( function( global, factory ) {
    'object' === typeof exports && typeof module !== 'undefined' ? factory( exports ) :
 ...
 'use strict';
    ...
    var Spectrum = /** @class */ ( function() {
        ...
        Spectrum.prototype.getDefaultStep = function( value, isDown, size ) {
            ...
            if ( 100 === value || ( isDown && value === this.xPct[ j - 1 ] ) ) {
                j = Math.max( j - 1, 1 );
            }
    ...
    function testPadding( parsed, entry ) {
        ...
        if ( Array.isArray( entry ) && ! ( 2 === entry.length || isNumeric( entry[ 0 ] ) || isNumeric( entry[ 1 ] ) ) ) {
            throw new Error( "noUiSlider: 'padding' option must be numeric or array of exactly 2 numbers." );
        }
        if ( 0 === entry ) {
            return;
    ...
    function scope( target, options, originalOptions ) {
        ...
        function tooltips() {
            ...
            bindEvent( 'update' + INTERNAL_EVENT_NS.tooltips, function( values, handleNumber, unencoded ) {
                ...
                if ( false === scope_Tooltips[ handleNumber ] ) {
                    return;
                }
        ...
        function eventMove( event, data ) {
            ...
            if ( -1 === navigator.appVersion.indexOf( 'MSIE 9' ) && 0 === event.buttons && data.buttonsProperty !== 0 ) {
        ...
        function bindSliderEvents( behaviour ) {
            ...
            if ( behaviour.drag ) {
                scope_Connects.forEach( function( connect, index ) {
                    if ( false === connect || 0 === index || index === scope_Connects.length - 1 ) {
                        return;
                    }
        ...
        function bindEvent( namespacedEvent, callback ) {
            ...
            if ( 'update' === namespacedEvent.split( '.' )[ 0 ] ) {
        ...
        function resolveToValue( to, handleNumber ) {
            ...
            if ( null === to || false === to || to === undefined ) {
 ...
 unencoded = false;
        ...
        function getNextStepsForHandle( handleNumber ) {
            ...
            } else if ( false === nearbySteps.stepBefore.step ) {
                decrement = false;
            }
