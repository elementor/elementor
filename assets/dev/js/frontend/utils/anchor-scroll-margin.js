...
// Export default class AnchorLinksScrollMargin {
// 	constructor() {
...
// 	}
//
// 	waitForElements = new Promise( ( resolve ) => {
...
// 	//
// 	// getAllStickyElements() {
// 	// 	const allStickyElements = document.querySelectorAll( '.elementor-element.elementor-sticky' );
// 	//
// 	// 	return Array.from( allStickyElements ).filter( ( anchor, index, self ) =>
// 	// 		index === self.findIndex( ( t ) => t.getAttribute( 'data-id' ) === anchor.getAttribute( 'data-id' ) ),
// 	// 	);
...
// 	//
// 	// getAllAnchorLinks() {
// 	// 	const allAnchors = document.querySelectorAll( '.elementor-element a[href^="#"]' );
// 	//
// 	// 	return Array.from( allAnchors ).filter( ( anchor, index, self ) =>
// 	// 		index === self.findIndex( ( t ) => t.getAttribute( 'href' ) === anchor.getAttribute( 'href' ) ),
// 	// 	);
