...
export default class Frontend extends elementorModules.ViewModule {
		...
		this.config.legacyMode = {
			get elementWrappers() {
				if ( elementorFrontend.isEditMode() ) {
					elementor.devTools.deprecation.deprecated( 'elementorFrontend.config.legacyMode.elementWrappers', '3.1.0', 'elementorFrontend.config.experimentalFeatures.e_dom_optimization' );
				}
	...
	get Module() {
		if ( this.isEditMode() ) {
			parent.elementor.devTools.deprecation.deprecated( 'elementorFrontend.Module', '2.5.0', 'elementorModules.frontend.handlers.Base' );
		}
	...
	getGeneralSettings( settingName ) {
		if ( this.isEditMode() ) {
			parent.elementor.devTools.deprecation.deprecated( 'getGeneralSettings', '3.0.0', 'getKitSettings and remove the `elementor_` prefix' );
		}
