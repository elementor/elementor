...
( function( $ ) {
	var ElementorAdmin = elementorModules.ViewModule.extend( {
		...
		bindEvents() {
			...
			$( '.e-notice--cta.e-notice--dismissible[data-notice_id="plugin_image_optimization"] a.e-button--cta' ).on( 'click', function( event ) {
			...
			$( '.e-a-apps .e-a-item[data-plugin="image-optimization/image-optimization.php"] a.e-btn' ).on( 'click', function( event ) {
				elementorCommon.ajax.addRequest( 'elementor_image_optimization_campaign', {
					data: {
