...
ColumnView = BaseElementView.extend( {
	...
	childViewContainer: elementorFrontend.config.experimentalFeatures.e_dom_optimization ? '> .elementor-widget-wrap' : '> .elementor-column-wrap > .elementor-widget-wrap',
	...
	ui: function() {
		...
		ui.columnInner = elementorFrontend.config.experimentalFeatures.e_dom_optimization ? '> .elementor-widget-wrap' : '> .elementor-column-wrap';
	...
	onRender: function() {
		const isDomOptimizationActive = elementorFrontend.config.experimentalFeatures.e_dom_optimization;
