...
const TemplateLibrarySaveTemplateView = Marionette.ItemView.extend( {
	...
	handleOnRender() {
		...
		elementor.templates.eventManager.sendPageViewEvent( {
			location: elementorCommon.editorEvents.config.secondaryLocations.templateLibrary[ `${ context }Modal` ],
		} );
	...
	handleCloudLibraryPromo( stateClass = 'promotion' ) {
		...
		elementor.templates.eventManager.sendPageViewEvent( {
			location: elementorCommon.editorEvents.config.secondaryLocations.templateLibrary.saveModalSelectUpgrade,
		} );
	},
	...
	async onEllipsisIconClick() {
		...
		elementor.templates.eventManager.sendPageViewEvent( {
			location: elementorCommon.editorEvents.config.secondaryLocations.templateLibrary.saveModalSelectFolder,
		} );
	},
	...
	handleElementorConnect() {
		elementor.templates.eventManager.sendPageViewEvent( {
			location: elementorCommon.editorEvents.config.secondaryLocations.templateLibrary.saveModalSelectConnect,
		} );
