...
const TemplateLibraryManager = function() {
		...
		const dialog = elementorCommon.dialogsManager.createWidget( 'confirm', {
			...
			onShow: () => {
				elementor.templates.eventManager.sendPageViewEvent( {
					location: elementorCommon.editorEvents.config.secondaryLocations.templateLibrary.renameDialog,
				} );
	...
	this.getCreateFolderDialog = function( folderData ) {
		...
		const dialog = elementorCommon.dialogsManager.createWidget( 'confirm', {
			...
			onShow: () => {
				...
				elementor.templates.eventManager.sendPageViewEvent( {
					location: elementorCommon.editorEvents.config.secondaryLocations.templateLibrary.newFolderModal,
				} );
			},
		} );
	...
	this.getDeleteFolderDialog = function( templateModel, data ) {
		const deleteFolderDialog = elementorCommon.dialogsManager.createWidget( 'confirm', {
			...
			onShow: () => {
				elementor.templates.eventManager.sendPageViewEvent( {
					location: elementorCommon.editorEvents.config.secondaryLocations.templateLibrary.deleteFolderDialog,
				} );
			},
		} );
	...
	this.getDeleteDialog = function( templateModel ) {
		if ( ! deleteDialog ) {
			deleteDialog = elementorCommon.dialogsManager.createWidget( 'confirm', {
				...
				onShow: () => {
					elementor.templates.eventManager.sendPageViewEvent( {
						location: elementorCommon.editorEvents.config.secondaryLocations.templateLibrary.deleteDialog,
					} );
				},
			} );
