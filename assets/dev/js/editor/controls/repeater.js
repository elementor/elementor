...
ControlRepeaterItemView = ControlBaseDataView.extend( {
	...
	updateContainer( model ) {
		...
		if ( ! isInChildren.length ) {
			elementor.devTools.deprecation.deprecated( 'Don\'t add models directly to the repeater.', '3.0.0', '$e.run( \'document/repeater/insert\' )' );
	...
	resetContainer: function() {
		elementor.devTools.deprecation.deprecated( 'Don\'t reset repeater collection directly.', '3.0.0', '$e.run( \'document/repeater/remove\' )' );
