...
ControlRepeaterItemView = ControlBaseDataView.extend( {
	...
	updateContainer( model ) {
		...
		if ( ! isInChildren.length ) {
			elementorDevToolsModule.deprecation.deprecated( 'Don\'t add models directly to the repeater.', '3.0.0', '$e.run( \'document/repeater/insert\' )' );
	...
	resetContainer: function() {
		elementorDevToolsModule.deprecation.deprecated( 'Don\'t reset repeater collection directly.', '3.0.0', '$e.run( \'document/repeater/remove\' )' );
