		...
		if ( widgetData ) {
			...
			if ( hasIconsControl ) {
				...
				elementor.helpers.getSimpleDialog(
					...
					__( 'Elementor v2.6 includes an upgrade from Font Awesome 4 to 5. In order to continue using icons, be sure to click "Update".', 'elementor' ) + ' <a href="https://go.elementor.com/fontawesome-migration/" target="_blank" rel="noopener">' + __( 'Learn More', 'elementor' ) + '</a>',
					__( 'Update', 'elementor' ),
					onConfirm
				).show();
				return true;
