...
process.env.DEV_SERVER = 'http://wordpress-dev.local';
process.env.TEST_SERVER = 'http://wordpress-dev.local'; // Test server is the same as dev server in elements-regression
