...
import ExportKitPartsSelection from 'elementor/app/modules/import-export/assets/js/export/components/export-kit-parts-selection';
...
describe( 'ExportKitPartsSelection Component', () => {
	...
	describe( 'Component Rendering', () => {
		...
		it( 'should have dialog configured for all items', () => {
			const kitContentData = require( 'elementor/app/modules/import-export/assets/js/shared/kit-content-data' );
