...
import ImportProcess from 'elementor/app/modules/import-export/assets/js/import/pages/import-process';
import eventsConfig from 'elementor/core/common/modules/events-manager/assets/js/events-config';
import useContextDetection from 'elementor/app/modules/import-export/assets/js/shared/hooks/use-context-detection';

const mockUseImportContext = jest.fn();
const mockUseImportKit = jest.fn();
const mockNavigate = jest.fn();

jest.mock( 'elementor/app/modules/import-export/assets/js/shared/hooks/use-context-detection' );

jest.mock( 'elementor/app/modules/import-export/assets/js/import/context/import-context', () => ( {
	useImportContext: () => mockUseImportContext(),
} ) );

jest.mock( 'elementor/app/modules/import-export/assets/js/import/hooks/use-import-kit', () => ( {
	...jest.requireActual( 'elementor/app/modules/import-export/assets/js/import/hooks/use-import-kit' ),
...
jest.mock( 'elementor/app/modules/import-export/assets/js/import/components/plugin-activation', () => ( {
