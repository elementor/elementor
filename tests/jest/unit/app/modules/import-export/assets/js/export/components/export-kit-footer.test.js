...
import ExportKitFooter from 'elementor/app/modules/import-export/assets/js/export/components/export-kit-footer';

const mockNavigate = jest.fn();

jest.mock( 'elementor-app/hooks/use-cloud-kits-eligibility', () => jest.fn() );

jest.mock( 'elementor/app/modules/import-export/assets/js/shared/hooks/use-connect-state', () => jest.fn() );

jest.mock( '@reach/router' );

jest.mock( 'elementor/app/modules/import-export/assets/js/export/context/export-context', () => ( {
...
import useConnectState from 'elementor/app/modules/import-export/assets/js/shared/hooks/use-connect-state';
import { useExportContext } from 'elementor/app/modules/import-export/assets/js/export/context/export-context';
