...
class Elementor_Test_Utils extends WP_UnitTestCase {
	 ...
	 *
	 */
	public function test_should_return_elemnentor_pro_link() {
	...
	public function test_should_return_elemnentor_pro_link_with_parent_post() {
	...
	public function test_should_get_timezone_string_defult_option() {
