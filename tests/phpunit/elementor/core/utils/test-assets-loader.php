...
class Test_Assets_Loader extends Elementor_Test_Base {
	...
	public function test_enable_asset() {
		...
		$assets_loader->enable_asset( 'styles', 'e-style-enable-asset' );
		$assets_loader->enable_asset( 'scripts', 'e-script-enable-asset' );
	...
	public function test_add_assets() {
		...
		$this->add_testing_assets( 'e-style-add-asset', 'e-script-add-asset' );

		$assets = $assets_loader->get_assets();

		$this->assertArrayHasKey( 'e-style-add-asset', $assets['styles'], 'e-style-add-asset was not properly added to assets.' );
		$this->assertArrayHasKey( 'e-script-add-asset', $assets['scripts'], 'e-script-add-asset was not properly added to assets.' );
	}
	...
	public function test_enqueue_assets() {
		...
		$assets_loader->enable_asset( 'styles', 'e-style-dynamic-enqueue' );
		$assets_loader->enable_asset( 'scripts', 'e-script-dynamic-enqueue' );
