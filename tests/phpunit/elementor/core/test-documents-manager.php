...
class Test_Documents_Manager extends Elementor_Test_Base {
	...
	public function test_create() {
		...
		$titles = [
			...
			'Title with image? Why not? <img src="x" onerror="alert(\'XSS\')">. It sounds grate for me!!' => 'Title with image? Why not? &lt;img src=&quot;x&quot; onerror=&quot;alert(&#039;XSS&#039;)&quot;&gt;. It sounds grate for me!!',
		];
