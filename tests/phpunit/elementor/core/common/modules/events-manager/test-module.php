...
class Test_Module extends Elementor_Test_Base {
	...
	/**
	 * The analytics SDK token is only injected at build time (see .github/scripts/build-zip.sh), so it
	 * is always empty in the test environment, meaning can_send_events() must always gate events off here.
	 */
