...
class Test_Editor_User_Rest_Api extends Elementor_Test_Base {
	...
	public function test_get_user_data_unauthorized() {
		// Arrange.
		update_user_meta( get_current_user_id(), User::INTRODUCTION_KEY, [ 'intro1' => true, 'intro2' => false ] );
	...
	public function test_patch_user_data() {
		// Arrange.
		$this->act_as_editor();
		update_user_meta( get_current_user_id(), User::INTRODUCTION_KEY, [ 'intro1' => true, 'intro2' => false ] );
	...
	public function test_patch_user_data_unauthorized() {
		// Arrange.
		update_user_meta( get_current_user_id(), User::INTRODUCTION_KEY, [ 'intro1' => true, 'intro2' => false ] );
	...
	public function test_patch__invalid_data() {
		// Arrange.
		$this->act_as_editor();
		update_user_meta( get_current_user_id(), User::INTRODUCTION_KEY, [ 'intro1' => true, 'intro2' => false ] );
