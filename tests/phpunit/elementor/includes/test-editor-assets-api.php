...
class Test_Editor_Assets_API extends PHPUnit_TestCase {
	...
	public function test_has_valid_nested_array_returns_true_when_empty_path_and_empty_root_and_require_non_empty_false() {
		$data = [];

		$this->assertTrue( EditorAssetsAPI::has_valid_nested_array( $data, [], false ) );
	}
	...
	public function test_has_valid_nested_array_returns_false_when_empty_array_and_require_non_empty_true() {
		$data = [ 'get_started' => [ 'repeater' => [] ] ];

		$this->assertFalse( EditorAssetsAPI::has_valid_nested_array( $data, [ 'get_started', 'repeater' ] ) );
	}

	public function test_has_valid_nested_array_returns_true_when_empty_array_and_require_non_empty_false() {
		$data = [ 'get_started' => [ 'repeater' => [] ] ];

		$this->assertTrue( EditorAssetsAPI::has_valid_nested_array( $data, [ 'get_started', 'repeater' ], false ) );
	}

	public function test_has_valid_nested_array_returns_false_when_empty_array_single_key_and_require_non_empty_true() {
		$data = [ 'sidebar_promotion_variants' => [] ];

		$this->assertFalse( EditorAssetsAPI::has_valid_nested_array( $data, [ 'sidebar_promotion_variants' ] ) );
	}

	public function test_has_valid_nested_array_returns_true_when_empty_array_single_key_and_require_non_empty_false() {
		$data = [ 'sidebar_promotion_variants' => [] ];

		$this->assertTrue( EditorAssetsAPI::has_valid_nested_array( $data, [ 'sidebar_promotion_variants' ], false ) );
	}
}
