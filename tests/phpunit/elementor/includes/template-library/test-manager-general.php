...
class Elementor_Test_Manager_General extends Elementor_Test_Base {
	...
	public function __construct( $name = null, array $data = [], $data_name = '' ) {
		...
		$this->manager = \Elementor\Plugin::$instance->templates_manager;
	}
	...
	public function test_should_return_wp_error_arguments_not_specified_from_save_template() {
		$this->assertWPError(
			$this->manager->save_template( [ 'post_id' => '123' ] ), 'arguments_not_specified'
		);
	}
	...
	public function test_should_return_wp_error_arguments_not_specified_from_update_template() {
		$this->assertWPError(
			$this->manager->update_template( [ 'post_id' => '123' ] ), 'arguments_not_specified'
		);
	}
	...
	public function test_should_return_wp_error_massage_template_error_from_get_template_data() {
		$this->assertWPError(
			$this->manager->get_template_data(
				[
					'source' => 'banana',
					'template_id' => '777',
					'edit_mode' => true,
