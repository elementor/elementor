...
export default class DocumentHelper {
	...
	static autoCreate( elType ) {
		...
		switch ( elType ) {
			...
			case 'section':
				result = DocumentHelper.createSection( 1 );
				break;

			case 'column':
				result = DocumentHelper.createSection( 1, true );
				break;

			case 'widget':
				result = DocumentHelper.createAutoButton();
				break;

			case 'innerSection':
				result = DocumentHelper.createInnerSection(
					DocumentHelper.createSection( 1, true )
				);
				break;
		}
