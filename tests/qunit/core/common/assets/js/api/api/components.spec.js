...
jQuery( () => {
	...
	QUnit.test( 'Run shortcut with scope', ( assert ) => {
		...
		const SecondComponent = class extends BaseComponent {
			getNamespace() {
	...
	QUnit.test( 'Modal component without a modal layout', ( assert ) => {
		...
		const Component = class extends BaseComponentModal {
			getNamespace() {
				return namespace;
			}
		};
	...
	QUnit.test( 'Modal component with esc shortcut', ( assert ) => {
		...
		const SecondComponent = class extends BaseComponentModal {
			getNamespace() {
