...
test.describe( 'Nested Accordion Content Tests @nested-accordion', () => {
	...
	for ( const atomicExperimentState of atomicExperimentStateCases ) { // Todo: remove once experiment is merged
		...
		test( 'Nested Accordion Title Icon and Text Vertical Alignment: ' + testTitleSuffix, async ( { browser }, testInfo ) => {
			...
			if ( atomicExperimentState ) {
				await wpAdmin.setExperiments( { e_nested_atomic_repeaters: 'active' } );
			}
		...
		test( 'Nested Accordion test SVG Icon and No Icon: ' + testTitleSuffix, async ( { browser }, testInfo ) => {
			const page = await browser.newPage(),
				wpAdmin = new WpAdminPage( page, testInfo );
		...
		test( 'Nested Accordion test SVG Icon and No Icon when Title Icons is disabled: ' + testTitleSuffix, async ( { browser }, testInfo ) => {
			const page = await browser.newPage(),
				wpAdmin = new WpAdminPage( page, testInfo );
		...
		test( 'Nested Accordion Title, Text and Icon Position: ' + testTitleSuffix, async ( { browser }, testInfo ) => {
			// Act
			const page = await browser.newPage(),
				wpAdmin = new WpAdminPage( page, testInfo ),
		...
		test( 'Nested Accordion animation: ' + testTitleSuffix, async ( { page }, testInfo ) => {
			const wpAdmin = new WpAdminPage( page, testInfo ),
				editor = await wpAdmin.openNewPage(),
		...
		test( 'Nested Accordion FAQ Schema: ' + testTitleSuffix, async ( { page }, testInfo ) => {
			// Arrange
			const wpAdmin = new WpAdminPage( page, testInfo ),
				editor = await wpAdmin.openNewPage(),
