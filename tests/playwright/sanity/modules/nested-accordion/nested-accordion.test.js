...
const { setTitleTextTag, expectScreenshotToMatchLocator, getChoicesButtonSelector, setTitleIconPosition, setTitleHorizontalAlignment, setBorderAndBackground, setIconColor } = require( './helper' );
