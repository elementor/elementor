...
// Skipped test can be resolved by applying site settings to be page's full width
test.describe( 'Inline editing toolbar placement @v4-tests', () => {
	...
	test( 'Edit the heading-title from the canvas and check the value in the panel and in the front', async () => {
		...
		await test.step.skip( 'Test placement on far left', async () => {
			// Act
		...
		await test.step.skip( 'Test placement on far right', async () => {
			// Act
