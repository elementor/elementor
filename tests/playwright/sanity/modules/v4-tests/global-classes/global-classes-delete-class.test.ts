...
const EXPERIMENT_VARIANTS = [
	{ label: 'without design system', experiments: { e_atomic_elements: 'active', e_classes: 'active' } },
	{ label: 'with design system', experiments: { e_atomic_elements: 'active', e_classes: 'active', e_editor_design_system_panel: 'active' } },
] as const;

for ( const { label, experiments } of EXPERIMENT_VARIANTS ) {
	test.describe( `Global Classes - Delete Class [${ label }] @v4-tests`, () => {
