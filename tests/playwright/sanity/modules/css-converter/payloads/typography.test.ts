...
test.describe( 'Typography Payload Integration @payloads', () => {
	...
	test.skip( 'should convert typography styles and verify with screenshots', async ( { page, request } ) => {
		...
		const testCases = [
			...
			{
				selector: '.elementor-widget-e-heading :is(h1, h2, h3, h4):first-of-type',
				name: 'main-heading',
				properties: {
					'font-size': '42px',
					'font-weight': '300',
			...
			{
				selector: '.elementor-widget-e-heading :is(h1, h2, h3, h4):nth-of-type(2)',
				name: 'subheading',
				properties: {
					'font-size': '28px',
					'font-weight': '600',
