...
export abstract class BasePropTypeTest {
	 ...
	 * @return Promise with postId and editUrl if successful, or skips test if failed
	 */
	 ...
	 * @return Elementor preview frame
	 */
	 ...
	 * @return Locator with text-based filtering
	 */
	 ...
	 * @param page - Playwright page
	 * @return Promise that resolves when frontend is loaded
	 */
