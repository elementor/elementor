...
export const ComponentsBadge = React.forwardRef<HTMLDivElement, { overridablePropsCount: number; onClick: () => void }>(
...
const StyledBadge = styled(Badge, { shouldForwardProp: (prop) => prop !== 'animate' })(({ theme, animate }) => ({
	'& .MuiBadge-badge': {
