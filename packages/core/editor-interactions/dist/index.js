...
const import_icons = require('@elementor/icons');
const import_ui = require('@elementor/ui');
...
var EmptyState = ({ onCreateInteraction }) => {
	return /* @__PURE__ */ React.createElement(
		...
		/* @__PURE__ */ React.createElement(
			...
			(0, import_i18n.__)('Animate elements with Interactions', 'elementor')
		),
		/* @__PURE__ */ React.createElement(
			import_ui.Typography,
			{ align: 'center', variant: 'caption', maxWidth: '170px' },
			(0, import_i18n.__)(
		...
		/* @__PURE__ */ React.createElement(
			import_ui.Button,
			{ variant: 'outlined', color: 'secondary', size: 'small', sx: { mt: 1 }, onClick: onCreateInteraction },
			(0, import_i18n.__)('Create an interaction', 'elementor')
		)
	);
};

// src/components/interactions-tab.tsx
const React11 = __toESM(require('react'));
const import_react9 = require('react');
const import_editor_elements2 = require('@elementor/editor-elements');
const import_session = require('@elementor/session');
const import_ui7 = require('@elementor/ui');

// src/contexts/interactions-context.tsx
const React2 = __toESM(require('react'));
const import_react = require('react');
const import_editor_elements = require('@elementor/editor-elements');
const InteractionsContext = (0, import_react.createContext)(null);
const DEFAULT_INTERACTIONS = {
	version: 1,
	items: [],
};
const InteractionsProvider = ({ children, elementId }) => {
...
const PopupStateContext = (0, import_react2.createContext)(void 0);
const PopupStateProvider = ({ children }) => {
	...
	return /* @__PURE__ */ React3.createElement(
		...
		{ value: { openByDefault, triggerDefaultOpen, resetDefaultOpen } },
		children
	);
};

// src/components/interactions-list.tsx
const React10 = __toESM(require('react'));
const import_react8 = require('react');
const import_editor_controls5 = require('@elementor/editor-controls');
const import_icons2 = require('@elementor/icons');
const import_ui6 = require('@elementor/ui');
const import_i18n5 = require('@wordpress/i18n');

// src/contexts/interactions-item-context.tsx
const React4 = __toESM(require('react'));
const import_react3 = require('react');
const InteractionItemContext = (0, import_react3.createContext)(null);
...
const import_editor_props = require('@elementor/editor-props');
...
var createTimingConfig = (duration, delay) => ({
	$$type: 'timing-config',
	value: {
		duration: import_editor_props.sizePropTypeUtil.create(
			parseSizeValue(duration, TIME_UNITS, void 0, DEFAULT_TIME_UNIT)
		),
		delay: import_editor_props.sizePropTypeUtil.create(
			parseSizeValue(delay, TIME_UNITS, void 0, DEFAULT_TIME_UNIT)
		),
	},
});
...
var createConfig = ({ replay, easing = 'easeIn', relativeTo = '', start = 85, end = 15 }) => ({
	$$type: 'config',
	value: {
...
const React9 = __toESM(require('react'));
const import_react7 = require('react');
const import_ui5 = require('@elementor/ui');
const import_i18n4 = require('@wordpress/i18n');

// src/components/interaction-details.tsx
const React7 = __toESM(require('react'));
const import_react5 = require('react');
const import_editor_controls3 = require('@elementor/editor-controls');
const import_ui3 = require('@elementor/ui');
const import_i18n2 = require('@wordpress/i18n');

// src/interactions-controls-registry.ts
const controlsRegistry = /* @__PURE__ */ new Map();
...
const React5 = __toESM(require('react'));
const import_react4 = require('react');
const import_editor_controls = require('@elementor/editor-controls');
...
function TimeFrameIndicator({ value, onChange, defaultValue }) {
	...
	return /* @__PURE__ */ React5.createElement(import_editor_controls.UnstableSizeField, {
		units: TIME_UNITS,
		value: sizeValue,
...
const React6 = __toESM(require('react'));
const import_editor_controls2 = require('@elementor/editor-controls');
const import_ui2 = require('@elementor/ui');
const Field = ({ label, children }) => {
	return /* @__PURE__ */ React6.createElement(
		import_ui2.Grid,
		{ item: true, xs: 12, 'aria-label': `${label} control` },
		/* @__PURE__ */ React6.createElement(
			import_editor_controls2.PopoverGridContainer,
			null,
			/* @__PURE__ */ React6.createElement(
				import_ui2.Grid,
				{ item: true, xs: 6 },
				/* @__PURE__ */ React6.createElement(import_editor_controls2.ControlFormLabel, null, label)
			),
			/* @__PURE__ */ React6.createElement(import_ui2.Grid, { item: true, xs: 6 }, children)
		)
	);
};
...
const InteractionDetails = ({ interaction, onChange, onPlayInteraction }) => {
	...
	return /* @__PURE__ */ React7.createElement(
		...
		/* @__PURE__ */ React7.createElement(
			import_editor_controls3.PopoverContent,
			{ p: 1.5 },
			/* @__PURE__ */ React7.createElement(
				import_ui3.Grid,
				{ container: true, spacing: 1.5 },
				TriggerControl &&
					/* @__PURE__ */ React7.createElement(
						Field,
						{ label: (0, import_i18n2.__)('Trigger', 'elementor') },
						/* @__PURE__ */ React7.createElement(TriggerControl, {
							value: trigger,
				...
				ReplayControl &&
					/* @__PURE__ */ React7.createElement(
						Field,
						{ label: (0, import_i18n2.__)('Replay', 'elementor') },
						/* @__PURE__ */ React7.createElement(ReplayControl, {
							value: replay,
			...
			/* @__PURE__ */ React7.createElement(import_ui3.Divider, null),
			/* @__PURE__ */ React7.createElement(
				import_ui3.Grid,
				{ container: true, spacing: 1.5 },
				EffectControl &&
					/* @__PURE__ */ React7.createElement(
						Field,
						{ label: (0, import_i18n2.__)('Effect', 'elementor') },
						/* @__PURE__ */ React7.createElement(EffectControl, {
							value: effect,
				...
				CustomEffectControl &&
					/* @__PURE__ */ React7.createElement(
						Field,
						{ label: (0, import_i18n2.__)('Custom Effect', 'elementor') },
						/* @__PURE__ */ React7.createElement(CustomEffectControl, {
							value: customEffects,
				...
				EffectTypeControl &&
					/* @__PURE__ */ React7.createElement(
						Field,
						{ label: (0, import_i18n2.__)('Type', 'elementor') },
						/* @__PURE__ */ React7.createElement(EffectTypeControl, {
							value: type,
				...
				DirectionControl &&
					/* @__PURE__ */ React7.createElement(
						Field,
						{ label: (0, import_i18n2.__)('Direction', 'elementor') },
						/* @__PURE__ */ React7.createElement(DirectionControl, {
							value: direction,
				...
				controlVisibilityConfig.duration(interactionValues) &&
					/* @__PURE__ */ React7.createElement(
						Field,
						{ label: (0, import_i18n2.__)('Duration', 'elementor') },
						/* @__PURE__ */ React7.createElement(TimeFrameIndicator, {
				...
				controlVisibilityConfig.delay(interactionValues) &&
					/* @__PURE__ */ React7.createElement(
						Field,
						{ label: (0, import_i18n2.__)('Delay', 'elementor') },
						/* @__PURE__ */ React7.createElement(TimeFrameIndicator, {
							value: String(delay),
				...
				/* @__PURE__ */ React7.createElement(
					...
					/* @__PURE__ */ React7.createElement(
						...
						StartControl &&
							/* @__PURE__ */ React7.createElement(
								Field,
								{ label: (0, import_i18n2.__)('Start', 'elementor') },
								/* @__PURE__ */ React7.createElement(StartControl, {
						...
						EndControl &&
							/* @__PURE__ */ React7.createElement(
								Field,
								{ label: (0, import_i18n2.__)('End', 'elementor') },
								/* @__PURE__ */ React7.createElement(EndControl, {
						...
						/* @__PURE__ */ React7.createElement(
							Field,
							{ label: (0, import_i18n2.__)('Relative To', 'elementor') },
							/* @__PURE__ */ React7.createElement(RelativeToControl, {
								value: relativeTo,
			...
			EasingControl &&
				/* @__PURE__ */ React7.createElement(
					...
					/* @__PURE__ */ React7.createElement(
						Field,
						{ label: (0, import_i18n2.__)('Easing', 'elementor') },
						/* @__PURE__ */ React7.createElement(EasingControl, {
							value: easing,
							onChange: (v) => {
...
const React8 = __toESM(require('react'));
const import_react6 = require('react');
const import_editor_controls4 = require('@elementor/editor-controls');
const import_editor_responsive = require('@elementor/editor-responsive');
const import_ui4 = require('@elementor/ui');
const import_i18n3 = require('@wordpress/i18n');
const SIZE = 'tiny';
const InteractionSettings = ({ interaction, onChange }) => {
	...
	return /* @__PURE__ */ React8.createElement(
		import_editor_controls4.PopoverContent,
		{ p: 1.5 },
		/* @__PURE__ */ React8.createElement(
			...
			/* @__PURE__ */ React8.createElement(
				...
				/* @__PURE__ */ React8.createElement(
					...
					/* @__PURE__ */ React8.createElement(
						import_editor_controls4.ControlFormLabel,
						{ sx: { width: '100%' } },
						(0, import_i18n3.__)('Trigger on', 'elementor')
					),
					/* @__PURE__ */ React8.createElement(import_ui4.Autocomplete, {
						fullWidth: true,
						multiple: true,
						...
						renderInput: (params) =>
							/* @__PURE__ */ React8.createElement(import_ui4.TextField, { ...params }),
						renderTags: (values, getTagProps) =>
							values.map((option, index) => {
								const { key, ...chipProps } = getTagProps({ index });
								return /* @__PURE__ */ React8.createElement(import_ui4.Chip, {
									key,
									size: SIZE,
									label: option.label,
									...chipProps,
...
// src/components/interactions-list-item.tsx
const InteractionsListItem = ({ index, value: interaction }) => {
	...
	return /* @__PURE__ */ React9.createElement(
		...
		/* @__PURE__ */ React9.createElement(
			...
			/* @__PURE__ */ React9.createElement(import_ui5.Tab, {
				label: (0, import_i18n4.__)('Details', 'elementor'),
				...getTabProps('details'),
			}),
			/* @__PURE__ */ React9.createElement(import_ui5.Tab, {
				label: (0, import_i18n4.__)('Settings', 'elementor'),
				...getTabProps('settings'),
			})
		),
		/* @__PURE__ */ React9.createElement(import_ui5.Divider, null),
		/* @__PURE__ */ React9.createElement(
			import_ui5.TabPanel,
			{ sx: { p: 0 }, ...getTabPanelProps('details') },
			/* @__PURE__ */ React9.createElement(InteractionDetails, {
				key: interactionId,
		...
		/* @__PURE__ */ React9.createElement(
			import_ui5.TabPanel,
			{ sx: { p: 0 }, ...getTabPanelProps('settings') },
			/* @__PURE__ */ React9.createElement(InteractionSettings, {
				key: interactionId,
				interaction: interaction.value,
				onChange: handleChange,
			})
...
function InteractionsList(props) {
	...
	const infotipContent = isMaxNumberOfInteractionsReached
		? /* @__PURE__ */ React10.createElement(
				...
				{
					color: 'secondary',
					icon: /* @__PURE__ */ React10.createElement(import_icons2.InfoCircleFilledIcon, null),
					size: 'small',
				},
				/* @__PURE__ */ React10.createElement(
					import_ui6.AlertTitle,
					null,
					(0, import_i18n5.__)('Interactions', 'elementor')
				),
				/* @__PURE__ */ React10.createElement(
					import_ui6.Box,
					{ component: 'span' },
	...
	return /* @__PURE__ */ React10.createElement(
		...
		{ value: contextValue },
		/* @__PURE__ */ React10.createElement(import_editor_controls5.Repeater, {
			openOnAdd: true,
			...
			itemSettings: {
				...
				actions: (value) =>
					/* @__PURE__ */ React10.createElement(
						import_ui6.Tooltip,
						{ key: 'preview', placement: 'top', title: (0, import_i18n5.__)('Preview', 'elementor') },
						/* @__PURE__ */ React10.createElement(
...
var InteractionsTab = ({ elementId }) => {
	return /* @__PURE__ */ React11.createElement(
		PopupStateProvider,
		null,
		/* @__PURE__ */ React11.createElement(InteractionsTabContent, { elementId })
	);
};
function InteractionsTabContent({ elementId }) {
	...
	return /* @__PURE__ */ React11.createElement(
		import_session.SessionStorageProvider,
		{ prefix: elementId },
		hasInteractions
			? /* @__PURE__ */ React11.createElement(
					InteractionsProvider,
					{ elementId },
					/* @__PURE__ */ React11.createElement(InteractionsContent, { firstInteractionState })
				)
			: /* @__PURE__ */ React11.createElement(EmptyState, {
					onCreateInteraction: () => {
...
function InteractionsContent({ firstInteractionState }) {
	...
	return /* @__PURE__ */ React11.createElement(
		import_ui7.Stack,
		{ sx: { m: 1, p: 1.5 }, gap: 2 },
		/* @__PURE__ */ React11.createElement(InteractionsList, {
...
const import_editor_elements3 = require('@elementor/editor-elements');
...
const documentElementsInteractionsProvider = createInteractionsProvider({
	key: () => {
...
const React12 = __toESM(require('react'));
const import_react10 = require('react');
const import_editor_controls6 = require('@elementor/editor-controls');
const import_icons3 = require('@elementor/icons');
const import_i18n6 = require('@wordpress/i18n');
function Direction({ value, onChange, interactionType }) {
		...
		return [
			{
				value: 'top',
				label: isIn
					? (0, import_i18n6.__)('From top', 'elementor')
					: (0, import_i18n6.__)('To top', 'elementor'),
				renderContent: ({ size }) =>
					isIn
						? /* @__PURE__ */ React12.createElement(import_icons3.ArrowDownSmallIcon, { fontSize: size })
						: /* @__PURE__ */ React12.createElement(import_icons3.ArrowUpSmallIcon, { fontSize: size }),
				showTooltip: true,
			},
			{
				value: 'bottom',
				label:
					interactionType === 'in'
						? (0, import_i18n6.__)('From bottom', 'elementor')
						: (0, import_i18n6.__)('To bottom', 'elementor'),
				renderContent: ({ size }) =>
					isIn
						? /* @__PURE__ */ React12.createElement(import_icons3.ArrowUpSmallIcon, { fontSize: size })
						: /* @__PURE__ */ React12.createElement(import_icons3.ArrowDownSmallIcon, { fontSize: size }),
			...
			},
			{
				...
				label:
					interactionType === 'in'
						? (0, import_i18n6.__)('From left', 'elementor')
						: (0, import_i18n6.__)('To left', 'elementor'),
				renderContent: ({ size }) =>
					isIn
						? /* @__PURE__ */ React12.createElement(import_icons3.ArrowRightIcon, { fontSize: size })
						: /* @__PURE__ */ React12.createElement(import_icons3.ArrowLeftIcon, { fontSize: size }),
				showTooltip: true,
			},
			{
				value: 'right',
				label:
					interactionType === 'in'
						? (0, import_i18n6.__)('From right', 'elementor')
						: (0, import_i18n6.__)('To right', 'elementor'),
				renderContent: ({ size }) =>
					isIn
						? /* @__PURE__ */ React12.createElement(import_icons3.ArrowLeftIcon, { fontSize: size })
						: /* @__PURE__ */ React12.createElement(import_icons3.ArrowRightIcon, { fontSize: size }),
	...
	return /* @__PURE__ */ React12.createElement(import_editor_controls6.ToggleButtonGroupUi, {
		items: options,
		exclusive: true,
		onChange,
		value,
...
const React15 = __toESM(require('react'));
const import_i18n9 = require('@wordpress/i18n');

// src/ui/promotion-select.tsx
const React14 = __toESM(require('react'));
const import_react12 = require('react');
const import_editor_ui2 = require('@elementor/editor-ui');
const import_ui9 = require('@elementor/ui');
const import_i18n8 = require('@wordpress/i18n');

// src/ui/interactions-promotion-chip.tsx
const React13 = __toESM(require('react'));
const import_react11 = require('react');
const import_editor_ui = require('@elementor/editor-ui');
const import_ui8 = require('@elementor/ui');
const import_i18n7 = require('@wordpress/i18n');
const InteractionsPromotionChip = (0, import_react11.forwardRef)(({ content, upgradeUrl, anchorRef }, ref) => {
...
function PromotionSelect({
	...
	return /* @__PURE__ */ React14.createElement(
		...
		Object.entries(baseOptions).map(([key, label]) =>
			/* @__PURE__ */ React14.createElement(import_editor_ui2.MenuListItem, { key, value: key }, label)
		),
		/* @__PURE__ */ React14.createElement(
			...
			/* @__PURE__ */ React14.createElement(InteractionsPromotionChip, {
		...
		Object.entries(disabledOptions).map(([key, label]) =>
			/* @__PURE__ */ React14.createElement(
				...
				{ key, value: key, disabled: true, sx: { pl: 3 } },
				label
			)
		)
	);
...
function Easing({}) {
	...
	return /* @__PURE__ */ React15.createElement(PromotionSelect, {
...
const React16 = __toESM(require('react'));
const import_i18n10 = require('@wordpress/i18n');
var EFFECT_OPTIONS = {
...
function Effect({ value, onChange }) {
	...
	return /* @__PURE__ */ React16.createElement(PromotionSelect, {
...
const React17 = __toESM(require('react'));
const import_editor_controls7 = require('@elementor/editor-controls');
const import_i18n11 = require('@wordpress/i18n');
function EffectType({ value, onChange }) {
	...
	return /* @__PURE__ */ React17.createElement(import_editor_controls7.ToggleButtonGroupUi, {
		items: options,
		exclusive: true,
		onChange,
		value,
...
const React18 = __toESM(require('react'));
const import_editor_controls8 = require('@elementor/editor-controls');
const import_icons4 = require('@elementor/icons');
const import_ui10 = require('@elementor/ui');
const import_i18n12 = require('@wordpress/i18n');
var REPLAY_OPTIONS = {
...
function Replay({ onChange, anchorRef }) {
	const options = [
		{
			...
			renderContent: ({ size }) =>
				/* @__PURE__ */ React18.createElement(import_icons4.MinusIcon, { fontSize: size }),
			showTooltip: true,
		},
		{
			value: true,
			...
			renderContent: ({ size }) =>
				/* @__PURE__ */ React18.createElement(import_icons4.CheckIcon, { fontSize: size }),
			showTooltip: true,
		},
	];
	return /* @__PURE__ */ React18.createElement(
		...
		/* @__PURE__ */ React18.createElement(
			import_ui10.Box,
			{ sx: { gridArea: OVERLAY_GRID } },
			/* @__PURE__ */ React18.createElement(import_editor_controls8.ToggleButtonGroupUi, {
				items: options,
				exclusive: true,
				onChange,
				value: false,
		...
		/* @__PURE__ */ React18.createElement(
			import_ui10.Box,
			{ sx: { gridArea: OVERLAY_GRID, marginInlineEnd: CHIP_OFFSET, justifySelf: 'end' } },
			/* @__PURE__ */ React18.createElement(InteractionsPromotionChip, {
				content: (0, import_i18n12.__)(
					'Upgrade to run the animation every time its trigger occurs.',
					'elementor'
				),
...
const React19 = __toESM(require('react'));
const import_i18n13 = require('@wordpress/i18n');
var TRIGGER_OPTIONS = {
...
function Trigger({ value, onChange }) {
	...
	return /* @__PURE__ */ React19.createElement(PromotionSelect, {
...
const import_editor_elements4 = require('@elementor/editor-elements');
...
// src/mcp/index.ts
const import_editor_mcp = require('@elementor/editor-mcp');
...
const baseSchema = {
	...
	excludedBreakpoints: import_schema.z
		.array(import_schema.z.string())
		.optional()
		.describe(
...
const proSchema = {
	...
	customEffect: import_schema.z
		.object({
			keyframes: import_schema.z
				.array(
					import_schema.z.object({
						stop: import_schema.z
							.number()
							.describe('The stop of the keyframe in percent, can be either 0 or 100'),
						value: import_schema.z.object({
							opacity: import_schema.z.number().min(0).max(1).describe('The opacity of the keyframe'),
							scale: import_schema.z
								.object({
							...
							rotate: import_schema.z
								.object({
									x: import_schema.z
										.number()
										.min(0)
										.max(360)
										.describe('The x rotate of the keyframe'),
									y: import_schema.z
										.number()
										.min(0)
										.max(360)
										.describe('The y rotate of the keyframe'),
									z: import_schema.z
										.number()
										.min(0)
										.max(360)
										.describe('The z rotate of the keyframe'),
								})
								.optional()
								.describe('The rotate of the keyframe'),
							move: import_schema.z
								.object({
...
const import_editor_elements5 = require('@elementor/editor-elements');
const import_schema3 = require('@elementor/schema');
const import_utils2 = require('@elementor/utils');
	...
	addTool({
		...
		outputSchema: {
			...
			action: import_schema3.z
				.enum(['get', 'add', 'update', 'delete', 'clear'])
				.describe('Operation to perform. Use "get" first to inspect existing interactions.'),
			elementId: import_schema3.z
				.string()
				.optional()
				.describe('The ID of the element to read or modify interactions on'),
			interactions: import_schema3.z
				.array(import_schema3.z.any())
				.optional()
				.describe('The interactions on the element'),
