	...
	return (
		<>
			...
			>
				...
				{action?.component}
				<CollapseIcon open={isOpen} color="secondary" fontSize="tiny" disabled={isDisabled} sx={{ ml: 1 }} />
			</ListItemButton>
			<Collapse id={contentId} aria-labelledby={labelId} in={isOpen} timeout="auto" unmountOnExit={unmountOnExit}>
