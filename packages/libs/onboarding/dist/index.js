...
// src/utils/translations.ts
var t = (0, import_utils.createTranslate)({
...
function registerOnboardingSlice() {
  (0, import_store.__registerSlice)(slice);
}
...
var selectCurrentStep = (0, import_store2.__createSelector)(
  [selectSteps, selectCurrentStepIndex],
  (steps, index) => steps[index] ?? null
);
var selectIsFirstStep = (0, import_store2.__createSelector)([selectCurrentStepIndex], (index) => index === 0);
var selectIsLastStep = (0, import_store2.__createSelector)(
  [selectSteps, selectCurrentStepIndex],
  (steps, index) => index === steps.length - 1
);
var selectTotalSteps = (0, import_store2.__createSelector)([selectSteps], (steps) => steps.length);
var selectIsStepCompleted = (0, import_store2.__createSelector)(
  [selectCompletedSteps, (_state, stepId) => stepId],
  (completedSteps, stepId) => completedSteps.includes(stepId)
);
var selectHasPassedLogin = (0, import_store2.__createSelector)(
  [selectIsConnected, selectIsGuest],
  (isConnected, isGuest) => isConnected || isGuest
);
var selectShouldShowProInstall = (0, import_store2.__createSelector)(
...
function useCheckProInstallScreen() {
  const checkProInstallScreen = (0, import_react.useCallback)(async () => {
...
function useElementorConnect({ connectUrl, onSuccess }) {
  const onSuccessRef = (0, import_react2.useRef)(onSuccess);
  ...
  const triggerConnect = (0, import_react2.useCallback)(() => {
    if (!connectUrl) {
      return;
    }
...
function useOnboarding() {
  ...
  const stepId = (0, import_store3.__useSelector)(selectCurrentStepId);
  const stepIndex = (0, import_store3.__useSelector)(selectCurrentStepIndex);
  const step = (0, import_store3.__useSelector)(selectCurrentStep);
  const steps = (0, import_store3.__useSelector)(selectSteps);
  const isFirst = (0, import_store3.__useSelector)(selectIsFirstStep);
  const isLast = (0, import_store3.__useSelector)(selectIsLastStep);
  const totalSteps = (0, import_store3.__useSelector)(selectTotalSteps);
  const completedSteps = (0, import_store3.__useSelector)(selectCompletedSteps);
  const choices = (0, import_store3.__useSelector)(selectChoices);
  const isLoading = (0, import_store3.__useSelector)(selectIsLoading);
  const error = (0, import_store3.__useSelector)(selectError);
  const hadUnexpectedExit = (0, import_store3.__useSelector)(selectHadUnexpectedExit);
  const isConnected = (0, import_store3.__useSelector)(selectIsConnected);
  const isGuest = (0, import_store3.__useSelector)(selectIsGuest);
  const hasPassedLogin = (0, import_store3.__useSelector)(selectHasPassedLogin);
  const shouldShowProInstall = (0, import_store3.__useSelector)(selectShouldShowProInstall);
  const userName = (0, import_store3.__useSelector)(selectUserName);
  const urls = (0, import_store3.__useSelector)(selectUrls);
...
var StepTitle = (0, import_ui.styled)(import_ui.Typography)({
  fontWeight: 500,
  fontFamily: "Poppins"
});
var GreetingBannerRoot = (0, import_ui.styled)(import_ui.Box)(({ theme }) => ({
  display: "inline-flex",
  alignItems: "center",
...
function GreetingBanner({ children }) {
  return /* @__PURE__ */ React.createElement(GreetingBannerRoot, null, /* @__PURE__ */ React.createElement(import_ui2.Typography, { variant: "body1", color: "text.primary", align: "center" }, children));
}

// src/components/ui/option-button.tsx
var import_ui3 = require("@elementor/ui");
var OptionButton = (0, import_ui3.styled)(import_ui3.Button)(({ theme }) => ({
...
var DirectionalChevronIcon = (0, import_ui4.withDirection)(import_icons.ChevronRightSmallIcon);
...
function BuildingFor({ onComplete }) {
  ...
  const greetingText = (0, import_react4.useMemo)(() => {
  ...
  return /* @__PURE__ */ React2.createElement(import_ui4.Stack, { spacing: 7.5, "data-testid": "building-for-step" }, /* @__PURE__ */ React2.createElement(GreetingBanner, null, greetingText), /* @__PURE__ */ React2.createElement(import_ui4.Stack, { spacing: 4, alignItems: "center" }, /* @__PURE__ */ React2.createElement(StepTitle, { variant: "h5", align: "center" }, t("steps.building_for.title")), /* @__PURE__ */ React2.createElement(import_ui4.Stack, { spacing: 2, width: "100%" }, BUILDING_FOR_OPTIONS.map((option) => {
...
var DirectionalChevronIcon2 = (0, import_ui5.withDirection)(import_icons2.ChevronRightSmallIcon);
var OPTIONS = [
...
function ExperienceLevel({ onComplete }) {
  ...
  return /* @__PURE__ */ React3.createElement(import_ui5.Stack, { spacing: 4, width: "100%", "data-testid": "experience-level-step" }, /* @__PURE__ */ React3.createElement(import_ui5.Stack, { spacing: 1, textAlign: "center", alignItems: "center" }, /* @__PURE__ */ React3.createElement(StepTitle, { variant: "h5", align: "center", maxWidth: 325 }, t("steps.experience_level.title")), /* @__PURE__ */ React3.createElement(import_ui5.Typography, { variant: "body1", color: "text.secondary" }, t("steps.experience_level.subtitle"))), /* @__PURE__ */ React3.createElement(import_ui5.Stack, { spacing: 2 }, OPTIONS.map((option) => {
...
var FullscreenCardRoot = (0, import_ui6.styled)(import_ui6.Box, {
...
var Backdrop = (0, import_ui6.styled)(import_ui6.Box)(({ theme }) => ({
  position: "absolute",
  inset: 0,
  backgroundColor: theme.palette.text.primary,
  opacity: BACKDROP_OPACITY
}));
var Card = (0, import_ui6.styled)(import_ui6.Paper)(({ theme }) => ({
  width: 512,
  maxWidth: "90%",
...
var PrimaryButton = (0, import_ui6.styled)(import_ui6.Button)(({ theme }) => ({
...
var SecondaryButton = (0, import_ui6.styled)(import_ui6.Button)(({ theme }) => ({
  borderRadius: theme.shape.borderRadius,
  textTransform: "none",
  fontSize: theme.typography.pxToRem(15),
  fontWeight: 500,
...
var TextButton = (0, import_ui6.styled)(import_ui6.Button)(({ theme }) => ({
  textTransform: "none",
...
// src/steps/screens/login.tsx
var SocialIcon = (0, import_ui7.styled)(import_ui7.Box)(({ theme }) => ({
  borderRadius: 100,
...
function Login({ onConnect, onContinueAsGuest }) {
  return /* @__PURE__ */ React5.createElement(FullscreenCard, { "data-testid": "login-screen" }, /* @__PURE__ */ React5.createElement(import_ui7.Typography, { variant: "h5", align: "center", fontWeight: 500, fontFamily: "Poppins" }, t("login.title")), /* @__PURE__ */ React5.createElement(import_ui7.Stack, { spacing: 3, width: "100%" }, /* @__PURE__ */ React5.createElement(PrimaryButton, { variant: "contained", color: "primary", fullWidth: true, size: "large", onClick: onConnect }, t("login.sign_in")), /* @__PURE__ */ React5.createElement(import_ui7.Stack, { direction: "row", alignItems: "center", justifyContent: "center", spacing: 2 }, /* @__PURE__ */ React5.createElement(import_ui7.Divider, { sx: { width: 80 } }), /* @__PURE__ */ React5.createElement(import_ui7.Typography, { variant: "body2", color: "text.tertiary" }, t("login.or")), /* @__PURE__ */ React5.createElement(import_ui7.Divider, { sx: { width: 80 } })), /* @__PURE__ */ React5.createElement(import_ui7.Stack, { spacing: 6 }, /* @__PURE__ */ React5.createElement(import_ui7.Stack, { spacing: 2, alignItems: "center" }, /* @__PURE__ */ React5.createElement(
    SecondaryButton,
    {
      variant: "text",
      color: "secondary",
      fullWidth: true,
      size: "large",
      endIcon: /* @__PURE__ */ React5.createElement(import_icons3.ChevronRightIcon, { fontSize: "tiny" }),
      onClick: onConnect
    },
    t("login.continue_another_way")
  ), /* @__PURE__ */ React5.createElement(import_ui7.Stack, { direction: "row" }, /* @__PURE__ */ React5.createElement(SocialIcon, null, /* @__PURE__ */ React5.createElement(import_ui7.Image, { src: getOnboardingAssetUrl("google.svg"), alt: "Google", variant: "circle" })), /* @__PURE__ */ React5.createElement(SocialIcon, { sx: { marginInlineStart: "-10px" } }, /* @__PURE__ */ React5.createElement(
    import_ui7.Image,
    {
  ...
  )), /* @__PURE__ */ React5.createElement(SocialIcon, { sx: { marginInlineStart: "-10px" } }, /* @__PURE__ */ React5.createElement(import_ui7.Image, { src: getOnboardingAssetUrl("apple.svg"), alt: "Apple", variant: "circle" })))), /* @__PURE__ */ React5.createElement(TextButton, { variant: "text", color: "info", onClick: onContinueAsGuest }, t("login.continue_as_guest")))));
}
...
// src/steps/screens/pro-install.tsx
var ProLogo = (0, import_ui8.styled)("img")(({ theme }) => ({
  maxWidth: 200,
  height: "auto",
...
function ProInstall() {
  ...
  const handleInstall = (0, import_react6.useCallback)(() => {
  ...
  const handleDismiss = (0, import_react6.useCallback)(() => {
    actions.dismissProInstallScreen();
  }, [actions]);
  const isInstalling = installPro2.isPending;
  const error = installPro2.error?.message ?? null;
  return /* @__PURE__ */ React6.createElement(FullscreenCard, { "data-testid": "pro-install-screen" }, /* @__PURE__ */ React6.createElement(import_ui8.Typography, { variant: "h5", align: "center", fontWeight: 500, fontFamily: "Poppins" }, t("pro_install.title")), /* @__PURE__ */ React6.createElement(import_ui8.Typography, { variant: "body2", align: "center", color: "text.secondary" }, isInstalling ? t("pro_install.installing") : t("pro_install.subtitle")), /* @__PURE__ */ React6.createElement(ProLogo, { src: getOnboardingAssetUrl("install-pro-logo.png"), alt: t("pro_install.logo_alt") }), error && /* @__PURE__ */ React6.createElement(import_ui8.Typography, { variant: "body2", align: "center", color: "error" }, error), /* @__PURE__ */ React6.createElement(import_ui8.Stack, { spacing: 2, width: "100%", alignItems: "center" }, /* @__PURE__ */ React6.createElement(
    PrimaryButton,
    {
      variant: "contained",
      color: "primary",
      ...
      startIcon: isInstalling ? /* @__PURE__ */ React6.createElement(import_ui8.CircularProgress, { size: 18, color: "inherit" }) : void 0
    },
...
var OrganizationIcon = React7.forwardRef((props, ref) => {
  return /* @__PURE__ */ React7.createElement(import_ui9.SvgIcon, { viewBox: "0 0 32 32", ...props, ref, fill: "currentColor", width: "32", height: "32" }, /* @__PURE__ */ React7.createElement(
    "path",
    {
...
var SITE_ABOUT_OPTIONS = [
  { value: "small_business", labelKey: "steps.site_about.option_small_med_business", icon: import_icons4.BriefcaseIcon },
  { value: "online_store", labelKey: "steps.site_about.option_online_store", icon: import_icons4.CartIcon },
  { value: "company_site", labelKey: "steps.site_about.option_company_site", icon: import_icons4.DomainIcon },
  { value: "blog", labelKey: "steps.site_about.option_blog", icon: import_icons4.PostTypeIcon },
  { value: "landing_page", labelKey: "steps.site_about.option_landing_page", icon: import_icons4.LandingPageTemplateIcon },
  { value: "booking", labelKey: "steps.site_about.option_booking", icon: import_icons4.CalendarIcon },
  { value: "organization", labelKey: "steps.site_about.option_organization", icon: organization_icon_default },
  { value: "other", labelKey: "steps.site_about.option_other", icon: import_icons4.SearchIcon }
];
...
var SelectionBadgeRoot = (0, import_ui10.styled)(import_ui10.Box, {
...
var OptionCardRoot = (0, import_ui11.styled)(import_ui11.ButtonBase)(({ theme }) => ({
  position: "relative",
  display: "flex",
  flexDirection: "column",
  alignItems: "center",
...
var CardGrid = (0, import_ui11.styled)(import_ui11.Box)(({ theme }) => ({
  display: "grid",
...
function OptionCard({ label, icon: Icon, selected, onClick }) {
  return /* @__PURE__ */ React9.createElement(
    ...
    selected && /* @__PURE__ */ React9.createElement(SelectionBadge, { icon: import_icons5.CheckIcon }),
    /* @__PURE__ */ React9.createElement(Icon, { sx: { fontSize: 32, color: "text.secondary" } }),
    /* @__PURE__ */ React9.createElement(import_ui12.Typography, { variant: "body2", color: "text.secondary", align: "center" }, label)
  );
}
...
function SiteAbout() {
  ...
  const greetingText = (0, import_react7.useMemo)(() => {
  ...
  return /* @__PURE__ */ React11.createElement(import_ui13.Stack, { spacing: 7.5, "data-testid": "site-about-step" }, /* @__PURE__ */ React11.createElement(GreetingBanner, null, greetingText), /* @__PURE__ */ React11.createElement(import_ui13.Stack, { spacing: 4, alignItems: "center" }, /* @__PURE__ */ React11.createElement(import_ui13.Stack, { spacing: 1, alignItems: "center" }, /* @__PURE__ */ React11.createElement(StepTitle, { variant: "h5", align: "center" }, t("steps.site_about.title")), /* @__PURE__ */ React11.createElement(import_ui13.Typography, { variant: "body1", color: "text.secondary", align: "center" }, t("steps.site_about.subtitle"))), /* @__PURE__ */ React11.createElement(OptionsGrid, { selectedValues, onToggle: handleToggle })));
}
...
function CorePlaceholderIcon(props) {
  return /* @__PURE__ */ React12.createElement(import_ui14.SvgIcon, { viewBox: "0 0 26 26", ...props }, /* @__PURE__ */ React12.createElement(
    "path",
    {
...
function WoocommerceIcon(props) {
  return /* @__PURE__ */ React13.createElement(import_ui15.SvgIcon, { viewBox: "0 0 28 26", ...props }, /* @__PURE__ */ React13.createElement(
    "path",
    {
...
var IncludedInCoreChip = (0, import_ui16.styled)(import_ui16.Chip)(({ theme }) => ({
  position: "absolute",
...
var FeatureCard = (0, import_ui16.styled)(import_ui16.Box, {
...
function FeatureGrid({ options, selectedValues, onFeatureClick }) {
  ...
  return /* @__PURE__ */ React14.createElement(
    ...
    options.map((option) => {
      ...
      const BadgeIcon = option.licenseType !== "core" ? import_icons6.CrownFilledIcon : import_icons6.CheckIcon;
      ...
      return /* @__PURE__ */ React14.createElement(
        ...
        /* @__PURE__ */ React14.createElement(import_ui16.Box, { className: "feature-icon", sx: { mb: 1 } }, /* @__PURE__ */ React14.createElement(Icon, { fontSize: "medium" })),
        /* @__PURE__ */ React14.createElement(import_ui16.Typography, { variant: "body2", color: "text.secondary", textAlign: "center" }, t(option.labelKey))
      );
    })
  );
}
...
var ProPlanNoticeRoot = (0, import_ui17.styled)(import_ui17.Box)(({ theme }) => ({
  display: "flex",
  alignItems: "center",
  gap: theme.spacing(1),
...
function ProPlanNotice({ planName }) {
  ...
  const handleComparePlansClick = (0, import_react8.useCallback)(() => {
...
var FEATURE_OPTIONS = [
  {
    ...
    Icon: (props) => /* @__PURE__ */ React16.createElement(import_icons8.ColorSwatchIcon, { ...props, sx: { transform: "rotate(90deg)" } }),
    licenseType: "core"
  },
  {
    id: "core_placeholder",
  ...
  },
  {
    ...
    Icon: import_icons8.ThemeBuilderIcon,
    licenseType: "pro"
  },
  {
    id: "lead_collection",
...
function SiteFeatures() {
  const { choices, actions } = useOnboarding();
  const storedPaidFeatures = (0, import_react9.useMemo)(
  ...
  const handleFeatureClick = (0, import_react9.useCallback)(
    (id) => {
  ...
  const planName = (0, import_react9.useMemo)(() => {
  ...
  return /* @__PURE__ */ React16.createElement(
    ...
    /* @__PURE__ */ React16.createElement(import_ui18.Stack, { spacing: 1, textAlign: "center", alignItems: "center" }, /* @__PURE__ */ React16.createElement(import_ui18.Typography, { variant: "h5", align: "center", fontWeight: 500 }, t("steps.site_features.title")), /* @__PURE__ */ React16.createElement(import_ui18.Typography, { variant: "body1", color: "text.secondary" }, t("steps.site_features.subtitle"))),
...
var ThemeCardRoot = (0, import_ui19.styled)(import_ui19.Box, {
...
var ThemePreview = (0, import_ui19.styled)(import_ui19.Box, {
...
var InstalledChip = (0, import_ui19.styled)(import_ui19.Chip)(({ theme }) => ({
  position: "absolute",
...
var RecommendedChip = (0, import_ui19.styled)(import_ui19.Chip)(({ theme }) => ({
  position: "absolute",
  insetBlockStart: theme.spacing(1),
  insetInlineStart: theme.spacing(1),
  zIndex: 1
  ...
  return /* @__PURE__ */ React17.createElement(
    ...
    /* @__PURE__ */ React17.createElement(ThemePreview, { bgColor: previewBgColor, previewImage }, installed && /* @__PURE__ */ React17.createElement(
      InstalledChip,
      {
        ...
        size: "small",
        color: "success",
        icon: /* @__PURE__ */ React17.createElement(import_icons9.CheckedCircleIcon, null)
      }
    ...
    /* @__PURE__ */ React17.createElement(import_ui20.Stack, { spacing: 1, alignItems: "center", sx: { textAlign: "center", px: 2.25 } }, /* @__PURE__ */ React17.createElement(import_ui20.Typography, { variant: "subtitle1", color: "text.primary" }, label), /* @__PURE__ */ React17.createElement(import_ui20.Typography, { variant: "body2", color: "text.secondary" }, description))
  );
}
...
function ThemeSelection({ onComplete }) {
  ...
  const recommendedTheme = (0, import_react10.useMemo)(() => getRecommendedTheme(choices), [choices]);
  const greetingText = (0, import_react10.useMemo)(() => getGreetingText(choices.experience_level), [choices.experience_level]);
  ...
  const themes = (0, import_react10.useMemo)(
    () => showBothThemes ? [HELLO_THEME, HELLO_BIZ_THEME] : [HELLO_THEME],
    [showBothThemes]
  );
  const effectiveSelection = selectedValue ?? recommendedTheme;
  return /* @__PURE__ */ React18.createElement(import_ui21.Stack, { spacing: 7.5, "data-testid": "theme-selection-step" }, /* @__PURE__ */ React18.createElement(GreetingBanner, null, greetingText), /* @__PURE__ */ React18.createElement(import_ui21.Stack, { spacing: 4 }, /* @__PURE__ */ React18.createElement(import_ui21.Stack, { spacing: 1 }, /* @__PURE__ */ React18.createElement(StepTitle, { variant: "h5", align: "center" }, t("steps.theme_selection.title")), /* @__PURE__ */ React18.createElement(import_ui21.Typography, { variant: "body1", color: "text.secondary" }, t("steps.theme_selection.subtitle"))), /* @__PURE__ */ React18.createElement(
    import_ui21.Stack,
    {
      direction: "row",
      spacing: 4,
...
var LayoutRoot = (0, import_ui22.styled)(import_ui22.Box)(({ theme }) => ({
  position: "fixed",
  inset: 0,
  display: "flex",
  flexDirection: "column",
...
var ContentArea = (0, import_ui22.styled)(import_ui22.Box, {
...
var ProgressTrack = (0, import_ui23.styled)(import_ui23.Box)(({ theme }) => ({
...
var ProgressFill = (0, import_ui23.styled)(import_ui23.Box)(({ theme }) => ({
  position: "absolute",
  left: 0,
  top: 0,
  height: "100%",
...
function CompletionScreen() {
  return /* @__PURE__ */ React20.createElement(
    ...
    /* @__PURE__ */ React20.createElement(import_ui23.Stack, { spacing: 4, alignItems: "center", sx: { maxWidth: 463, width: "100%", px: 3 } }, /* @__PURE__ */ React20.createElement(ProgressTrack, null, /* @__PURE__ */ React20.createElement(ProgressFill, null)), /* @__PURE__ */ React20.createElement(import_ui23.Stack, { spacing: 1, textAlign: "center" }, /* @__PURE__ */ React20.createElement(import_ui23.Typography, { variant: "h5", fontWeight: 500, color: "text.primary" }, t("completion.title")), /* @__PURE__ */ React20.createElement(import_ui23.Typography, { variant: "body1", color: "text.secondary" }, t("completion.subtitle"))))
  );
}
...
var FooterRoot = (0, import_ui24.styled)(import_ui24.Box)(({ theme }) => ({
  position: "fixed",
  bottom: 0,
  left: 0,
  right: 0,
...
var LeftActions = (0, import_ui25.styled)(import_ui25.Box)({
  display: "flex",
  alignItems: "center",
  gap: 8
});
var RightActions = (0, import_ui25.styled)(import_ui25.Box)({
  display: "flex",
  alignItems: "center",
  gap: 8
});
var BackButton = (0, import_ui25.styled)(import_ui25.Button)(({ theme }) => ({
...
var SkipButton = (0, import_ui25.styled)(import_ui25.Button)(({ theme }) => {
...
var ContinueButton = (0, import_ui25.styled)(import_ui25.Button)(({ theme }) => ({
...
function FooterActions({
  ...
  return /* @__PURE__ */ React22.createElement(React22.Fragment, null, /* @__PURE__ */ React22.createElement(LeftActions, null, showBack && /* @__PURE__ */ React22.createElement(BackButton, { variant: "text", onClick: onBack, startIcon: /* @__PURE__ */ React22.createElement(import_icons10.ArrowLeftIcon, { fontSize: "tiny" }) }, backLabel)), /* @__PURE__ */ React22.createElement(RightActions, null, showSkip && /* @__PURE__ */ React22.createElement(SkipButton, { variant: "outlined", onClick: onSkip }, skipLabel), showContinue && /* @__PURE__ */ React22.createElement(
    ContinueButton,
    {
      variant: "contained",
      onClick: onContinue,
...
var StyledLinearProgress = (0, import_ui26.styled)(import_ui26.LinearProgress)(({ theme }) => ({
  height: 4,
  borderRadius: 22,
  backgroundColor: theme.palette.action.hover,
...
var RightPanelRoot = (0, import_ui27.styled)(import_ui27.Box, {
...
var AssetImage = (0, import_ui27.styled)("img")({
  position: "absolute",
  maxWidth: "100%",
  height: "auto",
...
var SplitLayoutRoot = (0, import_ui28.styled)(import_ui28.Box, {
...
var LeftPanel = (0, import_ui28.styled)(import_ui28.Box, {
...
function ElementorIcon(props) {
  return /* @__PURE__ */ React27.createElement(import_ui30.SvgIcon, { viewBox: "0 0 32 32", ...props }, /* @__PURE__ */ React27.createElement(
    "path",
    {
...
function ElementorWordmark(props) {
  return /* @__PURE__ */ React28.createElement(import_ui31.SvgIcon, { viewBox: "0 0 90 15", ...props }, /* @__PURE__ */ React28.createElement(
    "path",
    {
...
function ElementorLogo({ height = 20, sx, ...props }) {
  const theme = (0, import_ui32.useTheme)();
...
// src/components/ui/top-bar-content.tsx
var UpgradeButton = (0, import_ui33.styled)(import_ui33.Button)(({ theme }) => ({
...
function TopBarContent({ showUpgrade = true, showClose = true, onUpgrade, onClose }) {
  ...
  return /* @__PURE__ */ React30.createElement(React30.Fragment, null, /* @__PURE__ */ React30.createElement(ElementorLogo, { height: 20 }), /* @__PURE__ */ React30.createElement(import_ui33.Stack, { direction: "row", alignItems: "center", spacing: 2 }, showUpgrade && /* @__PURE__ */ React30.createElement(UpgradeButton, { variant: "contained", onClick: onUpgrade }, t("common.upgrade")), showClose && /* @__PURE__ */ React30.createElement(import_ui33.Stack, { direction: "row", alignItems: "center", spacing: 1.5 }, /* @__PURE__ */ React30.createElement(Divider2, null), /* @__PURE__ */ React30.createElement(
    ...
    /* @__PURE__ */ React30.createElement(import_icons11.XIcon, { fontSize: "tiny" })
  ))));
}
...
function AppContent({ onClose }) {
  ...
  const [isCompleting, setIsCompleting] = (0, import_react12.useState)(false);
  ...
  const handleConnectSuccess = (0, import_react12.useCallback)(async () => {
  ...
  const handleContinueAsGuest = (0, import_react12.useCallback)(() => {
  ...
  const redirectToNewPage = (0, import_react12.useCallback)(() => {
    const redirectUrl = urls.createNewPage || urls.editor || urls.dashboard;
    window.location.href = redirectUrl;
  }, [urls]);
  const handleSkip = (0, import_react12.useCallback)(() => {
    if (isLast) {
  ...
  const rightPanelConfig = (0, import_react12.useMemo)(() => getStepVisualConfig(stepId), [stepId]);
  ...
  const renderStepContent = () => {
    switch (stepId) {
      ...
      default:
        return /* @__PURE__ */ React31.createElement(import_ui34.Box, { sx: { flex: 1, width: "100%" } });
    }
  };
  if (isCompleting) {
...
function App(props) {
  const store = (0, import_react13.useMemo)(() => {
    registerOnboardingSlice();
    let existingStore = (0, import_store5.__getStore)();
    if (!existingStore) {
      existingStore = (0, import_store5.__createStore)();
    }
  ...
  const queryClient = (0, import_react13.useMemo)(() => (0, import_query4.createQueryClient)(), []);
  const uiTheme = window.elementorAppConfig?.["e-onboarding"]?.uiTheme ?? "auto";
  const colorScheme = (0, import_react13.useMemo)(() => resolveColorScheme(uiTheme), [uiTheme]);
  return /* @__PURE__ */ React32.createElement(import_store5.__StoreProvider, { store }, /* @__PURE__ */ React32.createElement(import_query4.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React32.createElement(import_ui35.DirectionProvider, { rtl: window.document.dir === "rtl" }, /* @__PURE__ */ React32.createElement(import_ui35.ThemeProvider, { colorScheme, palette: "argon-beta" }, /* @__PURE__ */ React32.createElement(AppContent, { ...props })))));
}
