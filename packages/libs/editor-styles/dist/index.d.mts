import type * as _elementor_editor_props from '@elementor/editor-props';
import { type Props, type PropType } from '@elementor/editor-props';
...
declare const getStylesSchema: () => Record<
	string,
	_elementor_editor_props.PropType<{
		key?: string;
	}>
>;
declare const isExistingStyleProperty: (property: string) => boolean;

declare function getVariantByMeta(
	style: StyleDefinition,
	meta: StyleDefinitionVariant['meta']
): StyleDefinitionVariant | undefined;
