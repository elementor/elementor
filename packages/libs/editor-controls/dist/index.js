...
const MissingPropTypeError = (0, import_utils.createError)({
	code: 'missing_prop_provider_prop_type',
	message: 'Prop type is missing',
});
const UnsupportedParentError = (0, import_utils.createError)({
	code: 'unsupported_prop_provider_prop_type',
	message: 'Parent prop type is not supported',
});
const HookOutsideProviderError = (0, import_utils.createError)({
	code: 'hook_outside_provider',
	message: 'Hook used outside of provider',
});

// src/bound-prop-context/prop-context.tsx
const PropContext = (0, import_react.createContext)(null);
var PropProvider = ({ children, value, setValue, propType, placeholder, isDisabled }) => {
...
const PropKeyContext = (0, import_react2.createContext)(null);
...
var ControlAdornmentsProvider = ({ children, items: items2 }) =>
	/* @__PURE__ */ React4.createElement(Context.Provider, { value: { items: items2 } }, children);
const useControlAdornments = () => {
...
function ControlAdornments({ customContext }) {
	...
	return /* @__PURE__ */ React5.createElement(
		React5.Fragment,
		null,
		items2.map(({ Adornment, id }) => /* @__PURE__ */ React5.createElement(Adornment, { key: id, customContext }))
	);
}

// src/components/control-label.tsx
const ControlLabel = ({ children, ...props }) => {
	return /* @__PURE__ */ React6.createElement(
		import_ui2.Stack,
		{ direction: 'row', alignItems: 'center', justifyItems: 'start', gap: 0.25 },
		/* @__PURE__ */ React6.createElement(ControlFormLabel, { ...props }, children),
		/* @__PURE__ */ React6.createElement(ControlAdornments, null)
	);
};
...
const ControlReplacementContext = (0, import_react5.createContext)([]);
...
function createControl(Control5) {
	return (props) => {
		...
		return /* @__PURE__ */ React8.createElement(
			import_ui3.ErrorBoundary,
			{ fallback: null },
			/* @__PURE__ */ React8.createElement(ControlToRender, { ...controlProps })
		);
	};
}
...
const apiClient = {
	getElementorSetting: (key) =>
		(0, import_http_client.httpService)()
			.get(`${ELEMENTOR_SETTING_URL}/${key}`)
			.then((res) => formatSettingResponse(res.data)),
	updateElementorSetting: (key, value) =>
		(0, import_http_client.httpService)().put(`${ELEMENTOR_SETTING_URL}/${key}`, { value }),
};
var formatSettingResponse = (response) => response.data.value;

// src/hooks/use-unfiltered-files-upload.ts
const UNFILTERED_FILES_UPLOAD_KEY = 'elementor_unfiltered_files_upload';
const unfilteredFilesQueryKey = {
	queryKey: [UNFILTERED_FILES_UPLOAD_KEY],
};
const useUnfilteredFilesUpload = () =>
	(0, import_query.useQuery)({
		...unfilteredFilesQueryKey,
		queryFn: () =>
			apiClient.getElementorSetting(UNFILTERED_FILES_UPLOAD_KEY).then((res) => {
...
function useUpdateUnfilteredFilesUpload() {
	...
	const mutate = (0, import_query.useMutation)({
		mutationFn: ({ allowUnfilteredFilesUpload }) =>
			apiClient.updateElementorSetting(UNFILTERED_FILES_UPLOAD_KEY, allowUnfilteredFilesUpload ? '1' : '0'),
...
const import_wp_media = require('@elementor/wp-media');
...
const Context2 = (0, import_react6.createContext)(null);
var ControlActionsProvider = ({ children, items: items2 }) =>
	/* @__PURE__ */ React9.createElement(Context2.Provider, { value: { items: items2 } }, children);
...
function ControlActions({ children }) {
	...
	const menuItems = items2.map(({ MenuItem: MenuItem2, id }) =>
		/* @__PURE__ */ React10.createElement(MenuItem2, { key: id })
	);
	return /* @__PURE__ */ React10.createElement(import_editor_ui.FloatingActionsBar, { actions: menuItems }, children);
}

// src/controls/image-media-control.tsx
const ImageMediaControl = createControl(({ mediaTypes = ['image'] }) => {
	...
	return /* @__PURE__ */ React11.createElement(
		...
		/* @__PURE__ */ React11.createElement(
			...
			{ variant: 'outlined' },
			/* @__PURE__ */ React11.createElement(
				import_ui4.CardMedia,
				{ image: src, sx: { height: propType.meta.isDynamic ? 134 : 150 } },
				isFetching
					? /* @__PURE__ */ React11.createElement(
							import_ui4.Stack,
							{ justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%' },
							/* @__PURE__ */ React11.createElement(import_ui4.CircularProgress, null)
						)
					: /* @__PURE__ */ React11.createElement(React11.Fragment, null)
			),
			/* @__PURE__ */ React11.createElement(
				import_ui4.CardOverlay,
				null,
				/* @__PURE__ */ React11.createElement(
					import_ui4.Stack,
					{ gap: 1 },
...
var SelectControl = createControl(({ options, onChange, MenuProps = DEFAULT_MENU_PROPS, ariaLabel }) => {
		...
		/* @__PURE__ */ React12.createElement(
					...
					if (!selectedValue || selectedValue === '') {
						if (placeholder) {
							...
							return /* @__PURE__ */ React12.createElement(
								...
								{ component: 'span', variant: 'caption', color: 'text.tertiary' },
								displayText
							);
						}
						return '';
			...
			options.map(({ label, ...props }) =>
				/* @__PURE__ */ React12.createElement(
					...
					{ key: props.value, ...props, value: props.value ?? '' },
					label
				)
			)
		)
...
var ImageControl = createControl(({ sizes, label = (0, import_i18n2.__)('Image', 'elementor') }) => {
	...
	return /* @__PURE__ */ React13.createElement(
		...
		/* @__PURE__ */ React13.createElement(
			import_ui6.Stack,
			{ gap: 1.5 },
			/* @__PURE__ */ React13.createElement(ControlLabel, null, label),
			/* @__PURE__ */ React13.createElement(ImageSrcControl, null),
			/* @__PURE__ */ React13.createElement(
				import_ui6.Grid,
				{ container: true, gap: 1.5, alignItems: 'center', flexWrap: 'nowrap' },
				/* @__PURE__ */ React13.createElement(
					import_ui6.Grid,
					{ item: true, xs: 6 },
					/* @__PURE__ */ React13.createElement(
						ControlFormLabel,
						null,
						(0, import_i18n2.__)('Resolution', 'elementor')
					)
				),
				/* @__PURE__ */ React13.createElement(
					import_ui6.Grid,
					{ item: true, xs: 6, sx: { overflow: 'hidden' } },
					/* @__PURE__ */ React13.createElement(ImageSizeControl, { sizes })
				)
			)
		)
	);
...
var ImageSrcControl = () => {
	...
	return /* @__PURE__ */ React13.createElement(
		PropKeyProvider,
		{ bind: 'src' },
		/* @__PURE__ */ React13.createElement(ImageMediaControl, { mediaTypes })
	);
};
var ImageSizeControl = ({ sizes }) => {
	return /* @__PURE__ */ React13.createElement(
		PropKeyProvider,
		{ bind: 'size' },
		/* @__PURE__ */ React13.createElement(SelectControl, { options: sizes })
	);
};

// src/controls/text-control.tsx
const React14 = __toESM(require('react'));
const import_editor_props4 = require('@elementor/editor-props');
const import_ui7 = require('@elementor/ui');
var TextControl = createControl(({ placeholder, error, inputValue, inputDisabled, helperText, sx, ariaLabel }) => {
	const { value, setValue, disabled } = useBoundProp(import_editor_props4.stringPropTypeUtil);
	const handleChange = (event) => setValue(event.target.value);
	return /* @__PURE__ */ React14.createElement(
		ControlActions,
		null,
		/* @__PURE__ */ React14.createElement(import_ui7.TextField, {
			size: 'tiny',
			fullWidth: true,
...
const import_editor_props5 = require('@elementor/editor-props');
...
var TextAreaControl = createControl(({ placeholder, ariaLabel }) => {
	...
	return /* @__PURE__ */ React15.createElement(
		ControlActions,
		null,
		/* @__PURE__ */ React15.createElement(import_ui8.TextField, {
			size: 'tiny',
			multiline: true,
			fullWidth: true,
			minRows: 5,
...
const React20 = __toESM(require('react'));
const import_react13 = require('react');
const import_editor_props7 = require('@elementor/editor-props');
const import_editor_responsive = require('@elementor/editor-responsive');
const import_ui13 = require('@elementor/ui');

// src/components/size-control/size-input.tsx
const React18 = __toESM(require('react'));
const import_icons2 = require('@elementor/icons');
const import_ui11 = require('@elementor/ui');
...
const defaultExtendedOptions = ['auto', 'custom'];
...
const import_editor_props6 = require('@elementor/editor-props');
const import_editor_ui3 = require('@elementor/editor-ui');
...
var NumberInput = (0, import_react8.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ React16.createElement(import_ui9.TextField, {
		...props,
		ref,
		key,
...
// src/components/size-control/text-field-inner-selection.tsx
const TextFieldInnerSelection = (0, import_react9.forwardRef)(
	(
		{
			placeholder,
			type,
		...
		return /* @__PURE__ */ React17.createElement(NumberInput, {
			ref,
			sx: getCursorStyle2(),
			size: 'tiny',
			fullWidth: true,
...
const SelectionEndAdornment = ({
	...
	return /* @__PURE__ */ React17.createElement(
		...
		/* @__PURE__ */ React17.createElement(
			import_ui10.Menu,
			{ MenuListProps: { dense: true }, ...(0, import_ui10.bindMenu)(popupState) },
...
const SizeInput = ({
	...
	const InputProps = {
		...
		startAdornment: startIcon
			? /* @__PURE__ */ React18.createElement(
					import_ui11.InputAdornment,
					{ position: 'start', disabled },
					startIcon
				)
			: void 0,
		endAdornment: /* @__PURE__ */ React18.createElement(SelectionEndAdornment, {
			disabled,
			options: units2,
	...
	return /* @__PURE__ */ React18.createElement(
		...
		/* @__PURE__ */ React18.createElement(
			import_ui11.Box,
			null,
			/* @__PURE__ */ React18.createElement(TextFieldInnerSelection, {
				disabled,
				placeholder,
				type: inputType,
				value: inputValue,
...
const import_editor_ui4 = require('@elementor/editor-ui');
const import_icons3 = require('@elementor/icons');
const import_ui12 = require('@elementor/ui');
const import_i18n3 = require('@wordpress/i18n');
const SIZE = 'tiny';
const TextFieldPopover = (props) => {
	...
	return /* @__PURE__ */ React19.createElement(
		...
		/* @__PURE__ */ React19.createElement(import_editor_ui4.PopoverHeader, {
		...
		/* @__PURE__ */ React19.createElement(import_ui12.TextField, {
			value,
			onChange,
...
var SizeControl = createControl(
	({
		...
		return /* @__PURE__ */ React20.createElement(
			React20.Fragment,
			null,
			/* @__PURE__ */ React20.createElement(SizeInput, {
				disabled,
				size: controlSize,
				unit: controlUnit,
				units: [...actualUnits],
			...
			anchorRef?.current &&
				popupState.isOpen &&
				/* @__PURE__ */ React20.createElement(TextFieldPopover, {
					popupState,
					anchorRef,
					restoreValue,
					value: controlSize,
...
const React23 = __toESM(require('react'));
const import_react14 = require('react');
const import_editor_props9 = require('@elementor/editor-props');
const import_ui16 = require('@elementor/ui');
const import_i18n4 = require('@wordpress/i18n');

// src/components/section-content.tsx
const React21 = __toESM(require('react'));
const import_ui14 = require('@elementor/ui');
const SectionContent = ({ gap = 0.5, sx, children }) =>
	/* @__PURE__ */ React21.createElement(import_ui14.Stack, { gap, sx: { ...sx } }, children);

// src/controls/color-control.tsx
const React22 = __toESM(require('react'));
const import_editor_props8 = require('@elementor/editor-props');
const import_ui15 = require('@elementor/ui');
var ColorControl = createControl(
	({ propTypeUtil = import_editor_props8.colorPropTypeUtil, anchorEl, slotProps = {}, id, ...props }) => {
		...
		return /* @__PURE__ */ React22.createElement(
			ControlActions,
			null,
			/* @__PURE__ */ React22.createElement(import_ui15.UnstableColorField, {
				id,
				size: 'tiny',
				fullWidth: true,
				value: value ?? '',
...
var StrokeControl = createControl(() => {
	...
	return /* @__PURE__ */ React23.createElement(
		...
		/* @__PURE__ */ React23.createElement(
			...
			/* @__PURE__ */ React23.createElement(
				Control,
				{ bind: 'width', label: (0, import_i18n4.__)('Stroke width', 'elementor'), ref: rowRef },
				/* @__PURE__ */ React23.createElement(SizeControl, { units, anchorRef: rowRef })
			),
			/* @__PURE__ */ React23.createElement(
				Control,
				{ bind: 'color', label: (0, import_i18n4.__)('Stroke color', 'elementor') },
				/* @__PURE__ */ React23.createElement(ColorControl, null)
			)
		)
	);
});
var Control = (0, import_react14.forwardRef)(({ bind, label, children }, ref) =>
	/* @__PURE__ */ React23.createElement(
		PropKeyProvider,
		{ bind },
		/* @__PURE__ */ React23.createElement(
			import_ui16.Grid,
			{ container: true, gap: 2, alignItems: 'center', flexWrap: 'nowrap', ref },
			/* @__PURE__ */ React23.createElement(
				import_ui16.Grid,
				{ item: true, xs: 6 },
				/* @__PURE__ */ React23.createElement(ControlFormLabel, null, label)
			),
			/* @__PURE__ */ React23.createElement(import_ui16.Grid, { item: true, xs: 6 }, children)
		)
	)
);

// src/controls/box-shadow-repeater-control.tsx
const React39 = __toESM(require('react'));
const import_react21 = require('react');
const import_editor_props10 = require('@elementor/editor-props');
const import_ui30 = require('@elementor/ui');
const import_i18n11 = require('@wordpress/i18n');

// src/components/control-repeater/actions/tooltip-add-item-action.tsx
const React25 = __toESM(require('react'));
const import_icons4 = require('@elementor/icons');
const import_ui18 = require('@elementor/ui');
const import_i18n5 = require('@wordpress/i18n');

// src/components/control-repeater/context/repeater-context.tsx
const React24 = __toESM(require('react'));
const import_react16 = require('react');
const import_ui17 = require('@elementor/ui');
...
const import_react15 = require('react');
const ItemContext = (0, import_react15.createContext)({
	index: -1,
	value: {},
});

// src/components/control-repeater/context/repeater-context.tsx
const RepeaterContext = (0, import_react16.createContext)(null);
const EMPTY_OPEN_ITEM = -1;
const useRepeaterContext = () => {
...
const TooltipAddItemAction = ({
	...
	return /* @__PURE__ */ React25.createElement(
		ConditionalToolTip,
		{ content: tooltipContent, enable: enableTooltip },
		/* @__PURE__ */ React25.createElement(
			import_ui18.Box,
			{ component: 'span', sx: { cursor: disabled ? 'not-allowed' : 'pointer' } },
			/* @__PURE__ */ React25.createElement(
				import_ui18.IconButton,
				{
					...
					disabled,
					onClick,
					'aria-label': (0, import_i18n5.sprintf)(
						(0, import_i18n5.__)('Add %s item', 'elementor'),
...
var ConditionalToolTip = ({ children, enable, content }) =>
	enable && content
		? /* @__PURE__ */ React25.createElement(
				import_ui18.Infotip,
				{ placement: 'right', color: 'secondary', content },
				children
			)
		: children;

// src/components/control-repeater/items/items-container.tsx
const React27 = __toESM(require('react'));

// src/components/repeater/sortable.tsx
const React26 = __toESM(require('react'));
const import_icons5 = require('@elementor/icons');
const import_ui19 = require('@elementor/ui');
const import_i18n6 = require('@wordpress/i18n');
const SortableProvider = (props) => {
	return /* @__PURE__ */ React26.createElement(
		import_ui19.List,
		{ sx: { p: 0, my: -0.5, mx: 0 } },
		/* @__PURE__ */ React26.createElement(import_ui19.UnstableSortableProvider, {
			restrictAxis: true,
...
const SortableItem = ({ id, children, disabled }) => {
	return /* @__PURE__ */ React26.createElement(import_ui19.UnstableSortableItem, {
		id,
		disabled,
		render: ({ itemProps, triggerProps, itemStyle, triggerStyle, showDropIndication, dropIndicationStyle }) => {
			return /* @__PURE__ */ React26.createElement(
				StyledListItem,
				{ ...itemProps, style: itemStyle, tabIndex: -1 },
				!disabled &&
					/* @__PURE__ */ React26.createElement(SortableTrigger, { ...triggerProps, style: triggerStyle }),
				children,
				showDropIndication &&
					/* @__PURE__ */ React26.createElement(StyledDivider, { style: dropIndicationStyle })
			);
		},
	});
};
...
// src/components/control-repeater/items/items-container.tsx
const ItemsContainer = ({ isSortable = true, children }) => {
	...
	return /* @__PURE__ */ React27.createElement(
		...
		/* @__PURE__ */ React27.createElement(
			SortableProvider,
			{ value: keys, onChange: onChangeOrder },
			keys.map((key, index) => {
				const value = items2[index].item;
				return /* @__PURE__ */ React27.createElement(
					SortableItem,
					{ id: key, key: `sortable-${key}`, disabled: !isSortable },
					/* @__PURE__ */ React27.createElement(ItemContext.Provider, { value: { index, value } }, children)
				);
			})
		)
	);
...
const React29 = __toESM(require('react'));
const import_ui21 = require('@elementor/ui');
const import_i18n7 = require('@wordpress/i18n');

// src/hooks/use-repeatable-control-context.ts
const import_react17 = require('react');
const RepeatableControlContext = (0, import_react17.createContext)(void 0);
...
const React28 = __toESM(require('react'));
const import_react18 = require('react');
const import_ui20 = require('@elementor/ui');
const RepeaterTag = (0, import_react18.forwardRef)((props, ref) => {
	return /* @__PURE__ */ React28.createElement(import_ui20.UnstableTag, {
		ref,
		fullWidth: true,
...
const import_locations = require('@elementor/locations');
var { Slot: RepeaterItemIconSlot, inject: injectIntoRepeaterItemIcon } = (0,
import_locations.createReplaceableLocation)();
var { Slot: RepeaterItemLabelSlot, inject: injectIntoRepeaterItemLabel } = (0,
import_locations.createReplaceableLocation)();
var { Slot: RepeaterItemActionsSlot, inject: injectIntoRepeaterItemActions } = (0, import_locations.createLocation)();

// src/components/control-repeater/items/item.tsx
const Item = ({ Label: Label3, Icon, actions }) => {
	const {
		popoverState,
		setRowRef,
		openItemIndex,
	...
	return /* @__PURE__ */ React29.createElement(RepeaterTag, {
		ref: setRef,
		label: /* @__PURE__ */ React29.createElement(
			RepeaterItemLabelSlot,
			{ value },
			/* @__PURE__ */ React29.createElement(Label3, { value })
		),
		'aria-label': (0, import_i18n7.__)('Open item', 'elementor'),
		...triggerProps,
		onClick,
		startIcon: /* @__PURE__ */ React29.createElement(
			RepeaterItemIconSlot,
			{ value },
			/* @__PURE__ */ React29.createElement(Icon, { value })
		),
		sx: {
		...
		actions: /* @__PURE__ */ React29.createElement(
			React29.Fragment,
			null,
			/* @__PURE__ */ React29.createElement(RepeaterItemActionsSlot, { index: index ?? -1 }),
			actions
		),
	});
};
...
const React30 = __toESM(require('react'));
const ControlRepeater = ({ children, initial, propTypeUtil, isItemDisabled: isItemDisabled2 }) => {
...
const React31 = __toESM(require('react'));
const import_icons6 = require('@elementor/icons');
const import_ui22 = require('@elementor/ui');
const import_i18n8 = require('@wordpress/i18n');
const SIZE3 = 'tiny';
const DisableItemAction = () => {
	...
	const toggleLabel = propDisabled
		? (0, import_i18n8.__)('Show', 'elementor')
		: (0, import_i18n8.__)('Hide', 'elementor');
	const onClick = () => {
	...
	return /* @__PURE__ */ React31.createElement(
		import_ui22.Tooltip,
		{ title: toggleLabel, placement: 'top' },
		/* @__PURE__ */ React31.createElement(
			import_ui22.IconButton,
			{ size: SIZE3, onClick, 'aria-label': toggleLabel },
			propDisabled
				? /* @__PURE__ */ React31.createElement(import_icons6.EyeOffIcon, { fontSize: SIZE3 })
				: /* @__PURE__ */ React31.createElement(import_icons6.EyeIcon, { fontSize: SIZE3 })
		)
	);
};

// src/components/control-repeater/actions/duplicate-item-action.tsx
const React32 = __toESM(require('react'));
const import_icons7 = require('@elementor/icons');
const import_ui23 = require('@elementor/ui');
...
const DuplicateItemAction = () => {
	...
	return /* @__PURE__ */ React32.createElement(
		import_ui23.Tooltip,
		{ title: duplicateLabel, placement: 'top' },
...
const React33 = __toESM(require('react'));
const import_icons8 = require('@elementor/icons');
const import_ui24 = require('@elementor/ui');
...
const RemoveItemAction = () => {
	...
	return /* @__PURE__ */ React33.createElement(
		import_ui24.Tooltip,
		{ title: removeLabel, placement: 'top' },
		/* @__PURE__ */ React33.createElement(
			import_ui24.IconButton,
			{ size: SIZE5, onClick, 'aria-label': removeLabel },
			/* @__PURE__ */ React33.createElement(import_icons8.XIcon, { fontSize: SIZE5 })
		)
	);
};

// src/components/control-repeater/items/edit-item-popover.tsx
const React35 = __toESM(require('react'));
const import_ui26 = require('@elementor/ui');

// src/components/repeater/repeater-popover.tsx
const React34 = __toESM(require('react'));
const import_ui25 = require('@elementor/ui');
const RepeaterPopover = ({ children, width, ...props }) => {
...
// src/components/control-repeater/items/edit-item-popover.tsx
const EditItemPopover = ({ children }) => {
	...
	return /* @__PURE__ */ React35.createElement(
		RepeaterPopover,
		{ width: rowRef.offsetWidth, ...(0, import_ui26.bindPopover)(popoverState), onClose },
		/* @__PURE__ */ React35.createElement(
			PropKeyProvider,
			{ bind: String(openItemIndex) },
			/* @__PURE__ */ React35.createElement(import_ui26.Box, null, children)
		)
	);
};

// src/components/popover-content.tsx
const React36 = __toESM(require('react'));
const import_ui27 = require('@elementor/ui');
var PopoverContent = ({ gap = 1.5, children, ...props }) =>
	/* @__PURE__ */ React36.createElement(import_ui27.Stack, { ...props, gap }, children);

// src/components/popover-grid-container.tsx
const import_react19 = require('react');
const React37 = __toESM(require('react'));
const import_ui28 = require('@elementor/ui');
var PopoverGridContainer = (0, import_react19.forwardRef)(
	({ gap = 1.5, alignItems = 'center', flexWrap = 'nowrap', children }, ref) =>
		/* @__PURE__ */ React37.createElement(
			import_ui28.Grid,
			{ container: true, gap, alignItems, flexWrap, ref },
			children
		)
);

// src/components/repeater/repeater-header.tsx
const React38 = __toESM(require('react'));
const import_react20 = require('react');
const import_ui29 = require('@elementor/ui');
const RepeaterHeader = (0, import_react20.forwardRef)(
	({ label, children, adornment: Adornment = ControlAdornments }, ref) => {
		return /* @__PURE__ */ React38.createElement(
			...
			/* @__PURE__ */ React38.createElement(
				import_ui29.Box,
				{ display: 'flex', alignItems: 'center', gap: 1, sx: { flexGrow: 1 } },
				/* @__PURE__ */ React38.createElement(
					import_ui29.Typography,
					{ component: 'label', variant: 'caption', color: 'text.secondary', sx: { lineHeight: 1 } },
					label
				),
				/* @__PURE__ */ React38.createElement(Adornment, null)
			),
			children
		);
	}
...
var BoxShadowRepeaterControl = createControl(() => {
	...
	return /* @__PURE__ */ React39.createElement(
		PropProvider,
		{ propType, value, setValue, isDisabled: () => disabled },
		/* @__PURE__ */ React39.createElement(
			ControlRepeater,
			{ initial: initialShadow, propTypeUtil: import_editor_props10.boxShadowPropTypeUtil },
			/* @__PURE__ */ React39.createElement(
				RepeaterHeader,
				{ label: (0, import_i18n11.__)('Box shadow', 'elementor') },
				/* @__PURE__ */ React39.createElement(TooltipAddItemAction, {
					newItemIndex: 0,
					disabled,
			...
			/* @__PURE__ */ React39.createElement(
				ItemsContainer,
				null,
				/* @__PURE__ */ React39.createElement(Item, {
					Icon: ItemIcon,
					Label: ItemLabel,
					actions: /* @__PURE__ */ React39.createElement(
						React39.Fragment,
						null,
						/* @__PURE__ */ React39.createElement(DuplicateItemAction, null),
						/* @__PURE__ */ React39.createElement(DisableItemAction, null),
						/* @__PURE__ */ React39.createElement(RemoveItemAction, null)
					),
				})
			),
			/* @__PURE__ */ React39.createElement(
				EditItemPopover,
				null,
				/* @__PURE__ */ React39.createElement(Content, null)
			)
		)
	);
});
const StyledUnstableColorIndicator = (0, import_ui30.styled)(import_ui30.UnstableColorIndicator)(({ theme }) => ({
	height: '1rem',
	width: '1rem',
	borderRadius: `${theme.shape.borderRadius / 2}px`,
}));
var ItemIcon = ({ value }) =>
	/* @__PURE__ */ React39.createElement(StyledUnstableColorIndicator, {
		size: 'inherit',
		component: 'span',
	...
	return /* @__PURE__ */ React39.createElement(
		...
		/* @__PURE__ */ React39.createElement(
			...
			/* @__PURE__ */ React39.createElement(
				...
				/* @__PURE__ */ React39.createElement(
					Control2,
					{ bind: 'color', label: (0, import_i18n11.__)('Color', 'elementor') },
					/* @__PURE__ */ React39.createElement(ColorControl, { anchorEl })
				),
				/* @__PURE__ */ React39.createElement(
					Control2,
					{
						bind: 'position',
						label: (0, import_i18n11.__)('Position', 'elementor'),
						sx: { overflow: 'hidden' },
					},
					/* @__PURE__ */ React39.createElement(SelectControl, {
						options: [
			...
			/* @__PURE__ */ React39.createElement(
				...
				/* @__PURE__ */ React39.createElement(
					Control2,
					{ bind: 'hOffset', label: (0, import_i18n11.__)('Horizontal', 'elementor') },
					/* @__PURE__ */ React39.createElement(SizeControl, { anchorRef: rowRef[0] })
				),
				/* @__PURE__ */ React39.createElement(
					Control2,
					{ bind: 'vOffset', label: (0, import_i18n11.__)('Vertical', 'elementor') },
					/* @__PURE__ */ React39.createElement(SizeControl, { anchorRef: rowRef[0] })
				)
			),
			/* @__PURE__ */ React39.createElement(
				...
				/* @__PURE__ */ React39.createElement(
					Control2,
					{ bind: 'blur', label: (0, import_i18n11.__)('Blur', 'elementor') },
					/* @__PURE__ */ React39.createElement(SizeControl, { anchorRef: rowRef[1] })
				),
				/* @__PURE__ */ React39.createElement(
					Control2,
					{ bind: 'spread', label: (0, import_i18n11.__)('Spread', 'elementor') },
					/* @__PURE__ */ React39.createElement(SizeControl, { anchorRef: rowRef[1] })
				)
			)
		)
...
var Control2 = ({ label, bind, children, sx }) =>
	/* @__PURE__ */ React39.createElement(
		PropKeyProvider,
		{ bind },
		/* @__PURE__ */ React39.createElement(
			...
			/* @__PURE__ */ React39.createElement(
				import_ui30.Grid,
				{ container: true, gap: 0.75, alignItems: 'center' },
				/* @__PURE__ */ React39.createElement(
					import_ui30.Grid,
					{ item: true, xs: 12 },
					/* @__PURE__ */ React39.createElement(import_ui30.FormLabel, { size: 'tiny' }, label)
				),
				/* @__PURE__ */ React39.createElement(import_ui30.Grid, { item: true, xs: 12 }, children)
			)
		)
	);
var ItemLabel = ({ value }) => {
...
const React48 = __toESM(require('react'));
const import_editor_props15 = require('@elementor/editor-props');
const import_i18n16 = require('@wordpress/i18n');

// src/controls/filter-control/context/filter-config-context.tsx
const React40 = __toESM(require('react'));
const import_react22 = require('react');
const import_editor_props11 = require('@elementor/editor-props');
...
const FILTERS_BY_GROUP = {
	...
	'drop-shadow': {
		'drop-shadow': {
			name: (0, import_i18n12.__)('Drop shadow', 'elementor'),
			valueName: (0, import_i18n12.__)('Drop-shadow', 'elementor'),
		},
	},
};

// src/controls/filter-control/utils.ts
const AMOUNT_VALUE_NAME = (0, import_i18n13.__)('Amount', 'elementor');
...
function buildFilterConfig(cssFilterPropType) {
	...
	const entries = Object.entries(FILTERS_BY_GROUP).flatMap(([filterFunctionGroup, group]) =>
		Object.entries(group).map(([filterFunction, meta]) => createEntry(filterFunctionGroup, filterFunction, meta))
	);
...
// src/controls/filter-control/context/filter-config-context.tsx
const FilterConfigContext = (0, import_react22.createContext)(null);
...
const React43 = __toESM(require('react'));
const import_editor_props14 = require('@elementor/editor-props');
const import_ui33 = require('@elementor/ui');
const import_i18n15 = require('@wordpress/i18n');

// src/controls/filter-control/drop-shadow/drop-shadow-item-content.tsx
const React41 = __toESM(require('react'));
const import_react23 = require('react');
const import_editor_props12 = require('@elementor/editor-props');
const import_ui31 = require('@elementor/ui');
const import_i18n14 = require('@wordpress/i18n');
const items = [
	{
		bind: 'xAxis',
...
const DropShadowItemContent = ({ anchorEl }) => {
	...
	return /* @__PURE__ */ React41.createElement(
		...
		items.map((item) =>
			/* @__PURE__ */ React41.createElement(
				PopoverGridContainer,
				{ key: item.bind, ref: rowRefs[item.rowIndex] ?? null },
				/* @__PURE__ */ React41.createElement(
					PropKeyProvider,
					{ bind: item.bind },
					/* @__PURE__ */ React41.createElement(
						import_ui31.Grid,
						{ item: true, xs: 6 },
						/* @__PURE__ */ React41.createElement(ControlFormLabel, null, item.label)
					),
					/* @__PURE__ */ React41.createElement(
						import_ui31.Grid,
						{ item: true, xs: 6 },
						item.bind === 'color'
							? /* @__PURE__ */ React41.createElement(ColorControl, { anchorEl })
							: /* @__PURE__ */ React41.createElement(SizeControl, {
...
const import_react24 = require('react');
const React42 = __toESM(require('react'));
const import_editor_props13 = require('@elementor/editor-props');
const import_ui32 = require('@elementor/ui');
const propTypeMap = {
...
const SingleSizeItemContent = ({ filterFunc }) => {
			...
			/* @__PURE__ */ React42.createElement(
				...
				/* @__PURE__ */ React42.createElement(
					...
					/* @__PURE__ */ React42.createElement(
						import_ui32.Grid,
						{ item: true, xs: 6 },
						/* @__PURE__ */ React42.createElement(ControlFormLabel, null, valueName)
					),
					/* @__PURE__ */ React42.createElement(
						import_ui32.Grid,
						{ item: true, xs: 6 },
						/* @__PURE__ */ React42.createElement(SizeControl, {
							anchorRef: rowRef,
							enablePropTypeUnits: true,
						})
					)
...
const FilterContent = () => {
	...
	return /* @__PURE__ */ React43.createElement(
		PropProvider,
		{ ...propContext, setValue: handleValueChange },
		/* @__PURE__ */ React43.createElement(
			PropKeyProvider,
			{ bind: 'css-filter-func' },
			/* @__PURE__ */ React43.createElement(
				PopoverContent,
				{ p: 1.5 },
				/* @__PURE__ */ React43.createElement(
					...
					/* @__PURE__ */ React43.createElement(
						...
						/* @__PURE__ */ React43.createElement(
							ControlFormLabel,
							null,
							(0, import_i18n15.__)('Filter', 'elementor')
						)
					),
					/* @__PURE__ */ React43.createElement(
						import_ui33.Grid,
						...
						/* @__PURE__ */ React43.createElement(
							PropKeyProvider,
							{ bind: 'func' },
							/* @__PURE__ */ React43.createElement(SelectControl, { options: filterOptions })
						)
					)
				),
				/* @__PURE__ */ React43.createElement(
					PropKeyProvider,
					{ bind: 'args' },
					/* @__PURE__ */ React43.createElement(FilterValueContent, null)
				)
			)
		)
	);
...
const React44 = __toESM(require('react'));
const import_ui34 = require('@elementor/ui');
const FilterIcon = ({ value }) => {
	if (value.value.func.value !== 'drop-shadow') {
		return null;
	}
	return /* @__PURE__ */ React44.createElement(StyledUnstableColorIndicator2, {
		size: 'inherit',
		component: 'span',
...
const React47 = __toESM(require('react'));

// src/controls/filter-control/drop-shadow/drop-shadow-item-label.tsx
const React45 = __toESM(require('react'));
const import_ui35 = require('@elementor/ui');
const DropShadowItemLabel = ({ value }) => {
	...
	return /* @__PURE__ */ React45.createElement(
		...
		/* @__PURE__ */ React45.createElement(
			import_ui35.Box,
			{ component: 'span', style: { textTransform: 'capitalize' } },
			'Drop shadow:'
		),
		` ${labels.join(' ')}`
	);
...
const React46 = __toESM(require('react'));
const import_ui36 = require('@elementor/ui');
const SingleSizeItemLabel = ({ value }) => {
	...
	const label = /* @__PURE__ */ React46.createElement(
		import_ui36.Box,
		{ component: 'span', style: { textTransform: 'capitalize' } },
		func.value ?? '',
		':'
...
var FilterRepeaterControl = createControl(({ filterPropName = 'filter' }) => {
	...
	return /* @__PURE__ */ React48.createElement(
		...
		/* @__PURE__ */ React48.createElement(
			PropProvider,
			{ propType, value: filterValues, setValue },
			/* @__PURE__ */ React48.createElement(Repeater, {
				propTypeUtil,
				label,
				filterPropName,
			})
...
var Repeater = ({ propTypeUtil, label, filterPropName }) => {
	...
	return /* @__PURE__ */ React48.createElement(
		ControlRepeater,
		{ initial: getInitialValue2(), propTypeUtil },
		/* @__PURE__ */ React48.createElement(
			RepeaterHeader,
			{ label },
			/* @__PURE__ */ React48.createElement(TooltipAddItemAction, {
				newItemIndex: 0,
		...
		/* @__PURE__ */ React48.createElement(
			ItemsContainer,
			null,
			/* @__PURE__ */ React48.createElement(Item, {
				Label: FilterLabel,
				Icon: FilterIcon,
				actions: /* @__PURE__ */ React48.createElement(
					React48.Fragment,
					null,
					/* @__PURE__ */ React48.createElement(DuplicateItemAction, null),
					/* @__PURE__ */ React48.createElement(DisableItemAction, null),
					/* @__PURE__ */ React48.createElement(RemoveItemAction, null)
				),
			})
		),
		/* @__PURE__ */ React48.createElement(
			EditItemPopover,
			null,
			/* @__PURE__ */ React48.createElement(FilterContent, null)
		)
	);
};
...
const React49 = __toESM(require('react'));
const import_react25 = require('react');
...
const useDynamicOptions = (collectionId, initialOptions) => {
...
const React50 = __toESM(require('react'));
const import_editor_props16 = require('@elementor/editor-props');
const import_ui37 = require('@elementor/ui');
const SIZE6 = 'tiny';
var ChipsControl = createControl(({ options }) => {
	...
	const selectedValues = (value || [])
		.map((item) => import_editor_props16.stringPropTypeUtil.extract(item))
		.filter((val) => val !== null);
	const selectedOptions = selectedValues
		.map((val) => options.find((opt) => opt.value === val))
		.filter((opt) => opt !== void 0);
	...
	return /* @__PURE__ */ React50.createElement(
		ControlActions,
		null,
		/* @__PURE__ */ React50.createElement(import_ui37.Autocomplete, {
			fullWidth: true,
			multiple: true,
			size: SIZE6,
			disabled,
			...
			renderTags: (values, getTagProps) =>
				values.map((option, index) => {
					...
					return /* @__PURE__ */ React50.createElement(import_ui37.Chip, {
						key,
						size: 'tiny',
						label: option.label,
						...chipProps,
...
const React54 = __toESM(require('react'));
const import_editor_props17 = require('@elementor/editor-props');

// src/components/control-toggle-button-group.tsx
const React52 = __toESM(require('react'));
const import_react26 = require('react');
const import_icons9 = require('@elementor/icons');
const import_ui39 = require('@elementor/ui');

// src/components/conditional-tooltip.tsx
const React51 = __toESM(require('react'));
const import_ui38 = require('@elementor/ui');
const ConditionalTooltip = ({ showTooltip, children, label }) => {
	return showTooltip && label
		? /* @__PURE__ */ React51.createElement(
				import_ui38.Tooltip,
				{ title: label, disableFocusListener: true, placement: 'top' },
				children
			)
		: children;
};
...
// src/components/control-toggle-button-group.tsx
const StyledToggleButtonGroup = (0, import_ui39.styled)(import_ui39.ToggleButtonGroup)`
...
`;
const StyledToggleButton = (0, import_ui39.styled)(import_ui39.ToggleButton, {
...
var ToggleButtonGroupUi = React52.forwardRef(
	(
		...
		return /* @__PURE__ */ React52.createElement(
			...
			menuItems.length &&
				exclusive &&
				/* @__PURE__ */ React52.createElement(SplitButtonGroup, {
					size,
					value: value || null,
					onChange,
					items: menuItems,
...
var ControlToggleButtonGroup = (props) => {
	return /* @__PURE__ */ React52.createElement(
		ControlActions,
		null,
		/* @__PURE__ */ React52.createElement(ToggleButtonGroupUi, { ...props })
	);
};
var SplitButtonGroup = ({ size = 'tiny', onChange, items: items2, fullWidth, value }) => {
	...
	return /* @__PURE__ */ React52.createElement(
		...
		/* @__PURE__ */ React52.createElement(
			...
			items2.map(({ label, value: buttonValue }) =>
				/* @__PURE__ */ React52.createElement(
					...
					/* @__PURE__ */ React52.createElement(
						import_ui39.ListItemText,
						null,
						/* @__PURE__ */ React52.createElement(
							import_ui39.Typography,
							{ sx: { fontSize: '14px' } },
							label
						)
					)
...
const React53 = __toESM(require('react'));
const Icons = __toESM(require('@elementor/icons'));
const convertToggleOptionsToAtomic = (options) => {
...
var ToggleControl = createControl(
	({ options, fullWidth = false, size = 'tiny', exclusive = true, maxItems, convertOptions = false }) => {
		...
		return exclusive
			? /* @__PURE__ */ React54.createElement(ControlToggleButtonGroup, {
...
const React55 = __toESM(require('react'));
const import_editor_props18 = require('@elementor/editor-props');
const import_ui40 = require('@elementor/ui');
const isEmptyOrNaN = (value) => value === null || value === void 0 || value === '' || Number.isNaN(Number(value));
const renderSuffix = (propType) => {
	if (propType.meta?.suffix) {
		return /* @__PURE__ */ React55.createElement(
			import_ui40.InputAdornment,
			{ position: 'end' },
...
var NumberControl = createControl(
	({
		...
		const { value, setValue, placeholder, disabled, restoreValue, propType } = useBoundProp(
			import_editor_props18.numberPropTypeUtil
		);
		const handleChange = (event) => {
			const {
				value: eventValue,
		...
		return /* @__PURE__ */ React55.createElement(
			ControlActions,
			null,
			/* @__PURE__ */ React55.createElement(NumberInput, {
				size: 'tiny',
				type: 'number',
				fullWidth: true,
				disabled,
...
const React56 = __toESM(require('react'));
const import_react27 = require('react');
const import_ui41 = require('@elementor/ui');
const import_i18n17 = require('@wordpress/i18n');
function EqualUnequalSizesControl({ label, icon, tooltipLabel, items: items2, multiSizePropTypeUtil }) {
	...
	return /* @__PURE__ */ React56.createElement(
		...
		/* @__PURE__ */ React56.createElement(
			import_ui41.Grid,
			{ container: true, gap: 2, alignItems: 'center', flexWrap: 'nowrap', ref: rowRefs[0] },
			/* @__PURE__ */ React56.createElement(
				import_ui41.Grid,
				{ item: true, xs: 6 },
				!isShowingGeneralIndicator
					? /* @__PURE__ */ React56.createElement(ControlFormLabel, null, label)
					: /* @__PURE__ */ React56.createElement(ControlLabel, null, label)
			),
			/* @__PURE__ */ React56.createElement(
				import_ui41.Grid,
				{ item: true, xs: 6 },
				/* @__PURE__ */ React56.createElement(
					...
					/* @__PURE__ */ React56.createElement(
						import_ui41.Box,
						{ flexGrow: 1 },
						/* @__PURE__ */ React56.createElement(SizeControl, {
					...
					/* @__PURE__ */ React56.createElement(
						import_ui41.Tooltip,
						{ title: tooltipLabel, placement: 'top' },
						/* @__PURE__ */ React56.createElement(
							StyledToggleButton,
							{
								size: 'tiny',
			...
			/* @__PURE__ */ React56.createElement(
				...
				/* @__PURE__ */ React56.createElement(
					...
					/* @__PURE__ */ React56.createElement(
						PopoverGridContainer,
						{ ref: rowRefs[1] },
						/* @__PURE__ */ React56.createElement(MultiSizeValueControl, {
							item: items2[0],
							rowRef: rowRefs[1],
						}),
						/* @__PURE__ */ React56.createElement(MultiSizeValueControl, {
...
const React57 = __toESM(require('react'));
const import_react28 = require('react');
const import_editor_props19 = require('@elementor/editor-props');
const import_editor_responsive2 = require('@elementor/editor-responsive');
const import_icons10 = require('@elementor/icons');
const import_ui42 = require('@elementor/ui');
const import_i18n18 = require('@wordpress/i18n');
var LinkedDimensionsControl = ({ label, isSiteRtl = false, extendedOptions, min }) => {
	...
	return /* @__PURE__ */ React57.createElement(
		...
		/* @__PURE__ */ React57.createElement(
			import_ui42.Stack,
			{ direction: 'row', gap: 2, flexWrap: 'nowrap' },
			/* @__PURE__ */ React57.createElement(ControlFormLabel, null, label),
			/* @__PURE__ */ React57.createElement(
				import_ui42.Tooltip,
				{ title: isLinked ? unlinkedLabel : linkedLabel, placement: 'top' },
				/* @__PURE__ */ React57.createElement(
					StyledToggleButton,
					{
		...
		getCssDimensionProps(label, isSiteRtl).map((row, index) =>
			/* @__PURE__ */ React57.createElement(
				import_ui42.Stack,
				{ direction: 'row', gap: 2, flexWrap: 'nowrap', key: index, ref: gridRowRefs[index] },
				row.map(({ icon, ...props }) =>
					/* @__PURE__ */ React57.createElement(
						import_ui42.Grid,
						{ container: true, gap: 0.75, alignItems: 'center', key: props.bind },
						/* @__PURE__ */ React57.createElement(
							import_ui42.Grid,
							{ item: true, xs: 12 },
							/* @__PURE__ */ React57.createElement(Label, { ...props })
						),
						/* @__PURE__ */ React57.createElement(
							import_ui42.Grid,
							{ item: true, xs: 12 },
							/* @__PURE__ */ React57.createElement(Control3, {
								bind: props.bind,
...
var Control3 = ({ bind, ariaLabel, startIcon, isLinked, extendedOptions, anchorRef, min }) => {
	if (isLinked) {
		return /* @__PURE__ */ React57.createElement(SizeControl, {
			ariaLabel,
			startIcon,
			extendedOptions,
			anchorRef,
	...
	return /* @__PURE__ */ React57.createElement(
		PropKeyProvider,
		{ bind },
		/* @__PURE__ */ React57.createElement(SizeControl, {
			ariaLabel,
			startIcon,
			extendedOptions,
			anchorRef,
...
var Label = ({ label, bind }) => {
	return /* @__PURE__ */ React57.createElement(
		PropKeyProvider,
		{ bind },
		/* @__PURE__ */ React57.createElement(ControlLabel, null, label)
	);
};
	...
	return [
		[
			...
			},
			{
				bind: 'inline-end',
				label: isSiteRtl
					? (0, import_i18n18.__)('Left', 'elementor')
					: (0, import_i18n18.__)('Right', 'elementor'),
				ariaLabel: isSiteRtl
					? /* translators: %s is the name of the main group (margin or padding) */
				...
				icon: isSiteRtl
					? /* @__PURE__ */ React57.createElement(import_icons10.SideLeftIcon, { fontSize: 'tiny' })
					: /* @__PURE__ */ React57.createElement(import_icons10.SideRightIcon, { fontSize: 'tiny' }),
			},
		],
		[
			{
...
const React59 = __toESM(require('react'));
const import_editor_props20 = require('@elementor/editor-props');
const import_icons11 = require('@elementor/icons');
const import_ui44 = require('@elementor/ui');
const import_i18n20 = require('@wordpress/i18n');

// src/components/item-selector.tsx
const React58 = __toESM(require('react'));
const import_react29 = require('react');
const import_editor_ui5 = require('@elementor/editor-ui');
const import_ui43 = require('@elementor/ui');
const import_utils3 = require('@elementor/utils');
const import_i18n19 = require('@wordpress/i18n');

// src/hooks/use-filtered-items-list.ts
const useFilteredItemsList = (itemsList, searchValue, disabledItems) => {
...
var ItemSelector = ({
	...
	return /* @__PURE__ */ React58.createElement(
		import_editor_ui5.PopoverBody,
		{ width: sectionWidth, id },
		/* @__PURE__ */ React58.createElement(import_editor_ui5.PopoverHeader, {
			title,
			onClose: handleClose,
			icon: /* @__PURE__ */ React58.createElement(IconComponent, { fontSize: 'tiny' }),
		}),
		/* @__PURE__ */ React58.createElement(import_editor_ui5.SearchField, {
			value: searchValue,
			onSearch: handleSearch,
			placeholder: (0, import_i18n19.__)('Search', 'elementor'),
			id: id + '-search',
		}),
		/* @__PURE__ */ React58.createElement(import_ui43.Divider, null),
		/* @__PURE__ */ React58.createElement(
			import_ui43.Box,
			{ sx: { flex: 1, overflow: 'auto', minHeight: 0 } },
			filteredItemsList.length > 0
				? /* @__PURE__ */ React58.createElement(ItemList, {
				...
				: /* @__PURE__ */ React58.createElement(
						...
						/* @__PURE__ */ React58.createElement(
							...
							/* @__PURE__ */ React58.createElement(
								...
								{ align: 'center', variant: 'subtitle2', color: 'text.secondary' },
								(0, import_i18n19.__)('Sorry, nothing matched', 'elementor')
							),
							/* @__PURE__ */ React58.createElement(
								import_ui43.Typography,
								{
...
var ItemList = ({
	...
	return /* @__PURE__ */ React58.createElement(import_editor_ui5.PopoverMenuList, {
		items: itemListItems,
...
var FontFamilyControl = createControl(({ fontFamilies, sectionWidth, ariaLabel }) => {
	...
	return /* @__PURE__ */ React59.createElement(
		...
		/* @__PURE__ */ React59.createElement(
			ControlActions,
			null,
			/* @__PURE__ */ React59.createElement(import_ui44.UnstableTag, {
		...
		/* @__PURE__ */ React59.createElement(
			...
			/* @__PURE__ */ React59.createElement(ItemSelector, {
...
const React60 = __toESM(require('react'));
const import_editor_props21 = require('@elementor/editor-props');
const import_ui45 = require('@elementor/ui');
var UrlControl = createControl(({ placeholder, ariaLabel }) => {
	const { value, setValue, disabled } = useBoundProp(import_editor_props21.urlPropTypeUtil);
	const handleChange = (event) => setValue(event.target.value);
	return /* @__PURE__ */ React60.createElement(
		ControlActions,
		null,
		/* @__PURE__ */ React60.createElement(import_ui45.TextField, {
			size: 'tiny',
			fullWidth: true,
			value: value ?? '',
			disabled,
...
const React65 = __toESM(require('react'));
const import_react32 = require('react');
const import_editor_elements2 = require('@elementor/editor-elements');
const import_editor_props24 = require('@elementor/editor-props');
const import_icons15 = require('@elementor/icons');
const import_session = require('@elementor/session');
const import_ui49 = require('@elementor/ui');
const import_utils5 = require('@elementor/utils');
const import_i18n23 = require('@wordpress/i18n');

// src/components/restricted-link-infotip.tsx
const React61 = __toESM(require('react'));
const import_editor_elements = require('@elementor/editor-elements');
const import_icons12 = require('@elementor/icons');
const import_ui46 = require('@elementor/ui');
const import_i18n21 = require('@wordpress/i18n');
...
const RestrictedLinkInfotip = ({ linkInLinkRestriction, isVisible, children }) => {
	...
	const content = /* @__PURE__ */ React61.createElement(
		...
		/* @__PURE__ */ React61.createElement(
			import_ui46.AlertTitle,
			null,
			(0, import_i18n21.__)('Nested links', 'elementor')
		),
		/* @__PURE__ */ React61.createElement(
			import_ui46.Box,
			{ component: 'span' },
			...
			/* @__PURE__ */ React61.createElement(
				import_ui46.Link,
				{ href: learnMoreButton.href, target: '_blank', color: 'info.main' },
...
const React63 = __toESM(require('react'));
const import_react31 = require('react');
const import_editor_props22 = require('@elementor/editor-props');
const import_http_client2 = require('@elementor/http-client');
const import_icons14 = require('@elementor/icons');
const import_utils4 = require('@elementor/utils');
const import_i18n22 = require('@wordpress/i18n');

// src/components/autocomplete.tsx
const React62 = __toESM(require('react'));
const import_react30 = require('react');
const import_icons13 = require('@elementor/icons');
const import_ui47 = require('@elementor/ui');
const Autocomplete2 = (0, import_react30.forwardRef)((props, ref) => {
	const {
		options,
		onOptionChange,
		onTextChange,
	...
	return /* @__PURE__ */ React62.createElement(import_ui47.Autocomplete, {
		...restProps,
		ref,
		...
		groupBy: isCategorizedOptionPool(options)
			? (optionId) => findMatchingOption(options, optionId)?.groupLabel || optionId
			: void 0,
		...
		renderOption: (optionProps, optionId) =>
			/* @__PURE__ */ React62.createElement(
				import_ui47.Box,
				{ component: 'li', ...optionProps, key: optionProps.id },
				findMatchingOption(options, optionId)?.label ?? optionId
			),
		renderInput: (params) =>
			/* @__PURE__ */ React62.createElement(TextInput, {
				params,
...
var TextInput = ({
	...
	return /* @__PURE__ */ React62.createElement(import_ui47.TextField, {
		...params,
		placeholder,
		onChange,
...
var ClearButton = ({ allowClear, handleChange, params }) =>
	/* @__PURE__ */ React62.createElement(
		import_ui47.InputAdornment,
		{ position: 'end' },
		allowClear &&
			/* @__PURE__ */ React62.createElement(
				import_ui47.IconButton,
				{ size: params.size, onClick: () => handleChange(null), sx: { cursor: 'pointer' } },
				/* @__PURE__ */ React62.createElement(import_icons13.XIcon, { fontSize: params.size })
			)
	);
...
var QueryControl = createControl((props) => {
	...
	const [options, setOptions] = (0, import_react31.useState)(generateFirstLoadedOption(value?.value));
	const onOptionChange = (newValue) => {
		...
		const valueToSave = {
			...
			value: {
				...
				label: import_editor_props22.stringPropTypeUtil.create(
					findMatchingOption(options, newValue)?.label || null
				),
			},
		};
	...
	return /* @__PURE__ */ React63.createElement(
		ControlActions,
		null,
		/* @__PURE__ */ React63.createElement(Autocomplete2, {
			options,
			allowCustomValues,
...
const React64 = __toESM(require('react'));
const import_editor_props23 = require('@elementor/editor-props');
const import_ui48 = require('@elementor/ui');
var SwitchControl = createControl(() => {
	...
	return /* @__PURE__ */ React64.createElement(
		...
		/* @__PURE__ */ React64.createElement(import_ui48.Switch, {
			checked: !!value,
			onChange: handleChange,
			size: 'small',
			disabled,
		...
		/* @__PURE__ */ React65.createElement(
			...
			/* @__PURE__ */ React65.createElement(
				...
				/* @__PURE__ */ React65.createElement(
					...
					{ isVisible: !isActive, linkInLinkRestriction },
					/* @__PURE__ */ React65.createElement(ToggleIconControl, {
			...
			/* @__PURE__ */ React65.createElement(
				import_ui49.Collapse,
				{ in: isActive, timeout: 'auto', unmountOnExit: true },
				/* @__PURE__ */ React65.createElement(
					import_ui49.Stack,
					{ gap: 1.5 },
					/* @__PURE__ */ React65.createElement(
						PropKeyProvider,
						{ bind: 'destination' },
						/* @__PURE__ */ React65.createElement(QueryControl, {
							queryOptions,
							allowCustomValues,
							minInputLength,
							placeholder,
						...
						/* @__PURE__ */ React65.createElement(
							...
							/* @__PURE__ */ React65.createElement(
								...
								/* @__PURE__ */ React65.createElement(
									ControlFormLabel,
									null,
									(0, import_i18n23.__)('Open in a new tab', 'elementor')
								)
							),
							/* @__PURE__ */ React65.createElement(
								import_ui49.Grid,
								{ item: true, sx: { marginInlineEnd: -1 } },
								/* @__PURE__ */ React65.createElement(SwitchControl, null)
							)
						)
					)
				)
...
var ToggleIconControl = ({ disabled, active, onIconClick, label }) => {
	return /* @__PURE__ */ React65.createElement(
		...
		{ size: SIZE7, onClick: onIconClick, 'aria-label': label, disabled },
		active
			? /* @__PURE__ */ React65.createElement(import_icons15.MinusIcon, { fontSize: SIZE7 })
			: /* @__PURE__ */ React65.createElement(import_icons15.PlusIcon, { fontSize: SIZE7 })
	);
};

// src/controls/html-tag-control.tsx
const React67 = __toESM(require('react'));
const import_editor_elements3 = require('@elementor/editor-elements');
const import_editor_props25 = require('@elementor/editor-props');
const import_editor_ui7 = require('@elementor/editor-ui');
const import_ui52 = require('@elementor/ui');
const import_i18n24 = require('@wordpress/i18n');

// src/components/conditional-control-infotip.tsx
const React66 = __toESM(require('react'));
const import_editor_ui6 = require('@elementor/editor-ui');
const import_ui50 = require('@elementor/ui');
const import_ui51 = require('@elementor/ui');
const DEFAULT_COLOR = 'secondary';
const ConditionalControlInfotip = React66.forwardRef(
						...
						/* @__PURE__ */ React66.createElement(
							import_ui50.Infotip,
							{
								...
								content: /* @__PURE__ */ React66.createElement(
									...
									/* @__PURE__ */ React66.createElement(
										import_ui50.Box,
										{ sx: { flexDirection: 'column', display: 'flex', gap: 0.5 } },
										/* @__PURE__ */ React66.createElement(import_ui50.AlertTitle, null, title),
										/* @__PURE__ */ React66.createElement(import_ui50.Box, null, description)
									)
								),
							},
							children
...
// src/controls/html-tag-control.tsx
const StyledSelect = (0, import_ui52.styled)(import_ui52.Select)(() => ({
...
const React68 = __toESM(require('react'));
const import_react33 = require('react');
const import_editor_props26 = require('@elementor/editor-props');
const import_editor_responsive3 = require('@elementor/editor-responsive');
const import_icons16 = require('@elementor/icons');
const import_ui53 = require('@elementor/ui');
const import_i18n25 = require('@wordpress/i18n');
var GapControl = ({ label }) => {
	...
	return /* @__PURE__ */ React68.createElement(
		...
		/* @__PURE__ */ React68.createElement(
			import_ui53.Stack,
			{ direction: 'row', gap: 2, flexWrap: 'nowrap' },
			/* @__PURE__ */ React68.createElement(ControlLabel, null, label),
			/* @__PURE__ */ React68.createElement(
				import_ui53.Tooltip,
				{ title: isLinked ? unlinkedLabel : linkedLabel, placement: 'top' },
				/* @__PURE__ */ React68.createElement(
		...
		/* @__PURE__ */ React68.createElement(
			import_ui53.Stack,
			{ direction: 'row', gap: 2, flexWrap: 'nowrap', ref: stackRef },
			/* @__PURE__ */ React68.createElement(
				import_ui53.Grid,
				{ container: true, gap: 0.75, alignItems: 'center' },
				/* @__PURE__ */ React68.createElement(
					...
					/* @__PURE__ */ React68.createElement(
						ControlFormLabel,
						null,
						(0, import_i18n25.__)('Column', 'elementor')
					)
				),
				/* @__PURE__ */ React68.createElement(
					import_ui53.Grid,
					{ item: true, xs: 12 },
					/* @__PURE__ */ React68.createElement(Control4, {
						bind: 'column',
			...
			/* @__PURE__ */ React68.createElement(
				...
				/* @__PURE__ */ React68.createElement(
					...
					/* @__PURE__ */ React68.createElement(
						ControlFormLabel,
						null,
						(0, import_i18n25.__)('Row', 'elementor')
					)
				),
				/* @__PURE__ */ React68.createElement(
					import_ui53.Grid,
...
var Control4 = ({ bind, ariaLabel, isLinked, anchorRef }) => {
	if (isLinked) {
	...
	return /* @__PURE__ */ React68.createElement(
		PropKeyProvider,
		{ bind },
		/* @__PURE__ */ React68.createElement(SizeControl, { anchorRef, ariaLabel })
	);
};

// src/controls/aspect-ratio-control.tsx
const React69 = __toESM(require('react'));
const import_react34 = require('react');
const import_editor_props27 = require('@elementor/editor-props');
const import_editor_ui8 = require('@elementor/editor-ui');
const import_icons17 = require('@elementor/icons');
const import_ui54 = require('@elementor/ui');
const import_i18n26 = require('@wordpress/i18n');
const RATIO_OPTIONS = [
...
var AspectRatioControl = createControl(({ label }) => {
	...
	return /* @__PURE__ */ React69.createElement(
		...
		/* @__PURE__ */ React69.createElement(
			...
			/* @__PURE__ */ React69.createElement(
				import_ui54.Grid,
				{ container: true, gap: 2, alignItems: 'center', flexWrap: 'nowrap' },
				/* @__PURE__ */ React69.createElement(
					import_ui54.Grid,
					{ item: true, xs: 6 },
					/* @__PURE__ */ React69.createElement(ControlLabel, null, label)
				),
				/* @__PURE__ */ React69.createElement(
					import_ui54.Grid,
					{ item: true, xs: 6 },
					/* @__PURE__ */ React69.createElement(
						...
						[
							...RATIO_OPTIONS,
							{ label: (0, import_i18n26.__)('Custom', 'elementor'), value: CUSTOM_RATIO },
			...
			isCustom &&
				/* @__PURE__ */ React69.createElement(
					...
					/* @__PURE__ */ React69.createElement(
						import_ui54.Grid,
						{ item: true, xs: 6 },
						/* @__PURE__ */ React69.createElement(import_ui54.TextField, {
							size: 'tiny',
							type: 'number',
							fullWidth: true,
							disabled,
							...
							InputProps: {
								startAdornment: /* @__PURE__ */ React69.createElement(
									import_icons17.ArrowsMoveHorizontalIcon,
									{ fontSize: 'tiny' }
								),
							},
						})
					...
					/* @__PURE__ */ React69.createElement(
						...
						/* @__PURE__ */ React69.createElement(import_ui54.TextField, {
							...
							InputProps: {
								startAdornment: /* @__PURE__ */ React69.createElement(
									import_icons17.ArrowsMoveVerticalIcon,
									{ fontSize: 'tiny' }
								),
							},
						})
...
const React71 = __toESM(require('react'));
const import_react36 = require('react');
const import_editor_current_user = require('@elementor/editor-current-user');
const import_editor_props28 = require('@elementor/editor-props');
const import_icons18 = require('@elementor/icons');
const import_ui56 = require('@elementor/ui');
const import_wp_media2 = require('@elementor/wp-media');
const import_i18n28 = require('@wordpress/i18n');

// src/components/enable-unfiltered-modal.tsx
const React70 = __toESM(require('react'));
const import_react35 = require('react');
const import_ui55 = require('@elementor/ui');
const import_i18n27 = require('@wordpress/i18n');
const ADMIN_TITLE_TEXT = (0, import_i18n27.__)('Enable Unfiltered Uploads', 'elementor');
const ADMIN_CONTENT_TEXT = (0, import_i18n27.__)(
...
const ADMIN_FAILED_CONTENT_TEXT_PT1 = (0, import_i18n27.__)('Failed to enable unfiltered files upload.', 'elementor');
const ADMIN_FAILED_CONTENT_TEXT_PT2 = (0, import_i18n27.__)(
	'You can try again, if the problem persists, please contact support.',
	'elementor'
);
const WAIT_FOR_CLOSE_TIMEOUT_MS = 300;
const EnableUnfilteredModal = (props) => {
...
var AdminDialog = ({ open, onClose, handleEnable, isPending, isError }) =>
	/* @__PURE__ */ React70.createElement(
		import_ui55.Dialog,
		{ open, maxWidth: 'sm', onClose: () => onClose(false) },
		/* @__PURE__ */ React70.createElement(
			import_ui55.DialogHeader,
			{ logo: false },
			/* @__PURE__ */ React70.createElement(import_ui55.DialogTitle, null, ADMIN_TITLE_TEXT)
		),
		/* @__PURE__ */ React70.createElement(import_ui55.Divider, null),
		/* @__PURE__ */ React70.createElement(
			import_ui55.DialogContent,
			null,
			/* @__PURE__ */ React70.createElement(
				import_ui55.DialogContentText,
				null,
				isError
					? /* @__PURE__ */ React70.createElement(
							React70.Fragment,
							null,
							ADMIN_FAILED_CONTENT_TEXT_PT1,
							' ',
							/* @__PURE__ */ React70.createElement('br', null),
							' ',
							ADMIN_FAILED_CONTENT_TEXT_PT2
						)
					: ADMIN_CONTENT_TEXT
			)
		),
		/* @__PURE__ */ React70.createElement(
			import_ui55.DialogActions,
			null,
			/* @__PURE__ */ React70.createElement(
				import_ui55.Button,
				{ size: 'medium', color: 'secondary', onClick: () => onClose(false) },
				(0, import_i18n27.__)('Cancel', 'elementor')
			),
			/* @__PURE__ */ React70.createElement(
				import_ui55.Button,
				{
				...
				isPending
					? /* @__PURE__ */ React70.createElement(import_ui55.CircularProgress, { size: 24 })
					: (0, import_i18n27.__)('Enable', 'elementor')
			)
		)
	);
...
const StyledCard = (0, import_ui56.styled)(import_ui56.Card)`
	...
	border: none;
`;
const StyledCardMediaContainer = (0, import_ui56.styled)(import_ui56.Stack)`
	position: relative;
	height: 140px;
	object-fit: contain;
	padding: 5px;
...
`;
const MODE_BROWSE = { mode: 'browse' };
const MODE_UPLOAD = { mode: 'upload' };
var SvgMediaControl = createControl(() => {
	...
	const infotipProps = {
		...
		description: /* @__PURE__ */ React71.createElement(
			...
			(0, import_i18n28.__)('file uploads.', 'elementor')
		),
		isEnabled: !isAdmin,
	};
	return /* @__PURE__ */ React71.createElement(
		import_ui56.Stack,
		{ gap: 1, 'aria-label': 'SVG Control' },
		/* @__PURE__ */ React71.createElement(EnableUnfilteredModal, {
		...
		/* @__PURE__ */ React71.createElement(
			...
			/* @__PURE__ */ React71.createElement(
				...
				/* @__PURE__ */ React71.createElement(
					...
					null,
					isFetching
						? /* @__PURE__ */ React71.createElement(import_ui56.CircularProgress, { role: 'progressbar' })
						: /* @__PURE__ */ React71.createElement(import_ui56.CardMedia, {
								component: 'img',
								image: src,
					...
					/* @__PURE__ */ React71.createElement(
						...
						/* @__PURE__ */ React71.createElement(
							...
							/* @__PURE__ */ React71.createElement(
								...
								null,
								/* @__PURE__ */ React71.createElement(
									import_ui56.ThemeProvider,
									{ colorScheme: isAdmin ? 'light' : 'dark' },
									/* @__PURE__ */ React71.createElement(
										import_ui56.Button,
										{
											size: 'tiny',
...
const React72 = __toESM(require('react'));
const import_editor_props29 = require('@elementor/editor-props');
const import_icons19 = require('@elementor/icons');
const import_ui57 = require('@elementor/ui');
const import_wp_media3 = require('@elementor/wp-media');
const import_i18n29 = require('@wordpress/i18n');
...
var VideoPreview = ({ isFetching = false, videoUrl }) => {
	...
	if (videoUrl) {
		return /* @__PURE__ */ React72.createElement('video', {
			src: videoUrl,
			muted: true,
			preload: 'metadata',
			style: {
...
const React79 = __toESM(require('react'));
const import_editor_props35 = require('@elementor/editor-props');
const import_ui65 = require('@elementor/ui');
const import_i18n35 = require('@wordpress/i18n');

// src/controls/background-control/background-overlay/background-overlay-repeater-control.tsx
const React78 = __toESM(require('react'));
const import_editor_props34 = require('@elementor/editor-props');
const import_ui64 = require('@elementor/ui');
const import_wp_media4 = require('@elementor/wp-media');
const import_i18n34 = require('@wordpress/i18n');

// src/env.ts
const import_env = require('@elementor/env');
const { env } = (0, import_env.parseEnv)('@elementor/editor-controls');

// src/controls/background-control/background-gradient-color-control.tsx
const React73 = __toESM(require('react'));
const import_editor_props30 = require('@elementor/editor-props');
const import_ui58 = require('@elementor/ui');
const BackgroundGradientColorControl = createControl(() => {
	...
	const createTransformableValue = (newValue) => ({
		...
		stops: import_editor_props30.gradientColorStopPropTypeUtil.create(
			newValue.stops.map(({ color, offset }) =>
	...
	return /* @__PURE__ */ React73.createElement(import_ui58.UnstableGradientBox, {
		sx: { width: 'auto', padding: 1.5 },
		value: normalizeValue(),
		onChange: handleChange,
	});
});
const initialBackgroundGradientOverlay = import_editor_props30.backgroundGradientOverlayPropTypeUtil.create({
...
const React74 = __toESM(require('react'));
const import_icons20 = require('@elementor/icons');
const import_ui59 = require('@elementor/ui');
const import_i18n30 = require('@wordpress/i18n');
const attachmentControlOptions = [
	{
		value: 'fixed',
	...
	},
	{
		...
		renderContent: ({ size }) =>
			/* @__PURE__ */ React74.createElement(import_icons20.PinnedOffIcon, { fontSize: size }),
		showTooltip: true,
	},
];
const BackgroundImageOverlayAttachment = () => {
	return /* @__PURE__ */ React74.createElement(
		...
		/* @__PURE__ */ React74.createElement(
			...
			/* @__PURE__ */ React74.createElement(
				ControlFormLabel,
				null,
				(0, import_i18n30.__)('Attachment', 'elementor')
			)
		),
		/* @__PURE__ */ React74.createElement(
			import_ui59.Grid,
			{ item: true, xs: 6, sx: { display: 'flex', justifyContent: 'flex-end', overflow: 'hidden' } },
			/* @__PURE__ */ React74.createElement(ToggleControl, { options: attachmentControlOptions })
		)
	);
};

// src/controls/background-control/background-overlay/background-image-overlay/background-image-overlay-position.tsx
const React75 = __toESM(require('react'));
const import_react37 = require('react');
const import_editor_props31 = require('@elementor/editor-props');
const import_editor_ui9 = require('@elementor/editor-ui');
const import_icons21 = require('@elementor/icons');
const import_ui60 = require('@elementor/ui');
const import_i18n31 = require('@wordpress/i18n');
...
const BackgroundImageOverlayPosition = () => {
	...
	return /* @__PURE__ */ React75.createElement(
			...
			/* @__PURE__ */ React75.createElement(
				...
				/* @__PURE__ */ React75.createElement(
					...
					/* @__PURE__ */ React75.createElement(
						ControlFormLabel,
						null,
						(0, import_i18n31.__)('Position', 'elementor')
					)
				),
				/* @__PURE__ */ React75.createElement(
					import_ui60.Grid,
		...
		isCustom
			? /* @__PURE__ */ React75.createElement(
					PropProvider,
					{ ...backgroundImageOffsetContext },
					/* @__PURE__ */ React75.createElement(
						import_ui60.Grid,
						{ item: true, xs: 12 },
						/* @__PURE__ */ React75.createElement(
							import_ui60.Grid,
							{ container: true, spacing: 1.5, ref: rowRef },
							/* @__PURE__ */ React75.createElement(
								import_ui60.Grid,
								{ item: true, xs: 6 },
								/* @__PURE__ */ React75.createElement(
									PropKeyProvider,
									{ bind: 'x' },
									/* @__PURE__ */ React75.createElement(SizeControl, {
										startIcon: /* @__PURE__ */ React75.createElement(import_icons21.LetterXIcon, {
											fontSize: 'tiny',
										}),
										anchorRef: rowRef,
										min: -Number.MAX_SAFE_INTEGER,
							...
							/* @__PURE__ */ React75.createElement(
								...
								/* @__PURE__ */ React75.createElement(
									...
									{ bind: 'y' },
									/* @__PURE__ */ React75.createElement(SizeControl, {
										startIcon: /* @__PURE__ */ React75.createElement(import_icons21.LetterYIcon, {
											fontSize: 'tiny',
										}),
										anchorRef: rowRef,
										min: -Number.MAX_SAFE_INTEGER,
...
const React76 = __toESM(require('react'));
const import_icons22 = require('@elementor/icons');
const import_ui61 = require('@elementor/ui');
const import_i18n32 = require('@wordpress/i18n');
const repeatControlOptions = [
	{
		value: 'repeat',
		label: (0, import_i18n32.__)('Repeat', 'elementor'),
		renderContent: ({ size }) =>
			/* @__PURE__ */ React76.createElement(import_icons22.GridDotsIcon, { fontSize: size }),
		showTooltip: true,
	},
	{
		value: 'repeat-x',
		...
		renderContent: ({ size }) =>
			/* @__PURE__ */ React76.createElement(import_icons22.DotsHorizontalIcon, { fontSize: size }),
		showTooltip: true,
	},
	{
		value: 'repeat-y',
		...
		renderContent: ({ size }) =>
			/* @__PURE__ */ React76.createElement(import_icons22.DotsVerticalIcon, { fontSize: size }),
		showTooltip: true,
	},
	{
		value: 'no-repeat',
...
const BackgroundImageOverlayRepeat = () => {
	return /* @__PURE__ */ React76.createElement(
		...
		/* @__PURE__ */ React76.createElement(
			import_ui61.Grid,
			{ item: true, xs: 6 },
			/* @__PURE__ */ React76.createElement(ControlFormLabel, null, (0, import_i18n32.__)('Repeat', 'elementor'))
		),
		/* @__PURE__ */ React76.createElement(
			import_ui61.Grid,
			{ item: true, xs: 6, sx: { display: 'flex', justifyContent: 'flex-end' } },
			/* @__PURE__ */ React76.createElement(ToggleControl, { options: repeatControlOptions })
		)
	);
};

// src/controls/background-control/background-overlay/background-image-overlay/background-image-overlay-size.tsx
const React77 = __toESM(require('react'));
const import_react38 = require('react');
const import_editor_props32 = require('@elementor/editor-props');
const import_icons23 = require('@elementor/icons');
const import_ui62 = require('@elementor/ui');
const import_i18n33 = require('@wordpress/i18n');
const sizeControlOptions = [
	{
		value: 'auto',
		label: (0, import_i18n33.__)('Auto', 'elementor'),
		renderContent: ({ size }) =>
			/* @__PURE__ */ React77.createElement(import_icons23.LetterAIcon, { fontSize: size }),
		showTooltip: true,
	},
	{
		value: 'cover',
		...
		renderContent: ({ size }) =>
			/* @__PURE__ */ React77.createElement(import_icons23.ArrowsMaximizeIcon, { fontSize: size }),
		showTooltip: true,
	},
	{
		value: 'contain',
		...
		renderContent: ({ size }) =>
			/* @__PURE__ */ React77.createElement(import_icons23.ArrowBarBothIcon, { fontSize: size }),
		showTooltip: true,
	},
	{
		value: 'custom',
		...
		renderContent: ({ size }) =>
			/* @__PURE__ */ React77.createElement(import_icons23.PencilIcon, { fontSize: size }),
		showTooltip: true,
	},
];
const BackgroundImageOverlaySize = () => {
	...
	return /* @__PURE__ */ React77.createElement(
			...
			/* @__PURE__ */ React77.createElement(
				...
				/* @__PURE__ */ React77.createElement(
					...
					/* @__PURE__ */ React77.createElement(
						ControlFormLabel,
						null,
						(0, import_i18n33.__)('Size', 'elementor')
					)
				),
				/* @__PURE__ */ React77.createElement(
					import_ui62.Grid,
					{ item: true, xs: 6, sx: { display: 'flex', justifyContent: 'flex-end' } },
					/* @__PURE__ */ React77.createElement(ControlToggleButtonGroup, {
						exclusive: true,
		...
		isCustom
			? /* @__PURE__ */ React77.createElement(
					PropProvider,
					{ ...backgroundImageScaleContext },
					/* @__PURE__ */ React77.createElement(
						import_ui62.Grid,
						{ item: true, xs: 12, ref: rowRef },
						/* @__PURE__ */ React77.createElement(
							PopoverGridContainer,
							null,
							/* @__PURE__ */ React77.createElement(
								...
								/* @__PURE__ */ React77.createElement(
									PropKeyProvider,
									{ bind: 'width' },
									/* @__PURE__ */ React77.createElement(SizeControl, {
										startIcon: /* @__PURE__ */ React77.createElement(
											import_icons23.ArrowsMoveHorizontalIcon,
											{ fontSize: 'tiny' }
										),
							...
							/* @__PURE__ */ React77.createElement(
								...
								/* @__PURE__ */ React77.createElement(
									...
									/* @__PURE__ */ React77.createElement(SizeControl, {
										startIcon: /* @__PURE__ */ React77.createElement(
											import_icons23.ArrowsMoveVerticalIcon,
											{ fontSize: 'tiny' }
										),
										extendedOptions: ['auto'],
										anchorRef: rowRef,
...
const import_react39 = require('react');
const import_editor_props33 = require('@elementor/editor-props');
const import_ui63 = require('@elementor/ui');
const useBackgroundTabsHistory = ({
	color: initialBackgroundColorOverlay2,
	image: initialBackgroundImageOverlay,
	gradient: initialBackgroundGradientOverlay2,
}) => {
	const { value: imageValue, setValue: setImageValue } = useBoundProp(
		import_editor_props33.backgroundImageOverlayPropTypeUtil
	);
	const { value: colorValue, setValue: setColorValue } = useBoundProp(
		import_editor_props33.backgroundColorOverlayPropTypeUtil
	);
	const { value: gradientValue, setValue: setGradientValue } = useBoundProp(
		import_editor_props33.backgroundGradientOverlayPropTypeUtil
	);
...
const initialBackgroundColorOverlay = import_editor_props34.backgroundColorOverlayPropTypeUtil.create({
	color: import_editor_props34.colorPropTypeUtil.create(DEFAULT_BACKGROUND_COLOR_OVERLAY_COLOR),
});
const getInitialBackgroundOverlay = () => ({
...
const BackgroundOverlayRepeaterControl = createControl(() => {
	const {
		propType,
		value: overlayValues,
		setValue,
	} = useBoundProp(import_editor_props34.backgroundOverlayPropTypeUtil);
	return /* @__PURE__ */ React78.createElement(
		PropProvider,
		{ propType, value: overlayValues, setValue },
		/* @__PURE__ */ React78.createElement(
			...
			/* @__PURE__ */ React78.createElement(
				RepeaterHeader,
				{ label: (0, import_i18n34.__)('Overlay', 'elementor') },
				/* @__PURE__ */ React78.createElement(TooltipAddItemAction, { newItemIndex: 0 })
			),
			/* @__PURE__ */ React78.createElement(
				ItemsContainer,
				null,
				/* @__PURE__ */ React78.createElement(Item, {
					Icon: ItemIcon2,
					Label: ItemLabel2,
					actions: /* @__PURE__ */ React78.createElement(
						React78.Fragment,
						null,
						/* @__PURE__ */ React78.createElement(DuplicateItemAction, null),
						/* @__PURE__ */ React78.createElement(DisableItemAction, null),
						/* @__PURE__ */ React78.createElement(RemoveItemAction, null)
					),
				})
			),
			/* @__PURE__ */ React78.createElement(
				EditItemPopover,
				null,
				/* @__PURE__ */ React78.createElement(ItemContent, null)
			)
		)
	);
});
	...
	return /* @__PURE__ */ React78.createElement(
		...
		/* @__PURE__ */ React78.createElement(
			...
			/* @__PURE__ */ React78.createElement(
				...
				/* @__PURE__ */ React78.createElement(import_ui64.Tab, {
					label: (0, import_i18n34.__)('Image', 'elementor'),
					...getTabProps('image'),
				}),
				/* @__PURE__ */ React78.createElement(import_ui64.Tab, {
					label: (0, import_i18n34.__)('Gradient', 'elementor'),
					...getTabProps('gradient'),
				}),
				/* @__PURE__ */ React78.createElement(import_ui64.Tab, {
					label: (0, import_i18n34.__)('Color', 'elementor'),
					...getTabProps('color'),
				})
			)
		),
		/* @__PURE__ */ React78.createElement(
			import_ui64.TabPanel,
			{ sx: { p: 1.5 }, ...getTabPanelProps('image') },
			/* @__PURE__ */ React78.createElement(
				PopoverContent,
				null,
				/* @__PURE__ */ React78.createElement(ImageOverlayContent, null)
			)
		),
		/* @__PURE__ */ React78.createElement(
			import_ui64.TabPanel,
			{ sx: { p: 1.5 }, ...getTabPanelProps('gradient') },
			/* @__PURE__ */ React78.createElement(BackgroundGradientColorControl, null)
		),
		/* @__PURE__ */ React78.createElement(
			import_ui64.TabPanel,
			{ sx: { p: 1.5 }, ...getTabPanelProps('color') },
			/* @__PURE__ */ React78.createElement(
				PopoverContent,
				null,
				/* @__PURE__ */ React78.createElement(ColorOverlayContent, { anchorEl: rowRef })
			)
		)
	);
};
...
var ItemIconColor = ({ value: prop }) => {
	...
	return /* @__PURE__ */ React78.createElement(StyledUnstableColorIndicator3, {
		size: 'inherit',
		component: 'span',
		value: color,
	});
...
var ItemIconImage = ({ value }) => {
	...
	return /* @__PURE__ */ React78.createElement(import_ui64.CardMedia, {
		image: imageUrl,
		sx: (theme) => ({
			height: '1rem',
			width: '1rem',
...
var ItemLabelGradient = ({ value }) => {
	if (value.value.type.value === 'linear') {
		return /* @__PURE__ */ React78.createElement(
			'span',
			null,
			(0, import_i18n34.__)('Linear Gradient', 'elementor')
		);
	}
...
var ColorOverlayContent = ({ anchorEl }) => {
	...
	return /* @__PURE__ */ React78.createElement(
		...
		/* @__PURE__ */ React78.createElement(
			PropKeyProvider,
			{ bind: 'color' },
			/* @__PURE__ */ React78.createElement(ColorControl, { anchorEl })
		)
	);
};
var ImageOverlayContent = () => {
	...
	return /* @__PURE__ */ React78.createElement(
		...
		/* @__PURE__ */ React78.createElement(
			PropKeyProvider,
			{ bind: 'image' },
			/* @__PURE__ */ React78.createElement(ImageControl, { sizes: backgroundResolutionOptions })
		),
		/* @__PURE__ */ React78.createElement(
			PropKeyProvider,
			{ bind: 'position' },
			/* @__PURE__ */ React78.createElement(BackgroundImageOverlayPosition, null)
		),
		/* @__PURE__ */ React78.createElement(
			PropKeyProvider,
			{ bind: 'repeat' },
			/* @__PURE__ */ React78.createElement(BackgroundImageOverlayRepeat, null)
		),
		/* @__PURE__ */ React78.createElement(
			PropKeyProvider,
			{ bind: 'size' },
			/* @__PURE__ */ React78.createElement(BackgroundImageOverlaySize, null)
		),
		/* @__PURE__ */ React78.createElement(
			PropKeyProvider,
			{ bind: 'attachment' },
			/* @__PURE__ */ React78.createElement(BackgroundImageOverlayAttachment, null)
		)
	);
};
...
var getGradientValue = (value) => {
	...
	const stops = gradient.stops.value
		?.map(({ value: { color, offset } }) => `${color.value} ${offset.value ?? 0}%`)
		?.join(',');
...
const colorLabel = (0, import_i18n35.__)('Color', 'elementor');
const clipLabel = (0, import_i18n35.__)('Clipping', 'elementor');
var BackgroundControl = createControl(() => {
	...
	return /* @__PURE__ */ React79.createElement(
		...
		/* @__PURE__ */ React79.createElement(
			...
			/* @__PURE__ */ React79.createElement(BackgroundOverlayRepeaterControl, null)
		),
		/* @__PURE__ */ React79.createElement(BackgroundColorField, null),
		/* @__PURE__ */ React79.createElement(BackgroundClipField, null)
	);
});
	...
	return /* @__PURE__ */ React79.createElement(
		...
		/* @__PURE__ */ React79.createElement(
			...
			/* @__PURE__ */ React79.createElement(
				import_ui65.Grid,
				{ item: true, xs: 6 },
				/* @__PURE__ */ React79.createElement(ControlLabel, null, colorLabel)
			),
			/* @__PURE__ */ React79.createElement(
				import_ui65.Grid,
				{ item: true, xs: 6 },
				/* @__PURE__ */ React79.createElement(ColorControl, null)
			)
		)
	);
};
	...
	return /* @__PURE__ */ React79.createElement(
		...
		/* @__PURE__ */ React79.createElement(
			...
			/* @__PURE__ */ React79.createElement(
				import_ui65.Grid,
				{ item: true, xs: 6 },
				/* @__PURE__ */ React79.createElement(ControlLabel, null, clipLabel)
			),
			/* @__PURE__ */ React79.createElement(
				import_ui65.Grid,
				{ item: true, xs: 6 },
				/* @__PURE__ */ React79.createElement(SelectControl, { options: clipOptions })
			)
		)
	);
};
...
const React80 = __toESM(require('react'));
const import_react40 = require('react');
const import_editor_props36 = require('@elementor/editor-props');
const import_ui66 = require('@elementor/ui');
...
var RepeatableControl = createControl(
	({
		...
		const childArrayPropTypeUtil2 = (0, import_react40.useMemo)(
			() =>
				(0, import_editor_props36.createArrayPropUtils)(
			...
			/* @__PURE__ */ React80.createElement(
				...
				/* @__PURE__ */ React80.createElement(
					...
					/* @__PURE__ */ React80.createElement(
						RepeaterHeader,
						{ label: repeaterLabel },
						/* @__PURE__ */ React80.createElement(TooltipAddItemAction, {
							...addItemTooltipProps,
							newItemIndex: 0,
					...
					/* @__PURE__ */ React80.createElement(
						ItemsContainer,
						{ isSortable: false },
						/* @__PURE__ */ React80.createElement(Item, {
							Icon: ItemIcon3,
							Label: ItemLabel3,
							actions: /* @__PURE__ */ React80.createElement(
								React80.Fragment,
								null,
								showDuplicate && /* @__PURE__ */ React80.createElement(DuplicateItemAction, null),
								showToggle && /* @__PURE__ */ React80.createElement(DisableItemAction, null),
								/* @__PURE__ */ React80.createElement(RemoveItemAction, null)
							),
						})
					),
					/* @__PURE__ */ React80.createElement(
						EditItemPopover,
						null,
						/* @__PURE__ */ React80.createElement(Content2, null)
					)
				)
			)
		);
...
var Content2 = () => {
	...
	return /* @__PURE__ */ React80.createElement(
		...
		/* @__PURE__ */ React80.createElement(
			PopoverGridContainer,
			null,
			/* @__PURE__ */ React80.createElement(ChildControl, { ...props })
		)
	);
};
...
const shouldShowPlaceholder = (pattern, data) => {
...
const getTextColor = (isReadOnly, showPlaceholder) => {
	if (isReadOnly) {
...
const React81 = __toESM(require('react'));
const import_react41 = require('react');
const import_editor_props37 = require('@elementor/editor-props');
const import_ui67 = require('@elementor/ui');
const import_i18n36 = require('@wordpress/i18n');
...
// src/controls/key-value-control.tsx
const getInitialFieldValue = (fieldValue) => {
...
var KeyValueControl = createControl((props = {}) => {
	...
	return /* @__PURE__ */ React81.createElement(
		PropProvider,
		{ ...propContext, value, setValue: handleChange },
		/* @__PURE__ */ React81.createElement(
			import_ui67.Grid,
			{ container: true, gap: 1.5 },
			/* @__PURE__ */ React81.createElement(
				import_ui67.Grid,
				{ item: true, xs: 12, display: 'flex', flexDirection: 'column' },
				/* @__PURE__ */ React81.createElement(import_ui67.FormLabel, { size: 'tiny', sx: { pb: 1 } }, keyLabel),
				/* @__PURE__ */ React81.createElement(
					PropKeyProvider,
					{ bind: 'key' },
					/* @__PURE__ */ React81.createElement(TextControl, {
				...
				!!keyError &&
					/* @__PURE__ */ React81.createElement(import_ui67.FormHelperText, { error: true }, keyError)
			),
			/* @__PURE__ */ React81.createElement(
				import_ui67.Grid,
				{ item: true, xs: 12, display: 'flex', flexDirection: 'column' },
				/* @__PURE__ */ React81.createElement(
					import_ui67.FormLabel,
					{ size: 'tiny', sx: { pb: 1 } },
					valueLabel
				),
				/* @__PURE__ */ React81.createElement(
				...
				!!valueError &&
					/* @__PURE__ */ React81.createElement(import_ui67.FormHelperText, { error: true }, valueError)
			)
		)
	);
});
...
const React82 = __toESM(require('react'));
const import_editor_props38 = require('@elementor/editor-props');
const import_editor_ui10 = require('@elementor/editor-ui');
const import_icons24 = require('@elementor/icons');
const import_ui68 = require('@elementor/ui');
const import_i18n37 = require('@wordpress/i18n');
			...
			/* @__PURE__ */ React82.createElement(
				...
				/* @__PURE__ */ React82.createElement(
					...
					/* @__PURE__ */ React82.createElement(
						ControlFormLabel,
						null,
						(0, import_i18n37.__)('Object position', 'elementor')
					)
				),
				/* @__PURE__ */ React82.createElement(
					import_ui68.Grid,
					...
					/* @__PURE__ */ React82.createElement(
						...
						/* @__PURE__ */ React82.createElement(
							...
							/* @__PURE__ */ React82.createElement(
								PropKeyProvider,
								{ bind: 'x' },
								/* @__PURE__ */ React82.createElement(SizeControl, {
									startIcon: /* @__PURE__ */ React82.createElement(import_icons24.LetterXIcon, {
										fontSize: 'tiny',
									}),
									min: -Number.MAX_SAFE_INTEGER,
								})
						...
						/* @__PURE__ */ React82.createElement(
							...
							/* @__PURE__ */ React82.createElement(
								...
								{ bind: 'y' },
								/* @__PURE__ */ React82.createElement(SizeControl, {
									startIcon: /* @__PURE__ */ React82.createElement(import_icons24.LetterYIcon, {
										fontSize: 'tiny',
									}),
									min: -Number.MAX_SAFE_INTEGER,
								})
...
const React95 = __toESM(require('react'));
const import_react47 = require('react');
const import_editor_props47 = require('@elementor/editor-props');
const import_icons31 = require('@elementor/icons');
const import_ui81 = require('@elementor/ui');
const import_i18n47 = require('@wordpress/i18n');

// src/controls/transform-control/initial-values.ts
const import_editor_props39 = require('@elementor/editor-props');
...
const initialScaleValue = import_editor_props39.scaleTransformPropTypeUtil.create({
...
const initialRotateValue = import_editor_props39.rotateTransformPropTypeUtil.create({
...
const initialSkewValue = import_editor_props39.skewTransformPropTypeUtil.create({
...
const React89 = __toESM(require('react'));
const import_ui76 = require('@elementor/ui');
const import_i18n42 = require('@wordpress/i18n');

// src/controls/transform-control/functions/move.tsx
const React84 = __toESM(require('react'));
const import_react42 = require('react');
const import_editor_props40 = require('@elementor/editor-props');
const import_icons25 = require('@elementor/icons');
const import_ui70 = require('@elementor/ui');
const import_i18n38 = require('@wordpress/i18n');

// src/controls/transform-control/functions/axis-row.tsx
const React83 = __toESM(require('react'));
const import_ui69 = require('@elementor/ui');
const AxisRow = ({ label, bind, startIcon, anchorRef, units: units2, variant = 'angle' }) => {
	...
	return /* @__PURE__ */ React83.createElement(
		...
		/* @__PURE__ */ React83.createElement(
			...
			/* @__PURE__ */ React83.createElement(
				import_ui69.Grid,
				{ item: true, xs: 6 },
				/* @__PURE__ */ React83.createElement(ControlLabel, { htmlFor: safeId }, label)
			),
			/* @__PURE__ */ React83.createElement(
				import_ui69.Grid,
				{ item: true, xs: 6 },
				/* @__PURE__ */ React83.createElement(
					PropKeyProvider,
					{ bind },
					/* @__PURE__ */ React83.createElement(SizeControl, {
						anchorRef,
						startIcon,
						units: units2,
						variant,
...
const Move = () => {
	...
	return /* @__PURE__ */ React84.createElement(
		...
		/* @__PURE__ */ React84.createElement(
			...
			/* @__PURE__ */ React84.createElement(
				PropKeyProvider,
				{ bind: TransformFunctionKeys.move },
				moveAxisControls.map((control, index) =>
					/* @__PURE__ */ React84.createElement(AxisRow, {
						key: control.bind,
						...control,
...
const React85 = __toESM(require('react'));
const import_react43 = require('react');
const import_editor_props41 = require('@elementor/editor-props');
const import_icons26 = require('@elementor/icons');
const import_ui71 = require('@elementor/ui');
const import_i18n39 = require('@wordpress/i18n');
const rotateAxisControls = [
	{
	...
	},
	{
		...
		bind: 'y',
		startIcon: /* @__PURE__ */ React85.createElement(import_icons26.Arrow360Icon, {
			fontSize: 'tiny',
...
const Rotate = () => {
	...
	return /* @__PURE__ */ React85.createElement(
		...
		/* @__PURE__ */ React85.createElement(
			...
			/* @__PURE__ */ React85.createElement(
				PropKeyProvider,
				{ bind: TransformFunctionKeys.rotate },
				rotateAxisControls.map((control, index) =>
					/* @__PURE__ */ React85.createElement(AxisRow, {
						key: control.bind,
						...control,
						anchorRef: rowRefs[index],
						units: rotateUnits,
...
const React87 = __toESM(require('react'));
const import_react44 = require('react');
const import_editor_props42 = require('@elementor/editor-props');
const import_icons27 = require('@elementor/icons');
const import_ui73 = require('@elementor/ui');
const import_i18n40 = require('@wordpress/i18n');

// src/controls/transform-control/functions/scale-axis-row.tsx
const React86 = __toESM(require('react'));
const import_ui72 = require('@elementor/ui');
const ScaleAxisRow = ({ label, bind, startIcon, anchorRef }) => {
	return /* @__PURE__ */ React86.createElement(
		...
		/* @__PURE__ */ React86.createElement(
			...
			/* @__PURE__ */ React86.createElement(
				import_ui72.Grid,
				{ item: true, xs: 6 },
				/* @__PURE__ */ React86.createElement(ControlLabel, null, label)
			),
			/* @__PURE__ */ React86.createElement(
				import_ui72.Grid,
				{ item: true, xs: 6 },
				/* @__PURE__ */ React86.createElement(
					PropKeyProvider,
					{ bind },
					/* @__PURE__ */ React86.createElement(NumberControl, { step: 0.1, placeholder: '1', startIcon })
				)
			)
		)
	);
...
const Scale = () => {
	...
	return /* @__PURE__ */ React87.createElement(
		...
		/* @__PURE__ */ React87.createElement(
			...
			/* @__PURE__ */ React87.createElement(
				PropKeyProvider,
				{ bind: TransformFunctionKeys.scale },
				scaleAxisControls.map((control, index) =>
					/* @__PURE__ */ React87.createElement(ScaleAxisRow, {
						key: control.bind,
						...control,
						anchorRef: rowRefs[index],
					})
...
const React88 = __toESM(require('react'));
const import_react45 = require('react');
const import_editor_props43 = require('@elementor/editor-props');
const import_icons28 = require('@elementor/icons');
const import_ui74 = require('@elementor/ui');
const import_i18n41 = require('@wordpress/i18n');
const skewAxisControls = [
	...
	},
	{
		...
		bind: 'y',
		startIcon: /* @__PURE__ */ React88.createElement(import_icons28.ArrowLeftIcon, {
			fontSize: 'tiny',
			style: { transform: 'scaleX(-1) rotate(-90deg)' },
		}),
	},
];
const skewUnits = ['deg', 'rad', 'grad', 'turn'];
const Skew = () => {
	const context = useBoundProp(import_editor_props43.skewTransformPropTypeUtil);
	const rowRefs = [
		(0, import_react45.useRef)(null),
		(0, import_react45.useRef)(null),
		(0, import_react45.useRef)(null),
	];
	return /* @__PURE__ */ React88.createElement(
		...
		/* @__PURE__ */ React88.createElement(
			...
			/* @__PURE__ */ React88.createElement(
				PropKeyProvider,
				{ bind: TransformFunctionKeys.skew },
				skewAxisControls.map((control, index) =>
					/* @__PURE__ */ React88.createElement(AxisRow, {
						key: control.bind,
						...control,
						anchorRef: rowRefs[index],
						units: skewUnits,
...
const import_react46 = require('react');
const import_editor_props44 = require('@elementor/editor-props');
const import_ui75 = require('@elementor/ui');
const useTransformTabsHistory = ({
	move: initialMove,
	scale: initialScale,
	...
	const { value: scaleValue, setValue: setScaleValue } = useBoundProp(
		import_editor_props44.scaleTransformPropTypeUtil
	);
	const { value: rotateValue, setValue: setRotateValue } = useBoundProp(
		import_editor_props44.rotateTransformPropTypeUtil
	);
		...
		/* @__PURE__ */ React89.createElement(
			...
			/* @__PURE__ */ React89.createElement(
				...
				/* @__PURE__ */ React89.createElement(
					...
					/* @__PURE__ */ React89.createElement(import_ui76.Tab, {
						label: (0, import_i18n42.__)('Move', 'elementor'),
						...getTabProps(TransformFunctionKeys.move),
					}),
					/* @__PURE__ */ React89.createElement(import_ui76.Tab, {
						label: (0, import_i18n42.__)('Scale', 'elementor'),
						...getTabProps(TransformFunctionKeys.scale),
					}),
					/* @__PURE__ */ React89.createElement(import_ui76.Tab, {
						label: (0, import_i18n42.__)('Rotate', 'elementor'),
						...getTabProps(TransformFunctionKeys.rotate),
					}),
					/* @__PURE__ */ React89.createElement(import_ui76.Tab, {
						label: (0, import_i18n42.__)('Skew', 'elementor'),
						...getTabProps(TransformFunctionKeys.skew),
					})
				)
			),
			/* @__PURE__ */ React89.createElement(
				import_ui76.TabPanel,
				{ sx: { p: 1.5 }, ...getTabPanelProps(TransformFunctionKeys.move) },
				/* @__PURE__ */ React89.createElement(Move, null)
			),
			/* @__PURE__ */ React89.createElement(
				import_ui76.TabPanel,
				{ sx: { p: 1.5 }, ...getTabPanelProps(TransformFunctionKeys.scale) },
				/* @__PURE__ */ React89.createElement(Scale, null)
			),
			/* @__PURE__ */ React89.createElement(
				import_ui76.TabPanel,
				{ sx: { p: 1.5 }, ...getTabPanelProps(TransformFunctionKeys.rotate) },
				/* @__PURE__ */ React89.createElement(Rotate, null)
			),
			/* @__PURE__ */ React89.createElement(
				import_ui76.TabPanel,
				{ sx: { p: 1.5 }, ...getTabPanelProps(TransformFunctionKeys.skew) },
				/* @__PURE__ */ React89.createElement(Skew, null)
			)
		)
	);
};
...
const React90 = __toESM(require('react'));
const import_icons29 = require('@elementor/icons');
...
const React91 = __toESM(require('react'));
const import_ui77 = require('@elementor/ui');
const import_i18n43 = require('@wordpress/i18n');
const orderedAxis = ['x', 'y', 'z'];
const formatLabel = (value, functionType) => {
	return orderedAxis
		.map((axisKey) => {
...
const TransformLabel = (props) => {
	const { $$type, value } = props.value;
	switch ($$type) {
		case TransformFunctionKeys.move:
			return /* @__PURE__ */ React91.createElement(Label2, {
				label: (0, import_i18n43.__)('Move', 'elementor'),
				value: formatLabel(value, 'move'),
			});
		case TransformFunctionKeys.scale:
			return /* @__PURE__ */ React91.createElement(Label2, {
				label: (0, import_i18n43.__)('Scale', 'elementor'),
				value: formatLabel(value, 'scale'),
			});
		case TransformFunctionKeys.rotate:
			return /* @__PURE__ */ React91.createElement(Label2, {
				label: (0, import_i18n43.__)('Rotate', 'elementor'),
				value: formatLabel(value, 'rotate'),
			});
		case TransformFunctionKeys.skew:
			return /* @__PURE__ */ React91.createElement(Label2, {
				label: (0, import_i18n43.__)('Skew', 'elementor'),
...
const React94 = __toESM(require('react'));
const import_editor_ui11 = require('@elementor/editor-ui');
const import_icons30 = require('@elementor/icons');
const import_ui80 = require('@elementor/ui');
const import_i18n46 = require('@wordpress/i18n');

// src/controls/transform-control/transform-base-controls/children-perspective-control.tsx
const React92 = __toESM(require('react'));
const import_editor_props45 = require('@elementor/editor-props');
const import_ui78 = require('@elementor/ui');
const import_i18n44 = require('@wordpress/i18n');
const ORIGIN_UNITS = ['px', '%', 'em', 'rem'];
const PERSPECTIVE_CONTROL_FIELD = {
...
const ChildrenPerspectiveControl = () => {
	return /* @__PURE__ */ React92.createElement(
		...
		/* @__PURE__ */ React92.createElement(
			ControlFormLabel,
			null,
			(0, import_i18n44.__)('Children perspective', 'elementor')
		),
		/* @__PURE__ */ React92.createElement(PerspectiveControl, null),
		/* @__PURE__ */ React92.createElement(PerspectiveOriginControl, null)
	);
};
var PerspectiveControl = () =>
	/* @__PURE__ */ React92.createElement(
		PropKeyProvider,
		{ bind: 'perspective' },
		/* @__PURE__ */ React92.createElement(ControlFields, {
			control: PERSPECTIVE_CONTROL_FIELD,
			key: PERSPECTIVE_CONTROL_FIELD.bind,
		})
	);
var PerspectiveOriginControl = () =>
	/* @__PURE__ */ React92.createElement(
		PropKeyProvider,
		{ bind: 'perspective-origin' },
		/* @__PURE__ */ React92.createElement(PerspectiveOriginControlProvider, null)
	);
var PerspectiveOriginControlProvider = () => {
	...
	return /* @__PURE__ */ React92.createElement(
		...
		CHILDREN_PERSPECTIVE_FIELDS.map((control) =>
			/* @__PURE__ */ React92.createElement(
				PropKeyProvider,
				{ bind: control.bind, key: control.bind },
				/* @__PURE__ */ React92.createElement(ControlFields, { control })
			)
		)
	);
};
var ControlFields = ({ control }) => {
	...
	return /* @__PURE__ */ React92.createElement(
		...
		/* @__PURE__ */ React92.createElement(
			import_ui78.Grid,
			{ item: true, xs: 6 },
			/* @__PURE__ */ React92.createElement(ControlFormLabel, null, control.label)
		),
		/* @__PURE__ */ React92.createElement(
			import_ui78.Grid,
			{ item: true, xs: 6 },
			/* @__PURE__ */ React92.createElement(SizeControl, {
				variant: 'length',
				units: control.units,
				anchorRef: rowRef,
				disableCustom: true,
...
const React93 = __toESM(require('react'));
const import_editor_props46 = require('@elementor/editor-props');
const import_ui79 = require('@elementor/ui');
const import_i18n45 = require('@wordpress/i18n');
...
const TransformOriginControl = () => {
	return /* @__PURE__ */ React93.createElement(
		import_ui79.Stack,
		{ direction: 'column', spacing: 1.5 },
		/* @__PURE__ */ React93.createElement(ControlFormLabel, null, (0, import_i18n45.__)('Transform', 'elementor')),
		TRANSFORM_ORIGIN_FIELDS.map((control) =>
			/* @__PURE__ */ React93.createElement(ControlFields2, { control, key: control.bind })
		)
	);
};
		...
		/* @__PURE__ */ React93.createElement(
			...
			/* @__PURE__ */ React93.createElement(
				...
				/* @__PURE__ */ React93.createElement(
					import_ui79.Grid,
					{ item: true, xs: 6 },
					/* @__PURE__ */ React93.createElement(ControlFormLabel, null, control.label)
				),
				/* @__PURE__ */ React93.createElement(
					import_ui79.Grid,
					{ item: true, xs: 6 },
					/* @__PURE__ */ React93.createElement(SizeControl, {
						variant: 'length',
						units: control.units,
						anchorRef: rowRef,
						disableCustom: true,
...
var TransformSettingsControl = ({ popupState, anchorRef, showChildrenPerspective }) => {
	...
	return /* @__PURE__ */ React94.createElement(
		...
		/* @__PURE__ */ React94.createElement(import_editor_ui11.PopoverHeader, {
		...
		/* @__PURE__ */ React94.createElement(
			...
			/* @__PURE__ */ React94.createElement(
				PropKeyProvider,
				{ bind: 'transform-origin' },
				/* @__PURE__ */ React94.createElement(TransformOriginControl, null)
			),
			showChildrenPerspective &&
				/* @__PURE__ */ React94.createElement(
					...
					/* @__PURE__ */ React94.createElement(ChildrenPerspectiveControl, null)
				)
		)
	);
};
...
var TransformRepeaterControl = createControl(({ showChildrenPerspective }) => {
	...
	return /* @__PURE__ */ React95.createElement(
		PropProvider,
		{ ...context },
		/* @__PURE__ */ React95.createElement(TransformSettingsControl, {
			popupState,
			anchorRef: headerRef,
			showChildrenPerspective,
		}),
		/* @__PURE__ */ React95.createElement(
			...
			/* @__PURE__ */ React95.createElement(Repeater2, { headerRef, propType: context.propType, popupState })
		)
	);
});
const ToolTip = /* @__PURE__ */ React95.createElement(
	import_ui81.Box,
	{
		component: 'span',
		'aria-label': void 0,
	...
	/* @__PURE__ */ React95.createElement(
		import_ui81.Typography,
		{ variant: 'body2', color: 'text.secondary', fontSize: '14px' },
		(0, import_i18n47.__)('You can use each kind of transform only once per element.', 'elementor')
	)
);
var Repeater2 = ({ headerRef, propType, popupState }) => {
		...
		/* @__PURE__ */ React95.createElement(
			...
			/* @__PURE__ */ React95.createElement(
				RepeaterHeader,
				{
					...
					adornment: () =>
						/* @__PURE__ */ React95.createElement(ControlAdornments, {
							customContext: { path: ['transform'], propType },
						}),
					ref: headerRef,
				},
				/* @__PURE__ */ React95.createElement(TransformBasePopoverTrigger, {
					popupState,
					repeaterBindKey: bind,
				}),
				/* @__PURE__ */ React95.createElement(TooltipAddItemAction, {
			...
			/* @__PURE__ */ React95.createElement(
				ItemsContainer,
				null,
				/* @__PURE__ */ React95.createElement(Item, {
					Icon: TransformIcon,
					Label: TransformLabel,
					actions: /* @__PURE__ */ React95.createElement(
						React95.Fragment,
						null,
						/* @__PURE__ */ React95.createElement(DisableItemAction, null),
						/* @__PURE__ */ React95.createElement(RemoveItemAction, null)
					),
				})
			),
			/* @__PURE__ */ React95.createElement(
				EditItemPopover,
				null,
				/* @__PURE__ */ React95.createElement(TransformContent, null)
			)
		)
	);
};
var TransformBasePopoverTrigger = ({ popupState, repeaterBindKey }) => {
	...
	return bind !== repeaterBindKey
		? null
		: /* @__PURE__ */ React95.createElement(
				import_ui81.Tooltip,
				{ title: titleLabel, placement: 'top' },
				/* @__PURE__ */ React95.createElement(
					import_ui81.IconButton,
					{ size: SIZE9, 'aria-label': titleLabel, ...(0, import_ui81.bindTrigger)(popupState) },
					/* @__PURE__ */ React95.createElement(import_icons31.AdjustmentsIcon, { fontSize: SIZE9 })
				)
			);
};

// src/controls/transition-control/transition-repeater-control.tsx
const React98 = __toESM(require('react'));
const import_react50 = require('react');
const import_editor_props50 = require('@elementor/editor-props');
const import_icons33 = require('@elementor/icons');
const import_ui84 = require('@elementor/ui');
const import_i18n50 = require('@wordpress/i18n');

// src/controls/selection-size-control.tsx
const React96 = __toESM(require('react'));
const import_react48 = require('react');
const import_editor_props48 = require('@elementor/editor-props');
const import_ui82 = require('@elementor/ui');
const SelectionSizeControl = createControl(({ selectionLabel, sizeLabel, selectionConfig, sizeConfigMap }) => {
	...
	return /* @__PURE__ */ React96.createElement(
		...
		/* @__PURE__ */ React96.createElement(
			...
			/* @__PURE__ */ React96.createElement(
				...
				/* @__PURE__ */ React96.createElement(ControlFormLabel, null, selectionLabel)
			),
			/* @__PURE__ */ React96.createElement(
				import_ui82.Grid,
				{ item: true, xs: 6 },
				/* @__PURE__ */ React96.createElement(
					PropKeyProvider,
					{ bind: 'selection' },
					/* @__PURE__ */ React96.createElement(SelectionComponent, { ...selectionConfig.props })
				)
			),
			currentSizeConfig &&
				/* @__PURE__ */ React96.createElement(
					...
					/* @__PURE__ */ React96.createElement(
						import_ui82.Grid,
						{ item: true, xs: 6, sx: { display: 'flex', alignItems: 'center' } },
						/* @__PURE__ */ React96.createElement(ControlFormLabel, { htmlFor: sizeFieldId }, sizeLabel)
					),
					/* @__PURE__ */ React96.createElement(
						import_ui82.Grid,
						{ item: true, xs: 6 },
						/* @__PURE__ */ React96.createElement(
							PropKeyProvider,
							{ bind: 'size' },
							/* @__PURE__ */ React96.createElement(SizeControl, {
								anchorRef: rowRef,
...
const import_utils6 = require('@elementor/utils');
const import_i18n48 = require('@wordpress/i18n');
...
const shouldExtendTransitionProperties = () => {
...
const createTransitionPropertiesList = () => {
	...
	const baseProperties = [
		...
		},
		{
			...
			properties: [
				...
				{
					label: (0, import_i18n48.__)('Margin bottom', 'elementor'),
					value: 'margin-block-end',
					isDisabled: true,
				},
				{
					label: isSiteRtl
						? (0, import_i18n48.__)('Margin right', 'elementor')
						: (0, import_i18n48.__)('Margin left', 'elementor'),
				...
				{
					label: (0, import_i18n48.__)('Margin top', 'elementor'),
		...
		},
		{
			...
			properties: [
				...
				{
					label: (0, import_i18n48.__)('Padding bottom', 'elementor'),
					value: 'padding-block-end',
					isDisabled: true,
				},
				{
					label: isSiteRtl
						? (0, import_i18n48.__)('Padding right', 'elementor')
						: (0, import_i18n48.__)('Padding left', 'elementor'),
				...
				{
					label: (0, import_i18n48.__)('Padding top', 'elementor'),
		...
		},
		{
			...
			properties: [
				...
				{
					label: isSiteRtl
						? (0, import_i18n48.__)('Right', 'elementor')
						: (0, import_i18n48.__)('Left', 'elementor'),
		...
		},
		{
			...
			properties: [
				...
				{
					label: (0, import_i18n48.__)('Letter spacing', 'elementor'),
					value: 'letter-spacing',
					isDisabled: true,
				},
				{ label: (0, import_i18n48.__)('Word spacing', 'elementor'), value: 'word-spacing', isDisabled: true },
				{
					label: (0, import_i18n48.__)('Font variations', 'elementor'),
					value: 'font-variation-settings',
					isDisabled: true,
				},
				{
					label: (0, import_i18n48.__)('Text stroke color', 'elementor'),
		...
		},
		{
			...
			properties: [
				{
					label: (0, import_i18n48.__)('Background color', 'elementor'),
					value: 'background-color',
					isDisabled: true,
				},
				{
					label: (0, import_i18n48.__)('Background position', 'elementor'),
		...
		},
		{
			...
			properties: [
				...
				{
					label: (0, import_i18n48.__)('Border radius', 'elementor'),
					value: 'border-radius',
					isDisabled: true,
				},
...
const import_events = require('@elementor/events');
...
const React97 = __toESM(require('react'));
const import_react49 = require('react');
const import_editor_props49 = require('@elementor/editor-props');
const import_editor_ui12 = require('@elementor/editor-ui');
const import_icons32 = require('@elementor/icons');
const import_ui83 = require('@elementor/ui');
const import_i18n49 = require('@wordpress/i18n');
const toTransitionSelectorValue = (label) => {
...
const includeCurrentValueInOptions = (value, disabledItems) => {
...
const TransitionSelector = ({ recentlyUsedList = [], disabledItems = [], showPromotion = false }) => {
	...
	return /* @__PURE__ */ React97.createElement(
		...
		/* @__PURE__ */ React97.createElement(
			ControlActions,
			null,
			/* @__PURE__ */ React97.createElement(import_ui83.UnstableTag, {
				variant: 'outlined',
		...
		/* @__PURE__ */ React97.createElement(
			...
			/* @__PURE__ */ React97.createElement(ItemSelector, {
				...
				categoryItemContentTemplate: (item) =>
					/* @__PURE__ */ React97.createElement(
						...
						showPromotion &&
							disabledCategories.has(item.value) &&
							/* @__PURE__ */ React97.createElement(import_editor_ui12.PromotionChip, null)
					),
				footer: showPromotion
					? /* @__PURE__ */ React97.createElement(import_editor_ui12.PromotionAlert, {
...
const childArrayPropTypeUtil = (0, import_editor_props50.createArrayPropUtils)(
...
const areAllPropertiesUsed = (value = []) => {
	return value?.length
...
const getSelectionSizeProps = (recentlyUsedList, disabledItems, showPromotion) => {
	return {
		...
		sizeConfigMap: {
			...transitionProperties.reduce((acc, category) => {
...
const getChildControlConfig = (recentlyUsedList, disabledItems, showPromotion) => {
	return {
...
const isPropertyUsed = (value, property) => {
	return (value ?? []).some((item) => {
		return item?.value?.selection?.value?.value?.value === property.value;
	});
};
const getDisabledItemLabels = (values = []) => {
...
const disableAddItemTooltipContent = /* @__PURE__ */ React98.createElement(
	import_ui84.Alert,
	{
		sx: {
			width: 280,
	...
	/* @__PURE__ */ React98.createElement(
		import_ui84.AlertTitle,
		null,
		(0, import_i18n50.__)('Transitions', 'elementor')
	),
	/* @__PURE__ */ React98.createElement(
		import_ui84.Box,
		{ component: 'span' },
		/* @__PURE__ */ React98.createElement(
			import_ui84.Typography,
			{ variant: 'body2' },
			(0, import_i18n50.__)("Switch to 'Normal' state to add a transition.", 'elementor')
		)
	)
);
var TransitionRepeaterControl = createControl(({ recentlyUsedListGetter, currentStyleState }) => {
	...
	return /* @__PURE__ */ React98.createElement(RepeatableControl, {
...
const React99 = __toESM(require('react'));
const dayjs = __toESM(require('dayjs'));
const import_editor_props51 = require('@elementor/editor-props');
const import_editor_props52 = require('@elementor/editor-props');
const import_ui85 = require('@elementor/ui');
...
var DateTimeControl = createControl(({ inputDisabled }) => {
	...
	return /* @__PURE__ */ React99.createElement(
		...
		/* @__PURE__ */ React99.createElement(
			...
			null,
			/* @__PURE__ */ React99.createElement(
				import_ui85.LocalizationProvider,
				null,
				/* @__PURE__ */ React99.createElement(
					import_ui85.Box,
					...
					/* @__PURE__ */ React99.createElement(
						PropKeyProvider,
						{ bind: 'date' },
						/* @__PURE__ */ React99.createElement(import_ui85.DatePicker, {
					...
					/* @__PURE__ */ React99.createElement(
						PropKeyProvider,
						{ bind: 'time' },
						/* @__PURE__ */ React99.createElement(import_ui85.TimePicker, {
...
const React101 = __toESM(require('react'));
const import_react53 = require('react');
const import_editor_props53 = require('@elementor/editor-props');
const import_ui87 = require('@elementor/ui');
const import_utils7 = require('@elementor/utils');

// src/components/inline-editor.tsx
const React100 = __toESM(require('react'));
const import_react51 = require('react');
const import_ui86 = require('@elementor/ui');
const import_extension_bold = __toESM(require('@tiptap/extension-bold'));
const import_extension_document = __toESM(require('@tiptap/extension-document'));
const import_extension_hard_break = __toESM(require('@tiptap/extension-hard-break'));
const import_extension_heading = __toESM(require('@tiptap/extension-heading'));
const import_extension_italic = __toESM(require('@tiptap/extension-italic'));
const import_extension_link = __toESM(require('@tiptap/extension-link'));
const import_extension_paragraph = __toESM(require('@tiptap/extension-paragraph'));
const import_extension_strike = __toESM(require('@tiptap/extension-strike'));
const import_extension_subscript = __toESM(require('@tiptap/extension-subscript'));
const import_extension_superscript = __toESM(require('@tiptap/extension-superscript'));
const import_extension_text = __toESM(require('@tiptap/extension-text'));
const import_extension_underline = __toESM(require('@tiptap/extension-underline'));
const import_react52 = require('@tiptap/react');
...
var Wrapper = ({ children, containerRef, editor, sx, onBlur, className }) => {
	const wrappedChildren = /* @__PURE__ */ React100.createElement(
		import_ui86.Box,
		{ ref: containerRef, ...sx, className },
		children
	);
	return onBlur
		? /* @__PURE__ */ React100.createElement(
...
var InlineEditingControl = createControl(({ sx, attributes, props }) => {
...
const React102 = __toESM(require('react'));
const import_editor_props54 = require('@elementor/editor-props');
const import_editor_ui13 = require('@elementor/editor-ui');
const import_ui88 = require('@elementor/ui');
const import_i18n51 = require('@wordpress/i18n');
const EmailField = ({ bind, label, placeholder }) =>
	/* @__PURE__ */ React102.createElement(
		PropKeyProvider,
		{ bind },
		/* @__PURE__ */ React102.createElement(
			import_ui88.Grid,
			{ container: true, direction: 'column', gap: 0.5 },
			/* @__PURE__ */ React102.createElement(
				import_ui88.Grid,
				{ item: true },
				/* @__PURE__ */ React102.createElement(ControlFormLabel, null, label)
			),
			/* @__PURE__ */ React102.createElement(
				import_ui88.Grid,
				{ item: true },
				/* @__PURE__ */ React102.createElement(TextControl, { placeholder })
			)
		)
	);
const SendToField = () =>
	/* @__PURE__ */ React102.createElement(EmailField, {
		bind: 'to',
		...
		/* @__PURE__ */ React102.createElement(
			...
			/* @__PURE__ */ React102.createElement(
				...
				/* @__PURE__ */ React102.createElement(
					ControlFormLabel,
					null,
					(0, import_i18n51.__)('Message', 'elementor')
				)
			),
			/* @__PURE__ */ React102.createElement(
				import_ui88.Grid,
				{ item: true },
				/* @__PURE__ */ React102.createElement(TextAreaControl, {
...
const ReplyToField = () =>
	/* @__PURE__ */ React102.createElement(EmailField, {
		bind: 'reply-to',
		label: (0, import_i18n51.__)('Reply-to', 'elementor'),
	});
const CcField = () =>
	/* @__PURE__ */ React102.createElement(EmailField, { bind: 'cc', label: (0, import_i18n51.__)('Cc', 'elementor') });
const BccField = () =>
	/* @__PURE__ */ React102.createElement(EmailField, {
		bind: 'bcc',
		label: (0, import_i18n51.__)('Bcc', 'elementor'),
	});
const MetaDataField = () =>
	/* @__PURE__ */ React102.createElement(
		PropKeyProvider,
		...
		/* @__PURE__ */ React102.createElement(
			import_ui88.Stack,
			{ gap: 0.5 },
			/* @__PURE__ */ React102.createElement(ControlLabel, null, (0, import_i18n51.__)('Meta data', 'elementor')),
			/* @__PURE__ */ React102.createElement(ChipsControl, {
				options: [
		...
		/* @__PURE__ */ React102.createElement(
			...
			/* @__PURE__ */ React102.createElement(
				...
				/* @__PURE__ */ React102.createElement(
					ControlFormLabel,
					null,
					(0, import_i18n51.__)('Send as', 'elementor')
				)
			),
			/* @__PURE__ */ React102.createElement(
				import_ui88.Grid,
				{ item: true },
				/* @__PURE__ */ React102.createElement(SelectControl, {
					options: [
...
const AdvancedSettings = () =>
	/* @__PURE__ */ React102.createElement(
		import_editor_ui13.CollapsibleContent,
		{ defaultOpen: false },
		/* @__PURE__ */ React102.createElement(
			import_ui88.Box,
			{ sx: { pt: 2 } },
			/* @__PURE__ */ React102.createElement(
				import_ui88.Stack,
				{ gap: 2 },
				/* @__PURE__ */ React102.createElement(FromNameField, null),
				/* @__PURE__ */ React102.createElement(ReplyToField, null),
				/* @__PURE__ */ React102.createElement(CcField, null),
				/* @__PURE__ */ React102.createElement(BccField, null),
				/* @__PURE__ */ React102.createElement(import_ui88.Divider, null),
				/* @__PURE__ */ React102.createElement(MetaDataField, null),
				/* @__PURE__ */ React102.createElement(SendAsField, null)
			)
		)
	);
	...
	return /* @__PURE__ */ React102.createElement(
		...
		/* @__PURE__ */ React102.createElement(
			...
			/* @__PURE__ */ React102.createElement(
				ControlFormLabel,
				null,
				(0, import_i18n51.__)('Email settings', 'elementor')
			),
			/* @__PURE__ */ React102.createElement(SendToField, null),
			/* @__PURE__ */ React102.createElement(SubjectField, null),
			/* @__PURE__ */ React102.createElement(MessageField, null),
			/* @__PURE__ */ React102.createElement(FromEmailField, null),
			/* @__PURE__ */ React102.createElement(AdvancedSettings, null)
		)
	);
});

// src/components/promotions/display-conditions-control.tsx
const React104 = __toESM(require('react'));
const import_react55 = require('react');
const import_icons34 = require('@elementor/icons');
const import_ui90 = require('@elementor/ui');
const import_i18n52 = require('@wordpress/i18n');

// src/components/promotions/promotion-trigger.tsx
const React103 = __toESM(require('react'));
const import_react54 = require('react');
const import_editor_ui14 = require('@elementor/editor-ui');
const import_ui89 = require('@elementor/ui');
function getV4Promotion(key) {
	return window.elementor?.config?.v4Promotions?.[key];
}
var PromotionTrigger = (0, import_react54.forwardRef)(({ promotionKey, children }, ref) => {
...
// src/components/promotions/display-conditions-control.tsx
const ARIA_LABEL = (0, import_i18n52.__)('Display Conditions', 'elementor');
var DisplayConditionsControl = createControl(() => {
	...
	return /* @__PURE__ */ React104.createElement(
		...
		/* @__PURE__ */ React104.createElement(PromotionTrigger, {
			ref: triggerRef,
			promotionKey: 'displayConditions',
		}),
		/* @__PURE__ */ React104.createElement(
			import_ui90.Tooltip,
			{ title: ARIA_LABEL, placement: 'top' },
			/* @__PURE__ */ React104.createElement(
				...
				/* @__PURE__ */ React104.createElement(import_icons34.SitemapIcon, {
					fontSize: 'tiny',
					color: 'disabled',
				})
			)
...
const React105 = __toESM(require('react'));
const import_react56 = require('react');
const import_icons35 = require('@elementor/icons');
const import_ui91 = require('@elementor/ui');
const import_i18n53 = require('@wordpress/i18n');
const ARIA_LABEL2 = (0, import_i18n53.__)('Attributes', 'elementor');
var AttributesControl = createControl(() => {
	...
	return /* @__PURE__ */ React105.createElement(
		...
		/* @__PURE__ */ React105.createElement(
			import_ui91.Tooltip,
			{ title: ARIA_LABEL2, placement: 'top' },
			/* @__PURE__ */ React105.createElement(import_icons35.PlusIcon, {
...
const React106 = __toESM(require('react'));
const import_icons36 = require('@elementor/icons');
const import_ui92 = require('@elementor/ui');
const CustomIconButton = (0, import_ui92.styled)(import_ui92.IconButton)(({ theme }) => ({
	width: theme.spacing(2.5),
	height: theme.spacing(2.5),
}));
var ClearIconButton = ({ tooltipText, onClick, disabled, size = 'tiny' }) =>
	/* @__PURE__ */ React106.createElement(
		import_ui92.Tooltip,
		{ title: tooltipText, placement: 'top', disableInteractive: true },
		/* @__PURE__ */ React106.createElement(
			CustomIconButton,
			{ 'aria-label': tooltipText, size, onClick, disabled },
			/* @__PURE__ */ React106.createElement(import_icons36.BrushBigIcon, { fontSize: size })
		)
	);

// src/components/repeater/repeater.tsx
const React107 = __toESM(require('react'));
const import_react57 = require('react');
const import_icons37 = require('@elementor/icons');
const import_ui93 = require('@elementor/ui');
const import_i18n54 = require('@wordpress/i18n');
const SIZE10 = 'tiny';
const EMPTY_OPEN_ITEM2 = -1;
var Repeater3 = ({
	label,
	itemSettings,
	disabled = false,
	...
	const uniqueKeys = items2.map((item, index) =>
	...
	return /* @__PURE__ */ React107.createElement(
		...
		/* @__PURE__ */ React107.createElement(
			RepeaterHeader,
			{ label, adornment: ControlAdornments },
			shouldShowInfotip
				? /* @__PURE__ */ React107.createElement(
						import_ui93.Infotip,
						{
						...
						/* @__PURE__ */ React107.createElement(
							import_ui93.Box,
							{ sx: { ...(isButtonDisabled ? { cursor: 'not-allowed' } : {}) } },
							addButton
						)
					)
				: addButton
		...
		0 < uniqueKeys.length &&
			/* @__PURE__ */ React107.createElement(
				SortableProvider,
				{ value: uniqueKeys, onChange: onChangeOrder },
				uniqueKeys.map((key) => {
					...
					return /* @__PURE__ */ React107.createElement(
						...
						/* @__PURE__ */ React107.createElement(
							RepeaterItem,
							{
								...
								label: /* @__PURE__ */ React107.createElement(
									RepeaterItemLabelSlot,
									{ value },
									/* @__PURE__ */ React107.createElement(itemSettings.Label, { value, index })
								),
								startIcon: /* @__PURE__ */ React107.createElement(
									RepeaterItemIconSlot,
									{ value },
									/* @__PURE__ */ React107.createElement(itemSettings.Icon, { value })
								),
							...
							(props) =>
								/* @__PURE__ */ React107.createElement(itemSettings.Content, {
									...props,
									value,
									bind: String(index),
									index,
...
var RepeaterItem = ({
	...
	const toggleLabel = propDisabled
		? (0, import_i18n54.__)('Show', 'elementor')
		: (0, import_i18n54.__)('Hide', 'elementor');
	const removeLabel = (0, import_i18n54.__)('Remove', 'elementor');
	return /* @__PURE__ */ React107.createElement(
		React107.Fragment,
		null,
		/* @__PURE__ */ React107.createElement(RepeaterTag, {
			disabled,
			label,
			ref: setRef,
			...
			startIcon,
			actions: /* @__PURE__ */ React107.createElement(
				React107.Fragment,
				null,
				showDuplicate &&
					/* @__PURE__ */ React107.createElement(
						...
						/* @__PURE__ */ React107.createElement(
							import_ui93.IconButton,
							{ size: SIZE10, onClick: duplicateItem, 'aria-label': duplicateLabel },
							/* @__PURE__ */ React107.createElement(import_icons37.CopyIcon, { fontSize: SIZE10 })
						)
					),
				showToggle &&
					/* @__PURE__ */ React107.createElement(
						...
						/* @__PURE__ */ React107.createElement(
							import_ui93.IconButton,
							{ size: SIZE10, onClick: toggleDisableItem, 'aria-label': toggleLabel },
							propDisabled
								? /* @__PURE__ */ React107.createElement(import_icons37.EyeOffIcon, {
										fontSize: SIZE10,
									})
								: /* @__PURE__ */ React107.createElement(import_icons37.EyeIcon, { fontSize: SIZE10 })
						)
					),
				actions?.(value),
				showRemove &&
					/* @__PURE__ */ React107.createElement(
						...
						/* @__PURE__ */ React107.createElement(
							import_ui93.IconButton,
							{ size: SIZE10, onClick: removeItem, 'aria-label': removeLabel },
							/* @__PURE__ */ React107.createElement(import_icons37.XIcon, { fontSize: SIZE10 })
						)
					)
			),
		}),
		/* @__PURE__ */ React107.createElement(
			RepeaterPopover,
			{ width: ref?.getBoundingClientRect().width, ...popoverProps, anchorEl: ref },
			/* @__PURE__ */ React107.createElement(import_ui93.Box, null, children({ anchorEl: ref }))
		)
	);
};
...
const React109 = __toESM(require('react'));
const import_react59 = require('react');
const import_editor_elements5 = require('@elementor/editor-elements');
const import_icons39 = require('@elementor/icons');
const import_ui95 = require('@elementor/ui');
const import_react60 = require('@tiptap/react');
const import_i18n56 = require('@wordpress/i18n');

// src/components/url-popover.tsx
const React108 = __toESM(require('react'));
const import_react58 = require('react');
const import_icons38 = require('@elementor/icons');
const import_ui94 = require('@elementor/ui');
const import_i18n55 = require('@wordpress/i18n');
const UrlPopover = ({ popupState, restoreValue, anchorRef, value, onChange, openInNewTab, onToggleNewTab }) => {
	...
	return /* @__PURE__ */ React108.createElement(
		...
		/* @__PURE__ */ React108.createElement(
			import_ui94.Stack,
			{ direction: 'row', alignItems: 'center', gap: 1, sx: { p: 1.5 } },
			/* @__PURE__ */ React108.createElement(import_ui94.TextField, {
				value,
				onChange,
				size: 'tiny',
				fullWidth: true,
			...
			/* @__PURE__ */ React108.createElement(
				import_ui94.Tooltip,
				{ title: (0, import_i18n55.__)('Open in a new tab', 'elementor') },
				/* @__PURE__ */ React108.createElement(
...
var InlineEditorToolbar = ({ editor, elementId, sx = {} }) => {
	...
	return /* @__PURE__ */ React109.createElement(
		...
		/* @__PURE__ */ React109.createElement(
			import_ui95.Tooltip,
			{ title: clearButton.label, placement: 'top', sx: { borderRadius: '8px' } },
			/* @__PURE__ */ React109.createElement(
				import_ui95.IconButton,
				{ 'aria-label': clearButton.label, onClick: () => clearButton.method(editor), size: 'tiny' },
				clearButton.icon
			)
		),
		/* @__PURE__ */ React109.createElement(
			...
			formatButtonsList.map((button) =>
				/* @__PURE__ */ React109.createElement(
					import_ui95.Tooltip,
					{ title: button.label, key: button.action, placement: 'top' },
					/* @__PURE__ */ React109.createElement(
		...
		/* @__PURE__ */ React109.createElement(UrlPopover, {
...
const React112 = __toESM(require('react'));
const import_ui97 = require('@elementor/ui');

// src/hooks/use-size-value.ts
const DEFAULT_UNIT2 = 'px';
const DEFAULT_SIZE2 = '';
const useSizeValue = (externalValue, onChange, defaultUnit) => {
...
const React110 = __toESM(require('react'));
const import_react61 = require('react');
const import_editor_ui15 = require('@elementor/editor-ui');
const import_ui96 = require('@elementor/ui');
const menuItemContentStyles = {
	display: 'flex',
	flexDirection: 'column',
	justifyContent: 'center',
};
const UnitSelect = ({ value, showPrimaryColor, onClick, options }) => {
	...
	return /* @__PURE__ */ React110.createElement(
		...
		/* @__PURE__ */ React110.createElement(
			StyledButton2,
			{ isPrimaryColor: showPrimaryColor, size: 'small', ...(0, import_ui96.bindTrigger)(popupState) },
			value
		),
		/* @__PURE__ */ React110.createElement(
			import_ui96.Menu,
			{ MenuListProps: { dense: true }, ...(0, import_ui96.bindMenu)(popupState) },
			options.map((option, index) =>
				/* @__PURE__ */ React110.createElement(
...
const React111 = __toESM(require('react'));
const import_react62 = require('react');
const UnstableSizeInput = (0, import_react62.forwardRef)(
	({ type, value, onChange, onKeyDown, onKeyUp, InputProps, onBlur, focused, disabled }, ref) => {
		return /* @__PURE__ */ React111.createElement(NumberInput, {
			ref,
			size: 'tiny',
			fullWidth: true,
			type,
...
// src/components/size/unstable-size-field.tsx
var UnstableSizeField = ({ value, InputProps, onChange, onBlur, units: units2, defaultUnit, startIcon }) => {
	const { size, unit, setSize, setUnit } = useSizeValue(value, onChange, defaultUnit);
	const shouldHighlightUnit = () => {
		return hasValue(size);
	};
	return /* @__PURE__ */ React112.createElement(UnstableSizeInput, {
		type: 'number',
		value: size ?? '',
		onBlur,
		...
		InputProps: {
			...
			startAdornment:
				startIcon &&
				/* @__PURE__ */ React112.createElement(import_ui97.InputAdornment, { position: 'start' }, startIcon),
			endAdornment: /* @__PURE__ */ React112.createElement(
				import_ui97.InputAdornment,
				{ position: 'end' },
				/* @__PURE__ */ React112.createElement(UnitSelect, {
					options: units2,
					value: unit,
					onClick: setUnit,
...
const import_react63 = require('react');
const import_editor_v1_adapters = require('@elementor/editor-v1-adapters');
const import_i18n57 = require('@wordpress/i18n');
