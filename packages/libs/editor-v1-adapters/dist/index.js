...
const callbacksByEvent = /* @__PURE__ */ new Map();
...
const import_utils5 = require('@elementor/utils');

// src/undoable/get-history-manager.ts
const import_utils4 = require('@elementor/utils');
const HistoryManagerNotAvailable = (0, import_utils4.createError)({
...
function undoable(actions, options) {
	...
	const _addHistoryItem = options.debounce
		? (0, import_utils5.debounce)(addHistoryItem, options.debounce.wait)
		: addHistoryItem;
	return (payload) => {
