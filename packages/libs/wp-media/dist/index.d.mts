...
declare function useWpMediaAttachment(
	id: number | null
): _tanstack_react_query.UseQueryResult<Attachment | null, Error>;

declare function getMediaAttachment({ id }: { id: number | null }): Promise<Attachment | null>;
