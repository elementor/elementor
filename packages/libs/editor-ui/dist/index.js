...
const IndicatorsWrapper = (0, import_ui2.styled)('div')`
	position: absolute;
	top: 0;
...
var CollapsibleContent = ({ children, defaultOpen = false, titleEnd = null }) => {
	...
	return /* @__PURE__ */ React.createElement(
		...
		/* @__PURE__ */ React.createElement(
			...
			titleEnd &&
				/* @__PURE__ */ React.createElement(IndicatorsWrapper, null, getCollapsibleValue(titleEnd, open))
		),
		/* @__PURE__ */ React.createElement(
			import_ui2.Collapse,
...
var EllipsisWithTooltip = ({ maxWidth, title, as, ...props }) => {
	...
	if (isOverflowing) {
		return /* @__PURE__ */ React2.createElement(
			import_ui3.Tooltip,
			{ title, placement: 'top' },
			/* @__PURE__ */ React2.createElement(Content, { maxWidth, ref: setRef, as, ...props }, title)
		);
	}
	return /* @__PURE__ */ React2.createElement(Content, { maxWidth, ref: setRef, as, ...props }, title);
};
var Content = React2.forwardRef(({ maxWidth, as: Component = import_ui3.Box, ...props }, ref) =>
...
var EditableField = (0, import_react3.forwardRef)(({ value, error, as = 'span', sx, ...props }, ref) => {
	return /* @__PURE__ */ React3.createElement(
		import_ui4.Tooltip,
		{ title: error, open: !!error, placement: 'top' },
		/* @__PURE__ */ React3.createElement(StyledField, { ref, component: as, ...props }, value)
	);
});
...
var IntroductionModal = ({ open, handleClose, title, children }) => {
	...
	return /* @__PURE__ */ React4.createElement(
		import_ui5.Dialog,
		{ open, onClose: handleClose, maxWidth: 'sm', TransitionComponent: Transition },
		title &&
			/* @__PURE__ */ React4.createElement(
				import_ui5.DialogHeader,
				{ logo: false },
				/* @__PURE__ */ React4.createElement(import_ui5.DialogTitle, null, title)
			),
		children,
		/* @__PURE__ */ React4.createElement(
			import_ui5.DialogActions,
			null,
			/* @__PURE__ */ React4.createElement(import_ui5.FormControlLabel, {
				sx: { marginRight: 'auto' },
				control: /* @__PURE__ */ React4.createElement(import_ui5.Checkbox, {
				...
				label: /* @__PURE__ */ React4.createElement(
					...
					{ variant: 'body2' },
					(0, import_i18n2.__)("Don't show this again", 'elementor')
				),
			}),
			/* @__PURE__ */ React4.createElement(
				import_ui5.Button,
...
var Transition = React4.forwardRef((props, ref) =>
	/* @__PURE__ */ React4.createElement(import_ui5.Fade, {
		ref,
		...props,
		timeout: {
			enter: 1e3,
...
function useColorScheme() {
	...
	(0, import_react5.useEffect)(() => {
		return (0, import_editor_v1_adapters.__privateListenTo)((0, import_editor_v1_adapters.v1ReadyEvent)(), () =>
...
// src/components/theme-provider.tsx
const EDITOR_PALLETTE = 'unstable';
function ThemeProvider({ children }) {
	const colorScheme = useColorScheme();
	return /* @__PURE__ */ React5.createElement(
		import_ui6.ThemeProvider,
		{ colorScheme, palette: EDITOR_PALLETTE },
		children
	);
}
...
var InfoAlert = (props) =>
	/* @__PURE__ */ React6.createElement(import_ui7.Alert, {
		icon: /* @__PURE__ */ React6.createElement(import_icons2.InfoCircleFilledIcon, {
			fontSize: 'small',
			color: 'secondary',
		}),
		variant: 'standard',
...
var MenuListItem = ({ children, menuItemTextProps, primaryTypographyProps = { variant: 'caption' }, ...props }) => {
	return /* @__PURE__ */ React7.createElement(
		...
		/* @__PURE__ */ React7.createElement(import_ui8.MenuItemText, {
			primary: children,
...
var MenuItemInfotip = (0, import_react6.forwardRef)(({ showInfoTip = false, children, content }, ref) => {
	if (!showInfoTip) {
	...
	return /* @__PURE__ */ React7.createElement(
		...
		/* @__PURE__ */ React7.createElement(
			'div',
			{ style: { pointerEvents: 'initial', width: '100%' }, onClick: (e) => e.stopPropagation() },
			children
		)
	);
});
...
var InfoTipCard = ({ content, svgIcon, learnMoreButton, ctaButton }) => {
	return /* @__PURE__ */ React8.createElement(
		import_ui9.Card,
		{ elevation: 0, sx: { width: 320 } },
		/* @__PURE__ */ React8.createElement(
			import_ui9.CardContent,
			{ sx: { pb: 0 } },
			/* @__PURE__ */ React8.createElement(
				import_ui9.Box,
				...
				/* @__PURE__ */ React8.createElement(
					...
					learnMoreButton &&
						/* @__PURE__ */ React8.createElement(
							...
							/* @__PURE__ */ React8.createElement(
								import_ui9.Link,
								{ color: 'info.main', href: learnMoreButton.href, target: '_blank' },
...
var GlobalDialog = () => {
	...
	return /* @__PURE__ */ React10.createElement(
		...
		/* @__PURE__ */ React10.createElement(
			import_ui11.Dialog,
			{ role: 'dialog', open: true, onClose: closeDialog, maxWidth: 'sm', fullWidth: true },
			content.component
		)
	);
};
...
var SearchField = ({ value, onSearch, placeholder, id, sx }) => {
	...
	return /* @__PURE__ */ React11.createElement(
		import_ui12.Box,
		{ sx: { px: 2, pb: 1.5, ...sx } },
		/* @__PURE__ */ React11.createElement(import_ui12.TextField, {
			autoFocus: true,
			fullWidth: true,
			id,
			size: SIZE,
			...
			placeholder,
			InputProps: {
				startAdornment: /* @__PURE__ */ React11.createElement(
					import_ui12.InputAdornment,
					{ position: 'start' },
					/* @__PURE__ */ React11.createElement(import_icons3.SearchIcon, { fontSize: SIZE })
				),
				endAdornment:
					value &&
					/* @__PURE__ */ React11.createElement(
						import_ui12.IconButton,
						{ size: SIZE, onClick: handleClear, 'aria-label': (0, import_i18n3.__)('Clear', 'elementor') },
						/* @__PURE__ */ React11.createElement(import_icons3.XIcon, { color: 'action', fontSize: SIZE })
					),
			},
		})
	);
...
var CtaButton = ({ href, children, showIcon = true, ...props }) =>
...
const useScrollToSelected = ({ selectedValue, items, virtualizer }) => {
...
var PromotionInfotip = ({ children, open, onClose, ...cardProps }) => {
	...
	return /* @__PURE__ */ React14.createElement(
		...
		{
			placement: 'right',
			content: /* @__PURE__ */ React14.createElement(InfotipCard, { onClose, ...cardProps }),
			open,
		},
		children
	);
...
function InfotipCard({ title, content, assetUrl, ctaUrl, onClose }) {
	return /* @__PURE__ */ React14.createElement(
		...
		/* @__PURE__ */ React14.createElement(
			import_ui14.Card,
			{ elevation: 0, sx: { maxWidth: 296 } },
			/* @__PURE__ */ React14.createElement(import_ui14.CardHeader, {
				title,
				action: /* @__PURE__ */ React14.createElement(import_ui14.CloseButton, {
					slotProps: { icon: { fontSize: 'tiny' } },
					onClick: onClose,
				}),
			}),
			/* @__PURE__ */ React14.createElement(import_ui14.CardMedia, {
				component: 'img',
				image: assetUrl,
				alt: '',
			...
			/* @__PURE__ */ React14.createElement(
				import_ui14.CardActions,
				{ sx: { justifyContent: 'flex-start' } },
				/* @__PURE__ */ React14.createElement(CtaButton, { href: ctaUrl })
			)
		)
	);
}
	...
	return /* @__PURE__ */ React15.createElement(
		...
		/* @__PURE__ */ React15.createElement(
			...
			/* @__PURE__ */ React15.createElement(
				...
				/* @__PURE__ */ React15.createElement(import_ui15.AlertTitle, null, title),
				/* @__PURE__ */ React15.createElement(import_ui15.Typography, { variant: 'body2' }, content)
			)
		)
	);
}
...
var PromotionChip = React16.forwardRef(({ ...props }, ref) => {
	return /* @__PURE__ */ React16.createElement(import_ui16.Chip, {
...
var PromotionAlert = ({ message, upgradeUrl }) =>
...
const FloatingBarContainer = (0, import_ui18.styled)('span')`
	display: contents;
...
`;
const FloatingActionsContext = (0, import_react15.createContext)(null);
...
const useSectionRef = () => (0, import_react16.useContext)(SectionRefContext);
var useSectionWidth = () => {
...
var PopoverHeader = ({ title, onClose, icon, actions }) => {
	...
	return /* @__PURE__ */ React21.createElement(
		import_ui20.Stack,
		{ direction: 'row', alignItems: 'center', ...paddingAndSizing, sx: { columnGap: 0.5 } },
		icon,
		/* @__PURE__ */ React21.createElement(
			import_ui20.Typography,
			{ variant: 'subtitle2', sx: { fontSize: '12px', mt: 0.25 } },
			title
		),
		/* @__PURE__ */ React21.createElement(
			import_ui20.Stack,
			{ direction: 'row', sx: { ml: 'auto' } },
			actions,
			/* @__PURE__ */ React21.createElement(import_ui20.CloseButton, {
				slotProps: { icon: { fontSize: SIZE2 } },
				sx: { ml: 'auto' },
				onClick: onClose,
			})
		)
...
const import_react_virtual = require('@tanstack/react-virtual');
var ITEM_HEIGHT = 32;
...
var PopoverMenuList = ({
	...
	return /* @__PURE__ */ React22.createElement(
		import_ui21.Box,
		{ ref: containerRef, sx: { height: '100%', overflowY: 'auto' } },
	...
	return /* @__PURE__ */ React23.createElement(
		...
		/* @__PURE__ */ React23.createElement(
			...
			/* @__PURE__ */ React23.createElement(
				...
				{ 'aria-label': title, size: SIZE3, ...triggerProps },
				/* @__PURE__ */ React23.createElement(Icon, { fontSize: SIZE3 })
			)
		),
		/* @__PURE__ */ React23.createElement(
			import_ui22.Popover,
...
var SaveChangesDialog = ({ children, onClose }) =>
	/* @__PURE__ */ React24.createElement(
		import_ui23.Dialog,
		{ open: true, onClose, 'aria-labelledby': TITLE_ID, maxWidth: 'xs' },
		children
	);
const SaveChangesDialogTitle = ({ children, onClose }) =>
	/* @__PURE__ */ React24.createElement(
		...
		/* @__PURE__ */ React24.createElement(
			...
			/* @__PURE__ */ React24.createElement(import_icons8.AlertTriangleFilledIcon, { color: 'secondary' }),
			children
		),
		onClose &&
			/* @__PURE__ */ React24.createElement(
				...
				/* @__PURE__ */ React24.createElement(import_icons8.XIcon, null)
			)
	);
const SaveChangesDialogContent = ({ children }) =>
	/* @__PURE__ */ React24.createElement(import_ui23.DialogContent, null, children);
const SaveChangesDialogContentText = (props) =>
	/* @__PURE__ */ React24.createElement(import_ui23.DialogContentText, {
		variant: 'body2',
		color: 'textPrimary',
		display: 'flex',
		flexDirection: 'column',
...
const SaveChangesDialogActions = ({ actions }) => {
	...
	return /* @__PURE__ */ React24.createElement(
		import_ui23.DialogActions,
		null,
		cancel &&
			/* @__PURE__ */ React24.createElement(
				import_ui23.Button,
				{ variant: 'text', color: 'secondary', onClick: cancel.action },
				cancel.label
			),
		discard &&
			/* @__PURE__ */ React24.createElement(
				import_ui23.Button,
				{ variant: 'text', color: 'secondary', onClick: discard.action },
				discard.label
			),
		/* @__PURE__ */ React24.createElement(
			import_ui23.Button,
			{ variant: 'contained', color: 'secondary', onClick: onConfirm, loading: isConfirming },
			confirm.label
		)
	);
};
...
const TITLE_ID2 = 'confirmation-dialog';
var ConfirmationDialog = ({ open, onClose, children }) =>
	/* @__PURE__ */ React25.createElement(
		import_ui24.Dialog,
		{ open, onClose, 'aria-labelledby': TITLE_ID2, maxWidth: 'sm' },
		children
	);
const ConfirmationDialogTitle = ({
	...
	/* @__PURE__ */ React25.createElement(
		import_ui24.DialogTitle,
		{ id: TITLE_ID2, display: 'flex', alignItems: 'center', gap: 1, sx: { lineHeight: 1 } },
		/* @__PURE__ */ React25.createElement(Icon, { color: iconColor }),
		children
	);
const ConfirmationDialogContent = ({ children }) =>
	/* @__PURE__ */ React25.createElement(import_ui24.DialogContent, { sx: { mt: 2 } }, children);
const ConfirmationDialogContentText = (props) =>
	/* @__PURE__ */ React25.createElement(import_ui24.DialogContentText, {
		variant: 'body2',
		color: 'secondary',
		...props,
	});
const ConfirmationDialogActions = ({
	...
	return /* @__PURE__ */ React25.createElement(
		import_ui24.DialogActions,
		{ sx: onSuppressMessage ? { justifyContent: 'space-between', alignItems: 'center' } : void 0 },
		onSuppressMessage &&
			/* @__PURE__ */ React25.createElement(import_ui24.FormControlLabel, {
				control: /* @__PURE__ */ React25.createElement(import_ui24.Checkbox, {
		...
		/* @__PURE__ */ React25.createElement(
			...
			/* @__PURE__ */ React25.createElement(
				...
				cancelLabel ?? (0, import_i18n6.__)('Not now', 'elementor')
			),
			/* @__PURE__ */ React25.createElement(
				import_ui24.Button,
				{ autoFocus: true, variant: 'contained', color, onClick: handleConfirm, sx: { ml: 1 } },
				confirmLabel ?? (0, import_i18n6.__)('Delete', 'elementor')
			)
		)
	);
};
