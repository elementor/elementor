...
type V1Element$1 = {
    id: string;
    model: V1Model$2<V1ElementModelProps$1>;
    settings: V1Model$2<V1ElementSettingsProps$1>;
...
type StringPropValue$1 = {
    $$type: 'string';
    value: string;
};
type BooleanPropValue$1 = {
    $$type: 'boolean';
    value: boolean;
};
type TimingConfigPropValue$1 = {
    $$type: 'timing-config';
    value: {
        duration: SizePropValue;
        delay: SizePropValue;
...
type ConfigPropValue$1 = {
    $$type: 'config';
    value: {
        replay: BooleanPropValue$1;
        easing: StringPropValue$1;
        relativeTo: StringPropValue$1;
        start?: SizePropValue;
        end?: SizePropValue;
    };
};
type AnimationPresetPropValue$1 = {
    $$type: 'animation-preset-props';
    value: {
        effect: StringPropValue$1;
        custom_effect?: PropValue;
        type: StringPropValue$1;
        direction: StringPropValue$1;
        timing_config: TimingConfigPropValue$1;
        config: ConfigPropValue$1;
    };
};
type ExcludedBreakpointsPropValue$1 = {
    $$type: 'excluded-breakpoints';
    value: StringPropValue$1[];
};
type InteractionBreakpointsPropValue$1 = {
    $$type: 'interaction-breakpoints';
    value: {
        excluded: ExcludedBreakpointsPropValue$1;
    };
};
type InteractionItemPropValue$1 = {
    $$type: 'interaction-item';
    value: {
        interaction_id?: StringPropValue$1;
        trigger: StringPropValue$1;
        animation: AnimationPresetPropValue$1;
        breakpoints?: InteractionBreakpointsPropValue$1;
    };
};
type ElementInteractions$1 = {
    version: number;
    items: InteractionItemPropValue$1[];
};
type V1ElementModelProps$1 = {
    ...
    id: string;
    styles?: Record<StyleDefinitionID, StyleDefinition>;
    elements?: V1Model$2<V1ElementModelProps$1>[];
...
declare function useParentElement(elementId: string | null): V1Element$1 | null | undefined;
...
declare function createElementStyle({ styleId, elementId, classesProp, label, meta, props, custom_css: customCss, additionalVariants, }: CreateElementStyleArgs): string;
declare function shouldCreateNewLocalStyle<T>(payload: {
