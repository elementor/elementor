...
const import_editor_v1_adapters4 = require('@elementor/editor-v1-adapters');
...
const import_editor_v1_adapters5 = require('@elementor/editor-v1-adapters');
...
const import_editor_v1_adapters6 = require('@elementor/editor-v1-adapters');
...
const import_editor_v1_adapters7 = require('@elementor/editor-v1-adapters');
...
const import_editor_v1_adapters9 = require('@elementor/editor-v1-adapters');
const import_i18n = require('@wordpress/i18n');

// src/sync/delete-element.ts
const import_editor_v1_adapters8 = require('@elementor/editor-v1-adapters');
...
// src/sync/create-elements.ts
var createElements = ({ elements, title, subtitle = (0, import_i18n.__)('Item added', 'elementor') }) => {
...
const import_editor_v1_adapters10 = require('@elementor/editor-v1-adapters');
...
const import_editor_v1_adapters11 = require('@elementor/editor-v1-adapters');
...
const import_editor_v1_adapters12 = require('@elementor/editor-v1-adapters');
...
const ElementNotFoundError = (0, import_utils.createError)({
	code: 'element_not_found',
	message: 'Element not found.',
});
const StyleNotFoundError = (0, import_utils.createError)({
	code: 'style_not_found',
	message: 'Style not found.',
});
const ElementTypeNotExistsError = (0, import_utils.createError)({
	code: 'element_type_not_exists',
	message: 'Element type does not exist.',
});
const ElementLabelNotExistsError = (0, import_utils.createError)({
	code: 'element_label_not_exists',
	message: 'Element label does not exist.',
});
const ElementParentNotFoundError = (0, import_utils.createError)({
	code: 'element_parent_not_found',
	message: 'Element parent not found.',
});
const ElementIndexNotFoundError = (0, import_utils.createError)({
...
const import_editor_v1_adapters13 = require('@elementor/editor-v1-adapters');
...
const import_editor_v1_adapters14 = require('@elementor/editor-v1-adapters');
...
const import_editor_v1_adapters15 = require('@elementor/editor-v1-adapters');
var updateElementEditorSettings = ({ elementId, settings }) => {
	...
	(0, import_editor_v1_adapters15.__privateRunCommandSync)(
...
const import_editor_v1_adapters16 = require('@elementor/editor-v1-adapters');
var updateElementSettings = ({ id, props, withHistory = true }) => {
	...
	if (withHistory) {
		...
		(0, import_editor_v1_adapters16.__privateRunCommandSync)('document/elements/set-settings', args, {
			internal: true,
		});
	}
};
...
const import_editor_v1_adapters17 = require('@elementor/editor-v1-adapters');
...
const import_editor_props2 = require('@elementor/editor-props');
const import_editor_styles = require('@elementor/editor-styles');

// src/styles/mutate-element-styles.ts
const import_editor_props = require('@elementor/editor-props');
const import_editor_v1_adapters18 = require('@elementor/editor-v1-adapters');
...
function notifyChanges() {
	dispatchChangeEvent();
	(0, import_editor_v1_adapters18.__privateRunCommandSync)(
		'document/save/set-is-modified',
		{ status: true },
		{ internal: true }
	);
...
const import_editor_props3 = require('@elementor/editor-props');
const import_editor_styles2 = require('@elementor/editor-styles');
...
const import_editor_v1_adapters19 = require('@elementor/editor-v1-adapters');
...
const import_editor_v1_adapters20 = require('@elementor/editor-v1-adapters');
var updateElementInteractions = ({ elementId, interactions }) => {
	...
	(0, import_editor_v1_adapters20.__privateRunCommandSync)(
		'document/save/set-is-modified',
		{ status: true },
		{ internal: true }
	);
