import {
	...
	type ComponentType,
	type ElementType,
	type MouseEvent as MouseEvent$1,
...
import type * as _emotion_styled from '@emotion/styled';
import type * as _mui_material from '@mui/material';
import type * as _mui_system from '@mui/system';

declare const CollapseIcon: _emotion_styled.StyledComponent<
	Omit<_mui_material.SvgIconProps, 'ref'> &
...
declare const EllipsisWithTooltip: <T extends React$1.ElementType>({
	maxWidth,
	title,
	as,
	...props
}: EllipsisWithTooltipProps<T>) => React$1.JSX.Element;
...
declare const IntroductionModal: ({
	open,
	handleClose,
	title,
	children,
}: IntroductionModalProps) => React$1.JSX.Element;

declare function ThemeProvider({ children }: { children: React$1.ReactNode }): React$1.JSX.Element;

type MenuListItemProps = MenuItemProps & {
	menuItemTextProps?: MenuItemTextProps;
	primaryTypographyProps?: TypographyProps;
};
declare const MenuListItem: ({
	children,
	menuItemTextProps,
	primaryTypographyProps,
	...props
}: MenuListItemProps) => React$1.JSX.Element;
...
>;
declare const PromotionInfotip: ({
	children,
	open,
	onClose,
	...cardProps
}: PromotionInfotipProps) => React$1.JSX.Element;
...
type PromotionPopoverProps = React$1.PropsWithChildren<
...
>;
declare const PromotionPopover: ({
	children,
	open,
	placement,
	slotProps,
	anchorRef,
	...cardProps
}: PromotionPopoverProps) => React$1.JSX.Element;
...
declare function FloatingActionsBar({
	actions,
	children,
}: PropsWithChildren<{
...
declare const PopoverMenuList: <T, V extends string>({
	items,
	onSelect,
	onClose,
	selectedValue,
...
}: PopoverMenuListProps<T, V>) => React$1.JSX.Element;
declare const StyledMenuList: _emotion_styled.StyledComponent<
	any,
	{},
	{
...
declare function PopoverAction({
	title,
	visible,
	icon: Icon,
	content: PopoverContent,
}: PopoverActionProps): React$1.JSX.Element | null;
...
declare const ConfirmationDialog: {
	...
	Actions: ({
		...
		onSuppressMessage,
		suppressLabel,
	}: ConfirmationDialogActionsProps) => React$1.JSX.Element;
};
