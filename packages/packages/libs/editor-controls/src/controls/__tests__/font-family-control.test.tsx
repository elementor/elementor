...
jest.mock('@tanstack/react-virtual', () => ({
	useVirtualizer: jest.fn().mockImplementation((config) => {
		...
		return {
			...
			getTotalSize: jest.fn().mockReturnValue(count * ITEM_HEIGHT),
...
describe('FontFamilyControl', () => {
	...
	it('should display placeholder when no value is set and placeholder is provided', () => {
		...
		// Act.
		renderControl(<FontFamilyControl fontFamilies={mockFontFamilies} sectionWidth={320} />, propsWithPlaceholder);
