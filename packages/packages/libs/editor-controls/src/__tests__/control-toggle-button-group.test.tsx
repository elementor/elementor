	...
	it('should propagate size prop to icon', () => {
		...
		const { rerender } = renderControl(
			<ControlActionsProvider items={[]}>
				<ControlToggleButtonGroup value={null} items={localItems} onChange={onChange} size="large" exclusive />
		...
		// Act.
		rerender(
			<ControlToggleButtonGroup value={null} items={localItems} onChange={onChange} size="small" exclusive />
		);
