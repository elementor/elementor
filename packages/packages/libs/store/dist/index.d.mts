...
import type * as _reduxjs_toolkit_dist_configureStore from '@reduxjs/toolkit/dist/configureStore';
export {
	Action,
	AnyAction,
	CreateSliceOptions,
...
declare const subscribeWithSelector: <T>(
	selector: (state: any) => T,
	listener: (selectedState: T) => void
) => redux.Unsubscribe;
declare const createStore: () => AnyStore;
declare const getStore: () => _reduxjs_toolkit_dist_configureStore.ToolkitStore<
	any,
	AnyAction,
