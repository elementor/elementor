...
import { V1Element, V1ElementModelProps } from "./types";
...
export const replaceElement = ( currentElement: V1Element, newElement: Omit<V1ElementModelProps, 'id'> ) => {
    ...
    if ( ! parent ) {
        throw new Error( `Parent container not found for element with ID: ${currentElement.id}. Cannot replace element without a valid parent container.` );
    }
...
export const addElement = ( parent: V1Element | undefined, element: Omit<V1ElementModelProps, 'id'>, options?: { at?: number } ) => {
