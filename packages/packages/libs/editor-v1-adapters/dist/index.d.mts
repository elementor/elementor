...
declare function useRouteStatus(
	route: RouteEventDescriptor['name'],
	{ blockOnKitRoutes, allowedEditModes }?: UseRouteStatusOptions
): {
	isActive: boolean;
	isBlocked: boolean;
};
...
declare function undoable<TDoReturn, TUndoReturn>(
	actions: Actions<undefined, TDoReturn, TUndoReturn>,
	options: Options<undefined, NoInfer<TDoReturn>>
): () => TDoReturn;
declare function undoable<TPayload extends NonNullable<Payload>, TDoReturn, TUndoReturn>(
...
type AfterHookCallback<TArgs extends Args = Args, TResult = unknown> = (
	args: TArgs,
	result: TResult,
	options?: HookOptions
) => void | Promise<void>;
...
declare function registerDataHook<TArgs extends Args = Args>(
	type: 'dependency',
	command: string,
	callback: DependencyHookCallback<TArgs>
): DataHook<TArgs>;
declare function registerDataHook<TArgs extends Args = Args, TResult = unknown>(
	type: 'after',
	command: string,
...
export {
	...
	type RouteEvent,
	type RouteEventDescriptor,
	type SupportedFonts$1 as SupportedFonts,
	type UseRouteStatusOptions,
	type WindowEvent,
	type WindowEventDescriptor,
	type WindowWithHistoryManager,
