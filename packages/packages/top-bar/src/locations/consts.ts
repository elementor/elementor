// Menus
export const LOCATION_MAIN_MENU_DEFAULT = 'editor/top-bar/main-menu/default' as const;
export const LOCATION_MAIN_MENU_EXITS = 'editor/top-bar/main-menu/exits' as const;
export const LOCATION_TOOLS_MENU_DEFAULT = 'editor/top-bar/tools/default' as const;
