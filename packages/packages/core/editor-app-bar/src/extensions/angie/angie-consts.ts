...
export const ANGIE_DESCRIPTION = __( 'Angie lets you generate custom widgets, sections, and code using simple instructions.', 'elementor' );

export const AI_WIDGET_CTA_VIEWED_EVENT = 'ai_widget_cta_viewed' as const;
export const ANGIE_TOP_BAR_PROMOTION_IMAGE_URL = 'https://assets.elementor.com/packages/v1/images/angie-top-bar-promotion.svg';
