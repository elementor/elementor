import { MCPRegistryEntry } from "@elementor/editor-mcp";
...
export const initStyleSheetResource = ( reg: MCPRegistryEntry ) => {
	...
	mcpServer.resource( 'style-sheet-raw-css', STYLE_SHEET_RAW_CSS_URI, {description: 'Raw CSS of the style sheet.'}, async () => {
		return {
			contents: [ { 
                uri: STYLE_SHEET_RAW_CSS_URI, text: 
                `# Style sheet raw CSS
                ${variables && `
