...
const getInlineStartLabel = (isSiteRtl: boolean) => (isSiteRtl ? __('Right', 'elementor') : __('Left', 'elementor'));

const getInlineEndLabel = (isSiteRtl: boolean) => (isSiteRtl ? __('Left', 'elementor') : __('Right', 'elementor'));
	...
	return (
		<UiProviders>
			<Stack direction="row" gap={2} flexWrap="nowrap" ref={rowRefs[0]}>
				...
				<DimensionField side="inset-inline-end" label={getInlineEndLabel(isSiteRtl)} rowRef={rowRefs[0]} />
			</Stack>
			<Stack direction="row" gap={2} flexWrap="nowrap" ref={rowRefs[1]}>
				...
				<DimensionField side="inset-inline-start" label={getInlineStartLabel(isSiteRtl)} rowRef={rowRefs[1]} />
			</Stack>
		</UiProviders>
	);
};
