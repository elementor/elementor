...
export const descriptor: AuditDescriptor = {
	...
	description: __( 'A cookie policy is required by privacy regulations such as GDPR (europe) or CCPA (us) to inform visitors about tracking and data collection.', 'elementor' ),
