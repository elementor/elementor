...
export default function CollapsibleList({ label, Icon, isOpenByDefault = false, children }: PropsWithChildren<Props>) {
	...
	return (
		<>
			<ListItem>
				...
				<ListItemText primaryTypographyProps={{ variant: 'subtitle2', component: 'span' }} primary={label} />
			</ListItem>
