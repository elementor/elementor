...
import { type PropValue, type SizePropValue } from '@elementor/editor-props';

declare const EmptyState: ({ onCreateInteraction }: { onCreateInteraction: () => void }) => React.JSX.Element;

declare const InteractionsTab: ({ elementId }: { elementId: string }) => React.JSX.Element;
...
declare function createInteractionsProvider({
	key,
	priority,
	subscribe,
	actions,
...
declare function registerInteractionsControl<T extends InteractionsControlType>({
	type,
	component,
	options,
}: ControlOptions<T>): void;
...
declare const createAnimationPreset: ({
	effect,
	type,
	direction,
	duration,
...
declare const createInteractionItem: ({
	trigger,
	effect,
	type,
	direction,
...
declare const resolveDirection: (
