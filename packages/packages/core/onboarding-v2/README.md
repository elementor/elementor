...
```bash
npm install @elementor/onboarding-v2
```

## Usage

```typescript
import { init } from '@elementor/onboarding-v2';
...
- `onboardingV2Slice` - Manages current step, completed steps, user choices, and exit state
