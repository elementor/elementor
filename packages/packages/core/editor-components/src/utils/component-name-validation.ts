...
const schema = z
	.string()
	.min( 2, __( 'Component name is too short. Use at least 2 characters.', 'elementor' ) )
	.max( 50, __( 'Component name is too long. Please keep it under 50 characters.', 'elementor' ) )
