...
describe( 'Dynamic Tool', () => {
	...
	describe( 'successful operations', () => {
		it( 'should successfully get dynamic settings for control', async () => {
			...
			expect( ( window.elementor as NonNullable< typeof window.elementor > ).getContainer ).toHaveBeenCalledWith(
				'element-123'
			);
	...
	describe( 'error handling', () => {
		it( 'should throw error when element not found', async () => {
			(
				( window.elementor as NonNullable< typeof window.elementor > ).getContainer as jest.Mock
