...
describe('useCssClassUsageByID', () => {
	...
	it('returns usage data for a valid ID', async () => {
		...
		expect(result.current.data).toEqual({
			total: 3,
			content: [{ pageId: 'p1', total: 3, elements: ['el-1', 'el-2', 'el-3'], title: 'Page 1', type: 'wp-page' }],
		});
	});
	...
	it('sets loading state initially', async () => {
		mockedFetchCssClassUsage.mockImplementation(() => new Promise((resolve) => setTimeout(() => resolve({}), 100)));
