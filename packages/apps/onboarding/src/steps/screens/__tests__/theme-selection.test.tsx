...
describe('ThemeSelection', () => {
	...
	describe('Rendering', () => {
		it('should render the step heading and description', () => {
			...
			expect(screen.getByText('Hello themes are built to work seamlessly with Elementor.')).toBeInTheDocument();
		});
		...
		it('should render the Hello theme card', () => {
			...
			expect(screen.getByText('A flexible canvas theme you can shape from the ground up')).toBeInTheDocument();
		});
