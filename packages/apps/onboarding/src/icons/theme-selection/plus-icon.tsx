...
const PlusIcon = React.forwardRef< SVGSVGElement, React.ComponentProps< typeof SvgIcon > & { strokeColor?: string } >(
	( { sx, strokeColor = '#ffffff', ...props }, ref ) => {
		return (
			<SvgIcon viewBox="0 0 34.545 34.545" { ...props } ref={ ref } sx={ { overflow: 'visible', ...sx } }>
				<path d={ PLUS_PATH } fill="none" stroke={ strokeColor } strokeWidth="5.454" strokeLinejoin="round" />
