		...
		<Layout pageId={ pageId }>
			...
			<Grid container alignItems="center" justify="space-between" className="e-onboarding__cards-grid e-onboarding__page-content">
				<Card
					...
					clickAction={ () => OnboardingEventTracking.sendOnboardingSource( 'blank_canvas' ) }
				/>
				<Card
					name="template"
					...
					link={ kitLibraryLink }
					clickAction={ () => {
						OnboardingEventTracking.sendOnboardingSource( 'kit_library' );
				...
				<Card
					...
					target="_blank"
					clickAction={ () => OnboardingEventTracking.sendOnboardingSource( 'site_planner' ) }
				/>
			</Grid>
