...
use Elementor\App\Modules\ImportExport\Data\Routes\Traits\Handles_Quota_Errors;
...
class Process_Media extends Base_Route {
	...
	protected function callback( $request ): \WP_REST_Response {
		...
		try {
			...
			return Response::error( ImportExportModule::MEDIA_PROCESSING_ERROR, $e->getMessage() );
		}
	}
