...
class Elementor_Content extends Import_Runner_Base {
	...
	public function import( array $data, array $imported_data ) {
		...
		$post_types = apply_filters( 'elementor/import-export/elementor-content/post-types/customization', $post_types, $customization );
		...
		foreach ( $posts_settings as $id => $post_settings ) {
			try {
				if ( 'page' === $post_type ) {
					...
					$import_result = apply_filters( 'elementor/import-export/import/elementor-content/customization', null, $data, [], $customization ?? [], $this );
