...
class Wp_Content extends Export_Runner_Base {
	...
	public function export( array $data ) {
		...
		$post_types = apply_filters( 'elementor/import-export/wp-content/post-types/customization', $post_types, $data, $customization );
	...
	private function export_wp_post_type( $post_type, $customization ) {
		...
		$exporter_args = apply_filters( 'elementor/import-export/export/wp-content/query-args/customization', $exporter_args, $post_type, $customization );
