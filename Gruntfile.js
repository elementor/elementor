		...
		browserify: {
			...
			dist: {
				files: {
					...
					'assets/js/safe-loader.js': [ 'assets/dev/js/utils/safe-loader.js' ]
				},
		...
		exorcise: {
			bundle: {
				...
				files: {
					...
					'assets/js/safe-loader.js.map': [ 'assets/js/safe-loader.js' ]
				}
			}
		},
		...
		uglify: {
			...
			dist: {
				files: {
					...
					'assets/js/safe-loader.min.js': [
						'assets/js/safe-loader.js'
					]
				}
			}
		},
