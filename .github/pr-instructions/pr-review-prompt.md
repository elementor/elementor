...
- Any GitHub API call that submits a pull request review
...
Post a general summary comment:
```bash
...
**Remember: Be brief, specific, and focus only on critical issues. Never approve or request changes on a PR.**
