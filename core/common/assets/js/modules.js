...
elementorModules.common = {
	get Component() {
		...
		setTimeout( () => {
			elementorCommon.helpers.hardDeprecated( 'elementorModules.common.Component', '2.9.0',
	...
	get ComponentModal() {
		// `elementorCommon` isn't available during it self initialize.
		setTimeout( () => {
			elementorCommon.helpers.hardDeprecated( 'elementorModules.common.ComponentModal', '2.9.0',
	...
	get HookBreak() {
		// `elementorCommon` isn't available during it self initialize.
		setTimeout( () => {
			elementorCommon.helpers.hardDeprecated( 'elementorModules.common.HookBreak', '2.9.0',
				'$e.modules.HookBreak' );
		}, 2000 );
		return HookBreak;
	},
