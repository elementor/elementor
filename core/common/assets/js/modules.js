...
elementorModules.common = {
	get Component() {
		...
		setTimeout( () => {
			elementor.devTools.deprecation.deprecated( 'elementorModules.common.Component', '2.9.0',
	...
	get ComponentModal() {
		// `elementorCommon` isn't available during it self initialize.
		setTimeout( () => {
			elementor.devTools.deprecation.deprecated( 'elementorModules.common.ComponentModal', '2.9.0',
	...
	get HookBreak() {
		// `elementorCommon` isn't available during it self initialize.
		setTimeout( () => {
			elementor.devTools.deprecation.deprecated( 'elementorModules.common.HookBreak', '2.9.0',
				'$e.modules.HookBreak' );
		}, 2000 );
		return HookBreak;
	},
