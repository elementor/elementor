...
class Role_Manager extends Settings_Page {
	...
	public function get_go_pro_link_html() {
		...
		<div class="elementor-role-go-pro">
			...
			<div class="elementor-role-go-pro__link"><a class="elementor-button elementor-button-default go-pro" target="_blank" href="https://go.elementor.com/go-pro-role-manager/"><?php echo esc_html__( 'Upgrade', 'elementor' ); ?></a></div>
		</div>
		<?php
	}
