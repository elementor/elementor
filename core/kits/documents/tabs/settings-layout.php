...
class Settings_Layout extends Tab_Base {
	...
	protected function register_tab_controls() {
		...
		$page_templates = $page_templates_module->add_page_templates( array(), null, null );
		...
		$page_template_control_options = array(
		...
		$this->add_control( 'viewport_md', array( 'type' => Controls_Manager::HIDDEN ) );
		$this->add_control( 'viewport_lg', array( 'type' => Controls_Manager::HIDDEN ) );
	...
	private function add_breakpoints_controls() {
		...
		if ( ! Plugin::$instance->experiments->is_feature_active( 'additional_custom_breakpoints' ) ) {
			$default_breakpoints_config = array_intersect_key( $default_breakpoints_config, array_flip( array( Breakpoints_Manager::BREAKPOINT_KEY_MOBILE, Breakpoints_Manager::BREAKPOINT_KEY_TABLET ) ) );
		}
