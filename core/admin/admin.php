...
class Admin extends App {
	...
	public function __construct() {
		...
		Plugin::$instance->config->register( Site_Beta::class );
		Plugin::$instance->config->register( Site_CSS_Print_Method::class );
		Plugin::$instance->config->register( Site_Font_Display::class );
		Plugin::$instance->config->register( Site_Google_Fonts::class );
		Plugin::$instance->config->register( Site_Usage_Last_Send::class );
		Plugin::$instance->config->register( Site_Usage_Notice::class );
		Plugin::$instance->config->register( Site_Usage_Opt_In::class );
		Plugin::$instance->config->register( User_Beta_Tester::class );
		Plugin::$instance->config->register( User_Introduction::class );
		Plugin::$instance->config->register( WP_Blog_Name::class );
	...
	protected function get_init_settings() {
		$settings = [
			...
			'beta_tester' => [
				...
				'has_email' => User_Beta_Tester::get_value(),
