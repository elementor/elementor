		...
		return [
			{
				...
				tooltip_data: {
					...
					docs: 'https://go.elementor.com/app-site-editor-header',
			...
			},
			{
				...
				tooltip_data: {
					...
					docs: 'https://go.elementor.com/app-site-editor-footer',
			...
			},
			{
				...
				tooltip_data: {
					...
					docs: 'https://go.elementor.com/app-site-editor-page',
			...
			},
			{
				...
				tooltip_data: {
					...
					docs: 'https://go.elementor.com/app-site-editor-post',
			...
			},
			{
				...
				tooltip_data: {
					...
					docs: 'https://go.elementor.com/app-site-editor-archive',
			...
			},
			{
				...
				tooltip_data: {
					...
					docs: 'https://go.elementor.com/app-site-editor-search-results',
			...
			},
			{
				...
				tooltip_data: {
					...
					docs: 'https://go.elementor.com/app-site-editor-product',
			...
			},
			{
				...
				tooltip_data: {
					...
					docs: 'https://go.elementor.com/app-site-editor-products-archive',
					video_url: 'https://www.youtube.com/embed/F2gyAeZdU9s',
				},
			},
			{
				...
				tooltip_data: {
					...
					docs: 'https://go.elementor.com/app-site-editor-404',
