...
class Version {
	 ...
	 *
	 * @return static
	 * @throws \Exception When version comparison fails or invalid version format is provided.
	 */
	 ...
	 *
	 * @return bool
	 * @throws \Exception When version validation fails or parsing errors occur.
	 */
