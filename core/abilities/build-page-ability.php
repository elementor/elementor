			...
			'meta' => [
				...
				'annotations'  => [
					'instructions' => implode( "\n", [
						...
						'E-BUTTON BASE STYLES: the button base stylesheet sets background, padding, border-radius, border-width, text-align, color:inherit, and text-decoration:none. `color:inherit` means the button adopts the colour of its nearest ancestor that sets an explicit colour — it does NOT default to browser-link blue. However it also means no colour is forced: always set an explicit `color` in the button\'s local style when you need a specific colour (especially ghost/outline variants on coloured backgrounds).',
