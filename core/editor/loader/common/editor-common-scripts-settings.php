...
class Editor_Common_Scripts_Settings {
	public static function get() {
		...
		$client_env = [
			...
			'fa4_to_fa5_mapping_url' => ELEMENTOR_ASSETS_URL . 'lib/font-awesome/migration/mapping-v4-to-v5.js',
			'fa5_to_fa6_mapping_url' => ELEMENTOR_ASSETS_URL . 'lib/font-awesome/migration/mapping-v5-to-v6.js',
			'settings' => $settings,
