...
class Svg extends Base {
	 ...
	 * 
	 * List based of https://github.com/darylldoyle/svg-sanitizer/blob/master/src/data/AllowedAttributes.php
	 *
	 * @since 3.5.0
	 * @access private
	 *
	 ...
	 * 
	 * List based on https://github.com/darylldoyle/svg-sanitizer/blob/master/src/data/AllowedAttributes.php
	 *
	 * @since 3.5.0
	 * @access private
	 *
	...
	private function get_allowed_elements() {
		$allowed_elements = array_map( strtolower, [
			// SVG
			'svg',
			'altglyph',
			'altglyphdef',
