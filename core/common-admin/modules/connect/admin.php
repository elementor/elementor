<?php
namespace Elementor\Core\CommonAdmin\Modules\Connect;
...
class Admin {
	...
	public function on_load_page() {
		if ( isset( $_GET['action'], $_GET['app'] ) ) {
			$manager = Plugin::$instance->common_admin->get_component( 'connect' );
			$app_slug = $_GET['app'];
	...
	public function render_page() {
		$apps = Plugin::$instance->common_admin->get_component( 'connect' )->get_apps();
		?>
		<style>
		...
		<div class="wrap">
			...
			/** @var \Elementor\Core\CommonAdmin\Modules\Connect\Apps\Base_App $app */
			foreach ( $apps as $app ) {
