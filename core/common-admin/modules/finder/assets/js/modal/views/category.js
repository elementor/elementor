...
export default class extends Marionette.CompositeView {
	...
	getTextFilter() {
		return elementorCommonAdmin.finder.channel.request( 'filter:text' ).trim().toLowerCase();
	}
	...
	onRender() {
		this.listenTo( elementorCommonAdmin.finder.channel, 'filter:change', this.onFilterChange.bind( this ) );
	}
