...
class Group_Control_Typography extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['font_weight'] = [
			...
			'default' => '',
			'options' => [
				'100' => esc_html_x( '100 (Thin)', 'Typography Control', 'elementor' ),
				'200' => esc_html_x( '200 (Extra Light)', 'Typography Control', 'elementor' ),
				'300' => esc_html_x( '300 (Light)', 'Typography Control', 'elementor' ),
				'400' => esc_html_x( '400 (Normal)', 'Typography Control', 'elementor' ),
				'500' => esc_html_x( '500 (Medium)', 'Typography Control', 'elementor' ),
				'600' => esc_html_x( '600 (Semi Bold)', 'Typography Control', 'elementor' ),
