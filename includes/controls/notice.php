...
class Control_Notice extends Base_UI_Control {
	...
	public function content_template() {
		...
		<div class="elementor-control-notice elementor-control-notice-type-{{ data.notice_type }}">
			...
			<# if ( data.dismissible ) { #>
			<button class="elementor-control-notice-dismiss tooltip-target" data-tooltip="<?php echo esc_html__( 'Dismiss and don’t show again.', 'elementor' ); ?>">
				<i class="eicon eicon-close" aria-hidden="true"></i>
				<span class="elementor-screen-only"><?php echo esc_html__( 'Dismiss and don’t show again.', 'elementor' ); ?></span>
			</button>
			<# } #>
		</div>
		<?php
