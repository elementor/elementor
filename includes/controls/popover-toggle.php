			...
			<div class="elementor-control-input-wrapper">
				<# if ( 'switcher' === data.toggle_type ) { #>
					<div class="elementor-choices">
						...
						<label class="elementor-choices-label elementor-control-popover-toggle-toggle" for="<?php echo $control_uid; ?>-custom">{{{ data.label_on }}}<i class="eicon-sort-down"></i></label>
					</div>
				<# } else { #>
