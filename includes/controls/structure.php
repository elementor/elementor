	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			<div class="elementor-control-input-wrapper">
				<div class="elementor-control-structure-title"><?php esc_html_e( 'Structure', 'elementor' ); ?></div>
				...
				<div class="elementor-control-structure-reset">
					...
					<?php esc_html_e( 'Reset Structure', 'elementor' ); ?>
				</div>
				<#
				var morePresets = getMorePresets();

				if ( morePresets.length > 1 ) { #>
					<div class="elementor-control-structure-more-presets-title"><?php esc_html_e( 'More Structures', 'elementor' ); ?></div>
