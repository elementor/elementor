	...
	public function content_template() {
		...
		<div class="elementor-control-field elementor-control-url-external-{{{ ( data.options.length || data.show_external ) ? 'show' : 'hide' }}}">
			...
			<div class="elementor-control-input-wrapper elementor-control-dynamic-switcher-wrapper">
				...
				<input id="<?php $this->print_control_uid(); ?>" class="elementor-control-tag-area elementor-input" data-setting="url" placeholder="{{ elementor.getPanelView().currentPageView.children.findByModelCid( data._cid )?.getControlPlaceholder() }}" />
