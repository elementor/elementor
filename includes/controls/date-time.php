	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<input id="<?php $this->print_control_uid(); ?>" placeholder="{{ elementor.getPanelView().currentPageView.children.findByModelCid( data._cid )?.getControlPlaceholder() }}" class="elementor-date-time-picker flatpickr" type="text" data-setting="{{ data.name }}">
			</div>
		</div>
		<# if ( data.description ) { #>
