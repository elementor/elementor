		...
		wp_localize_script(
			...
			[
				...
				'i18n' => [
					...
					'preview_el_not_found_message' => sprintf( __( 'You must call \'the_content\' function  is called for Elementor to work on this page. <a href="%s" target="_blank">Learn more</a>', 'elementor' ), 'https://go.elementor.com/the-content-missing/' ),
				],
			]
		);
