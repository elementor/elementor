...
class Editor {
	...
	public function enqueue_scripts() {
		...
		$config = [
			...
			'help_preview_error_url' => 'https://go.elementor.com/not_exists_yet/',
			...
			'i18n' => [
				...
				'preview_not_loading_header' => __( 'Error Loading Preview', 'elementor' ),
				'preview_not_loading_message' => __( 'The preview area could not be loaded because of some errors.', 'elementor' ),
