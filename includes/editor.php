	...
	public function enqueue_scripts() {
		...
		$config = [
			...
			'i18n' => [
				...
				// Deprecated Control
				'deprecated_notice' => __( 'The <strong>{{{ element }}}</strong> {{{ type }}} has been deprecated since {{{ plugin }}} {{{ since }}}.', 'elementor' ),
				'deprecated_notice_replacement' => __( 'It has been replaced by <strong>{{{ replacement }}}</strong>.', 'elementor' ),
				'deprecated_notice_last' => __( 'Note that {{{ element }}} will be completely removed once {{{ plugin }}} {{{ last }}} is released.', 'elementor' ),
