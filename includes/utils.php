...
class Utils {
	...
	/**
	 * Checks whether a control is a tablet/mobile setting generated by add_responsive_control()
	 *
	 * @param array $control
	 *
	 * @return bool
	 */
	public static function is_control_responsive_generated( $control ) {
		return isset( $control['responsive']['max'] ) && ( 'tablet' === $control['responsive']['max'] || 'mobile' === $control['responsive']['max'] );
	}
