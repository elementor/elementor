...
<script type="text/template" id="tmpl-editor-content">
	...
	<div class="elementor-nerd-box elementor-nerd-box--upsale">
		...
		<a class="elementor-button go-pro" href='{{ elementData.upsale_data.upgrade_url }}' target="_blank"><?php echo esc_html__( '{{ elementData.upsale_data.upgrade_text }}', 'elementor' ); ?></a>
		<# } else { #>
