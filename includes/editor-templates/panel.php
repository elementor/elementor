...
<script type="text/template" id="tmpl-editor-content">
	...
	<div class="elementor-nerd-box elementor-nerd-box--upsale">
		...
		<img class="elementor-nerd-box-icon" src="<?php Utils::print_unescaped_internal_string( esc_url( ELEMENTOR_ASSETS_URL . '{{ elementData.upsale_data.image }}' ) ); ?>" loading="lazy" alt="<?php echo esc_attr__( 'Upgrade', 'elementor' ); ?>" />
		<# } else { #>
		...
		<# if ( elementData.upsale_data.upgrade_text ) { #>
		<a class="elementor-button go-pro" href='{{ elementData.upsale_data.upgrade_url }}' target="_blank"><?php echo esc_html( '{{ elementData.upsale_data.upgrade_text }}', 'elementor' ); ?></a>
		<# } else { #>
