...
<script type="text/template" id="tmpl-elementor-templates-responsive-bar">
	<div id="e-responsive-bar__start">
		<div id="elementor-panel-footer-logo" class="elementor-panel-footer-tool tooltip-target elementor-toggle-state">
			<div class="e-responsive-bar__menu">
				...
				<div class="e-responsive-bar__menu-dropdown" style="display:none;">
					<a class="e-responsive-bar__menu-dropdown-item">test1</a>
					<a class="e-responsive-bar__menu-dropdown-item">test2</a>
					<a class="e-responsive-bar__menu-dropdown-item">test3</a>
				</div>
			</div>
		...
		<div id="elementor-panel-footer-global-styles" class="elementor-panel-footer-tool tooltip-target elementor-toggle-state" data-tooltip="<?php esc_attr_e('Global Styles', 'elementor'); ?>">
		...
		<div id="elementor-panel-footer-more" class="elementor-panel-footer-tool tooltip-target elementor-toggle-state" data-tooltip="<?php esc_attr_e('More', 'elementor'); ?>">
			<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
