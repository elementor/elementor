...
<script type="text/template" id="tmpl-elementor-add-section">
	<div class="elementor-add-section-inner">
		...
		<div class="e-view elementor-add-new-section">
			...
			?>
			<div class="elementor-add-section-area-button elementor-add-section-button elementor-button" title="<?php echo esc_attr( $button_title ); ?>">
				<i class="eicon-plus"></i>
			</div>
			<div class="elementor-add-section-area-button elementor-add-template-button elementor-button" title="<?php echo esc_attr__( 'Add Template', 'elementor' ); ?>">
