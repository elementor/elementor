...
<script type="text/template" id="tmpl-elementor-panel-categories">
	...
	<div id="elementor-panel-get-pro-elements" class="elementor-nerd-box">
		...
		<a class="elementor-button elementor-button-default go-pro" target="_blank" href="https://go.elementor.com/pro-widgets/"><?php echo esc_html__( 'Upgrade Now', 'elementor' ); ?></a>
	</div>
</script>
...
<script type="text/template" id="tmpl-elementor-panel-global">
	<div class="elementor-nerd-box">
		...
		<a class="elementor-button elementor-button-default go-pro" target="_blank" href="https://go.elementor.com/pro-global/"><?php echo esc_html__( 'Upgrade Now', 'elementor' ); ?></a>
	</div>
</script>
