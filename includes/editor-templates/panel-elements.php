...
<script type="text/template" id="tmpl-elementor-panel-elements">
	...
	<div id="elementor-panel-elements-navigation" class="elementor-panel-navigation">
		<div id="elementor-panel-elements-navigation-all" class="elementor-panel-navigation-tab elementor-active" data-route="panel/elements/categories"><?php echo __( 'Elements', 'elementor' ); ?></div>
		<div id="elementor-panel-elements-navigation-global" class="elementor-panel-navigation-tab" data-route="panel/elements/global"><?php echo __( 'Global', 'elementor' ); ?></div>
	</div>
