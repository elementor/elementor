...
<script type="text/template" id="tmpl-elementor-panel-categories">
	...
	<div id="elementor-panel-get-pro-elements" class="elementor-nerd-box">
		...
		<a class="elementor-button elementor-button-default elementor-nerd-box-link"
			target="_blank"
			rel="noopener"
			href="<?php echo Utils::get_pro_link( 'https://elementor.com/pro/?utm_source=panel-widgets&utm_campaign=gopro&utm_medium=wp-dash' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
...
<script type="text/template" id="tmpl-elementor-panel-global">
	<div class="elementor-nerd-box">
		...
		<a class="elementor-button elementor-button-default elementor-nerd-box-link"
			rel="noopener"
			target="_blank"
			href="<?php echo Utils::get_pro_link( 'https://elementor.com/pro/?utm_source=panel-global&utm_campaign=gopro&utm_medium=wp-dash' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
			<?php echo esc_html__( 'Go Pro', 'elementor' ); ?>
		</a>
	</div>
</script>
