		...
		return [
			'allow_tracking' => [
				...
				'field_args' => [
					...
					'value' => 'yes',
					'default' => '',
					'sub_desc' => esc_html__( 'Become a super contributor by opting in to share non-sensitive plugin data and to receive periodic email updates from us.', 'elementor' ) . sprintf( ' <a href="%1$s" target="_blank" rel="noopener">%2$s</a>', 'https://go.elementor.com/usage-data-tracking/', esc_html__( 'Learn more.', 'elementor' ) ),
				],
