				...
				<div class="e-getting-started__box postbox">
					...
					<div class="e-getting-started__content">
						...
						<div class="e-getting-started__actions e-getting-started__content--narrow">
							...
							<a href="https://go.elementor.com/getting-started/" target="_blank" rel="noopener" class="button button-secondary button-hero"><?php echo esc_html__( 'Watch the Full Guide', 'elementor' ); ?></a>
						</div>
					</div>
				</div>
			</div>
	...
	public function elementor_custom_fonts() {
		...
		<div class="wrap">
			<div class="elementor-blank_state">
				...
				<a class="elementor-button elementor-button-default elementor-button-go-pro" target="_blank" rel="noopener" href="<?php echo Utils::get_pro_link( 'https://elementor.com/pro/?utm_source=wp-custom-fonts&utm_campaign=gopro&utm_medium=wp-dash' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"><?php echo esc_html__( 'Go Pro', 'elementor' ); ?></a>
			</div>
		</div><!-- /.wrap -->
		<?php
	}
	...
	public function elementor_custom_icons() {
		...
		<div class="wrap">
			<div class="elementor-blank_state">
				...
				<?php // PHPCS - No need to escape a URL. The query arg is sanitized. ?>
				<a class="elementor-button elementor-button-default elementor-button-go-pro" target="_blank" rel="noopener" href="<?php echo Utils::get_pro_link( 'https://elementor.com/pro/?utm_source=wp-custom-icons&utm_campaign=gopro&utm_medium=wp-dash' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"><?php echo esc_html__( 'Go Pro', 'elementor' ); ?></a>
			</div>
		</div><!-- /.wrap -->
		<?php
	}
	...
	public function elementor_popups() {
		...
		<div class="wrap">
			<div class="elementor-blank_state">
				...
				<?php // PHPCS - No need to escape a URL. The query arg is sanitized. ?>
				<a class="elementor-button elementor-button-default elementor-button-go-pro" target="_blank" rel="noopener" href="<?php echo Utils::get_pro_link( 'https://elementor.com/popup-builder/?utm_source=popup-templates&utm_campaign=gopro&utm_medium=wp-dash' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"><?php echo esc_html__( 'Go Pro', 'elementor' ); ?></a>
			</div>
		</div><!-- /.wrap -->
		<?php
	}
...
All within a simple, intuitive place.', 'elementor' ); ?>
					<a href="http://go.elementor.com/wp-dash-submissions" target="_blank" rel="noopener nofollow">
						<?php echo esc_html__( 'Learn More', 'elementor' ); ?>
					</a>
				</p>
				<a class="elementor-button elementor-button-default elementor-button-go-pro" target="_blank" rel="noopener" href="<?php
						...
						'fields' => [
							'notice' => [
								...
								'field_args' => [
									...
									sprintf( ' <a target="_blank" rel="noopener" href="http://go.elementor.com/panel-layout-settings">%s</a>', esc_html__( 'Learn More', 'elementor' ) ),
								],
							],
						],
					],
					...
					'google_maps' => [
						...
						'callback' => function() {
							printf(
								...
								'<a target="_blank" rel="noopener" href="https://developers.google.com/maps/documentation/embed/get-api-key">',
								'</a>'
							);
						},
						'fields' => [
	...
	private function elementor_custom_code() {
		...
		<div class="wrap">
			<div class="elementor-blank_state">
				...
				<a class="elementor-button elementor-button-default elementor-button-go-pro" target="_blank" rel="noopener" href="<?php echo esc_url( Utils::get_pro_link( 'http://go.elementor.com/go-pro-custom-code' ) ); ?>"><?php echo esc_html__( 'Go Pro', 'elementor' ); ?></a>
			</div>
		</div><!-- /.wrap -->
		<?php
	}
