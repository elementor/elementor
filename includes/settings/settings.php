	...
	public function elementor_custom_icons() {
		...
		<div class="wrap">
			<div class="elementor-blank_state">
				...
				<p><?php echo __( 'Custom Icons allows you to add your self-hosted icons and use them on your Elementor projects to create a unique brand language.', 'elementor' ); ?></p>
