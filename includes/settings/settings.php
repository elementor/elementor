					...
					'style' => [
						'fields' => [
							'notice' => [
								...
								'field_args' => [
									'type' => 'raw_html',
									'html' => __( 'The Style settings changed its location and can now be found within Elementor Editor\'s Settings Panel > Hamburger Menu > Global Settings.<br>You can use the Global Manager to make changes and see them live!', 'elementor' ) . sprintf( ' <a target="_blank" href="http://go.elementor.com/panel-layout-settings">%s</a>', __( 'Learn More', 'elementor' ) ),
								],
							],
						],
					],
