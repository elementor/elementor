	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'hide_in_inner' => true,
				'description' => esc_html__( 'Stretch the section to the full width of the page using JS.', 'elementor' ) . sprintf( ' <a href="%1$s" rel="noopener" target="_blank">%2$s</a>', 'https://go.elementor.com/stretch-section/', esc_html__( 'Learn more.', 'elementor' ) ),
				'render_type' => 'none',
