	...
	protected function render() {
		...
		<div class="elementor-tabs">
			...
			<div class="elementor-tabs-content-wrapper">
				<?php foreach ( $tabs as $item ) : ?>
					<div class="elementor-tab-content elementor-repeater-item-<?php echo $item['_id']; ?>" data-tab="<?php echo $counter; ?>"><?php echo $this->parse_text_editor( $item['tab_content'] ); ?></div>
				<?php
					$counter++;
				endforeach; ?>
			</div>
