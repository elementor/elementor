...
class Widget_Alert extends Widget_Base {
	...
	protected function render() {
		...
		$this->add_inline_editing_attributes( 'alert_title', 'basic' );
		?>
	...
	protected function _content_template() {
		...
		<div class="elementor-alert elementor-alert-{{ settings.alert_type }}" role="alert">
			<span class="elementor-alert-title elementor-inline-editing" data-elementor-setting-key="alert_title" data-elementor-inline-editing-toolbar="basic">{{{ settings.alert_title }}}</span>
