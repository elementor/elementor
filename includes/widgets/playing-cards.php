...
class Widget_Playing_Cards extends Widget_Base {
	...
	private static function render_card( $value, $suit ) {
		...
		if ( $value > 10 ) {
			?>
			<div class="<?php echo esc_html__( $class, 'elementor' ); ?>-royal-image" style="background-image: url( <?php echo
			esc_url( ELEMENTOR_ASSETS_URL .	'images/playing-cards/' . $text . '.jpg' ); ?> ); "></div>
