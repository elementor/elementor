...
class Widget_Divider extends Widget_Base {
	...
	public function get_keywords() {
		return array( 'divider', 'hr', 'line', 'border' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'condition' => array(
					'style!' => array_merge( array_keys( $this->filter_styles_by( $styles, 'supports_amount', false ) ), array(
						'',
						'solid',
						'double',
						'dotted',
		...
		<div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
			...
			<?php if ( $has_icon ) : ?>
				<div class="elementor-icon elementor-divider__element">
					<?php
					Icons_Manager::render_icon( $settings['icon'], array(
						'aria-hidden' => 'true',
					) );
					?></div>
			<?php elseif ( $has_text ) :
				$this->add_inline_editing_attributes( 'text' );
				$this->add_render_attribute( 'text', array( 'class' => array( 'elementor-divider__text', 'elementor-divider__element' ) ) );
				?>
