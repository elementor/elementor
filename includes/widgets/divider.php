...
class Widget_Divider extends Widget_Base {
	...
	private function get_separator_styles() {
		return array_merge(
			...
			[
				...
				'zigzag_tribal'   => [
					'label' => __( 'Zigzag Tribal', 'elementor' ),
				...
				'stripes_tribal'   => [
					'label' => __( 'Stripes Tribal', 'elementor' ),
				...
				'squares_tribal'   => [
					'label' => __( 'Squares Tribal', 'elementor' ),
				...
				'rounds_tribal'   => [
					'label' => __( 'Rounds Tribal', 'elementor' ),
				...
				'leaves_tribal'   => [
					'label' => __( 'Leaves Tribal', 'elementor' ),
				...
				'trees_tribal'   => [
					'label' => __( 'Trees Tribal', 'elementor' ),
				...
				'planes_tribal'   => [
					'label' => __( 'Planes Tribal', 'elementor' ),
				...
				'arrows_up_tribal'   => [
					'label' => __( 'Arrows Up Tribal', 'elementor' ),
				...
				'dots_tribal'   => [
					'label' => __( 'Dots Tribal', 'elementor' ),
				...
				'parallelogram'   => [
					'label' => __( 'Parallelogram', 'elementor' ),
				...
				'squares'   => [
					'label' => __( 'Squares', 'elementor' ),
					'shape' => '<rect x="1" y="1" width="22" height="22"/>',
					'preserve_aspect_ratio' => false,
					'supports_amount' => true,
					'group' => 'pattern',
					'view_box' => '0 0 50 24',
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'render_type' => 'template',
				'condition' => [
					'style' => array_keys( $this->get_options_by_groups( $styles, 'classic' )['options'] ),
				],
				'selectors' => [
	...
	private function build_svg() {
		...
		if ( 'classic' !== $selected_pattern['group'] ) {
