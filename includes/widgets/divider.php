...
class Widget_Divider extends Widget_Base {
	...
	private $stroke_separator_styles = [
		'zigzag',
		'curly',
		'curved',
		'wavy',
	...
	private $no_spacing_separator_styles = [
		'dots_tribal',
		'arrows_up_tribal',
		'planes_tribal',
		'trees_tribal',
	...
	protected function _register_controls() {
				...
				'groups' => [
					...
					[
						...
						'options' => [
							...
							'pluses' => __( 'Pluses', 'elementor' ),
							'zigzag_tribal' => __( 'Zig Zag Tribal', 'elementor' ),
							'stripes_tribal' => __( 'Stripes Tribal', 'elementor' ),
							'squares_tribal' => __( 'Squares Tribal', 'elementor' ),
							'rounds_tribal' => __( 'Rounds Tribal', 'elementor' ),
							'leaves_tribal' => __( 'Leaves Tribal', 'elementor' ),
							'x_tribal' => __( 'X Tribal', 'elementor' ),
							...
							'parallelogram' => __( 'Parallelogram', 'elementor' ),
						],
					],
				],
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'style!' => $this->classic_separator_styles,
				],
				'render_type' => 'template',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'style' => $this->no_spacing_separator_styles,
				],
				'render_type' => 'template',
			]
		);
	...
	private function build_svg() {
		...
		if ( ! in_array( $settings['style'], $this->stroke_separator_styles, true ) ) {
