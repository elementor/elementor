...
class Widget_Image_Box extends Widget_Base {
	...
	protected function render() {
		...
		$has_content = ! Utils::control_is_empty( $settings['title_text'] ) || ! Utils::control_is_empty( $settings['description_text'] );
		...
		if ( $has_content ) {
			...
			if ( ! Utils::control_is_empty( $settings['title_text'] ) ) {
			...
			if ( ! Utils::control_is_empty( $settings['description_text'] ) ) {
