...
class Widget_Image_box extends Widget_Base {
	...
	protected function render( $instance = [] ) {
		...
		if ( ! empty( $instance['image']['url'] ) ) {
			$image_html = sprintf( '<img src="%s" alt="%s" title="%s" />', esc_attr( $instance['image']['url'] ), esc_attr( $instance['alt_text'] ), esc_attr( $instance['title_attr'] ) );
	...
	protected function content_template() {
		...
		if ( settings.image.url ) {
			var imageHtml = '<img src="' + settings.image.url + '" alt="' + settings.alt_text + '" title="' + settings.title_attr + '" />';
