	...
	private static function get_current_introduction() {
		return [
			...
			'title' => '<div id="elementor-introduction-title">' .
			           ...
			           '</div>',
			'content' => '<div class="elementor-video-wrapper"><iframe src="https://www.youtube.com/v/6u45V2q1s4k?autoplay=1&rel=0&showinfo=0" frameborder="0" allowfullscreen></iframe></div>',
			'delay' => 2500,
			'version' => 1,
		];
	}
