	...
	public function __construct() {
		...
		if ( self::is_font_icon_inline_svg() ) {
			...
			add_action( 'elementor/frontend/after_enqueue_styles', function() {
				$css = '.elementor-icon { display: inline-block; } .elementor-icon svg, .elementor-button-icon svg, .elementor-icon-list-icon svg, .elementor-widget-container i svg { width: 1em; height: 1em; display: block; }';
