...
class Fonts {
	...
	private static $hasFontsInitialized = false;
	public static $fonts = [
		// System fonts.
		'Arial' => self::SYSTEM,
		'Tahoma' => self::SYSTEM,
	...
	public static function get_fonts() {
		if ( self::$hasFontsInitialized ) {
			return self::$fonts;
		}

		self::$hasFontsInitialized = true;
		self::$fonts = apply_filters('elementor/fonts_registered', self::$fonts);
