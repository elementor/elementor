...
const entry = {
	...
	'editor-screen-navigation': path.resolve( __dirname, '../modules/editor-screen-navigation/assets/js/admin.js' ),
	...
	'e-editor-screen': path.resolve( __dirname, '../modules/editor-screen/assets/js/app.js' ),
