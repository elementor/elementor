...
* Fix: Elements are pasted in reverse order when copying and pasting multi-selected elements
* Fix: SVG and JSON files were not being uploaded when Dragged from Desktop
