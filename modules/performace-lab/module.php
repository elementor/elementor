<?php
namespace Elementor\Modules\PerformaceLab;
...
class Module extends BaseModule {
	...
	public function get_name() {
		return 'performace-lab';
	}

	private function does_performace_lab_is_active() {
	...
	private function performace_lab_get_webp_src( $attachment_id, $size = 'full', $url ) {
		if ( $this->does_performace_lab_is_active() ) {
