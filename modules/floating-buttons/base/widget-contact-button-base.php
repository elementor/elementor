		...
		if ( $config['content']['chat_button_section']['has_display_text'] ) {
			...
			$this->add_control(
				...
				array(
					...
					'condition' => $this->get_display_text_condition(array(
		...
		if ( $config['style']['chat_button_section']['has_tabs'] ) {
			...
			$this->add_control(
				...
				array(
					...
					'condition' => $this->get_platform_color_condition( array(
			...
			if ( $config['advanced']['has_horizontal_offset'] ) {
				$this->add_responsive_control(
					...
					array(
						...
						'condition' => array(
							'advanced_horizontal_position' => array(
								'start',
								'end',
							),
						),
			...
			if ( $config['advanced']['has_vertical_offset'] ) {
				$this->add_responsive_control(
					...
					array(
						...
						'condition' => array(
							'advanced_vertical_position' => array(
								'top',
								'bottom',
							),
						),
