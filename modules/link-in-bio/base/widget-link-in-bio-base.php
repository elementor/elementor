...
abstract class Widget_Link_In_Bio_Base extends Widget_Base {
	...
	public static function get_configuration() {
		return array(
			'content' => array(
				'identity_section' => array(
					'identity_image_style' => array(
						'default' => 'profile',
					),
			...
			'style' => array(
				...
				'cta_section' => array(
					...
					'has_border_control' => array(
						'prefix' => 'cta_links',
						'show_border_args' => array(
							'condition' => array(
								'cta_links_type' => 'button',
							),
						),
						'border_width_args' => array(
							'condition' => array(
								'cta_links_type' => 'button',
							),
							'selectors' => array(
	...
	public function get_keywords(): array {
		return array( 'buttons', 'bio', 'widget', 'link in bio' );
	}
	...
	protected function add_image_links_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default' => $config['content']['image_links_section']['images_repeater_defaults'] ?? array(),
			)
		);
	...
	protected function add_cta_controls() {
		...
		$repeater->add_control(
			...
			array(
				...
				'type' => Controls_Manager::MEDIA,
				'label_block' => true,
				'media_type' => array( 'application/pdf' ),
				'condition' => array(
					'cta_link_type' => array(
						Social_Network_Provider::FILE_DOWNLOAD,
					),
...
JS;
	...
	protected function add_style_background_controls(): void {
		...
		$bg_section_image_field_option_defaults = array(
			'background' => array(
				'default' => 'classic',
			),
			'position' => array(
