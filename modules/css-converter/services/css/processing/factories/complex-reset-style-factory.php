...
use Elementor\Modules\CssConverter\Services\Css\Processing\Styles\Complex_Reset_Style;
...
class Complex_Reset_Style_Factory implements Style_Factory_Interface {
	...
	public function create_styles( array $data ): array {
		...
		foreach ( $properties as $property_data ) {
			...
			$styles[] = new Complex_Reset_Style([
