...
class Css_Property_Convertor_Config {
	...
	private function init_default_config(): void {
		$this->config = [
			...
			'enable_v4_conversion' => true,
			'fallback_to_schema' => true,
		];

		$this->config = apply_filters( 'elementor_css_property_convertor_config', $this->config );
	}
	...
	public function get_max_properties_per_request(): int {
		return $this->get( 'max_properties_per_request', 100 );
	}
	...
	public function is_v4_conversion_enabled(): bool {
		return $this->get( 'enable_v4_conversion', true );
	}

	public function should_fallback_to_schema(): bool {
		return $this->get( 'fallback_to_schema', true );
	}
}
