...
class Border_Color_Property_Mapper implements Class_Property_Mapper_Interface {
	...
	public function map_to_schema( string $property, $value ): array {
		if ( $property === 'border-color' ) {
			...
			return [
				'border-top-color' => [ '$$type' => 'color', 'value' => $parsed['top'] ],
				'border-right-color' => [ '$$type' => 'color', 'value' => $parsed['right'] ],
				'border-bottom-color' => [ '$$type' => 'color', 'value' => $parsed['bottom'] ],
				'border-left-color' => [ '$$type' => 'color', 'value' => $parsed['left'] ],
			];
		}
