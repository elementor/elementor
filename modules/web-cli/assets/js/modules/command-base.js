...
export default class CommandBase extends CommandInfra {
	...
	requireContainer( args = this.args ) {
		elementor.devTools.deprecation.deprecated( 'requireContainer', '3.7.0', 'Extend `$e.modules.editor.CommandContainerBase` or `$e.modules.editor.CommandContainerInternalBase`' );
