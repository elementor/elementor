...
export const generateLayout = ( prompt, attachments, variationType, prevGeneratedIds, promptAffects, signal ) => request( 'ai_generate_layout', { prompt, attachments, variationType, prevGeneratedIds, promptAffects }, true, signal );
