...
export const generateLayout = ( prompt, attachments, variationType, prevGeneratedIds, signal ) => request( 'ai_generate_layout', { prompt, attachments, variationType, prevGeneratedIds }, true, signal );
