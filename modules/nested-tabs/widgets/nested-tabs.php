...
class NestedTabs extends Widget_Nested_Base {
	...
	protected function get_default_children_placeholder_selector() {
		if ( Plugin::$instance->experiments->is_feature_active( 'nested_elements_html' ) ) {
			return '.e-n-tabs';
		}
	...
	protected function register_controls_new() {
	...
	protected function content_template_new() {
		?>
			New Nested Tabs Markup
		<?php
	}

	protected function content_template_old() {
		?>
