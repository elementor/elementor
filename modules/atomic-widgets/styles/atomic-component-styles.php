...
//
// Component JSON (to be added to a document data - replace the component_id with the actual component_id):
// {"id":"a1d2cb6","elType":"widget","settings":{"component_id":{"$$type":"string","value":"180"}},"name":{"$$type":"string","value":"This is an overridden name"},"title":{"$$type":"string","value":"This is an overridden title"},"elements":[],"widgetType":"e-component","styles":[],"editor_settings":[],"version":"0.0"}
