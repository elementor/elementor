...
/**
 * Static reference data for the V4 style prop-type system.
 *
 * All methods return documentation arrays consumed by V4_Styles_Ability and
 * served to AI agents via the WordPress Abilities API. No live dependencies —
 * pure data, safe to call anywhere.
 */
class V4_Styles_Reference {

	public static function get_critical_rules(): array {
		return [
	...
	public static function get_element_structure(): array {
		return [
