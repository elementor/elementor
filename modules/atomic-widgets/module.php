...
use Elementor\Modules\AtomicWidgets\PropsResolver\Transformers\Styles\Background_Image_Overlay_Offset_Transformer;
use Elementor\Modules\AtomicWidgets\PropsResolver\Transformers_Registry;
use Elementor\Modules\AtomicWidgets\PropTypes\Background_Color_Overlay_Prop_Type;
use Elementor\Modules\AtomicWidgets\PropTypes\Background_Image_Overlay_Offset_Prop_Type;
...
class Module extends BaseModule {
	...
	private function register_styles_transformers( Transformers_Registry $transformers ) {
		...
		$transformers->register( Background_Image_Overlay_Offset_Prop_Type::get_key(), new Background_Image_Overlay_Offset_Transformer() );
