...
class Atomic_Svg extends Atomic_Widget_Base {
	...
	protected static function get_placeholder(): string {
		$default_svg = '<svg width="200" height="200" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="checkered" patternUnits="userSpaceOnUse" width="9" height="9">
                    <rect width="9" height="9" fill="#666"/>
                    <rect width="4.5" height="4.5" fill="#ccc"/>
                    <rect x="4.5" y="4.5" width="4.5" height="4.5" fill="#ccc"/>
                </pattern>
            </defs>

            <rect width="100%" height="100%" fill="url(#checkered)"/>

            <g transform="translate(100, 100) scale(1.3)" fill="#fff">
