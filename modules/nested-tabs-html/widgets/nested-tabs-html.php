<?php
namespace Elementor\Modules\NestedTabsHtml\Widgets;
...
class NestedTabsHtml extends Widget_Nested_Base {
	...
	protected function get_html_wrapper_class() {
		return 'elementor-widget-n-tabs-html';
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient' ],
				'exclude' => [ 'image' ],
				'selector' => "{$heading_selector} > .e-n-tab-title[aria-selected=\"true\"]",
				'fields_options' => [
					'background' => [
						'default' => 'classic',
					],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => "{$heading_selector} > .e-n-tab-title[aria-selected=\"true\"] :is( span, a, i )",
				'fields_options' => [
					'text_stroke_type' => [
						'label' => esc_html__( 'Stroke', 'elementor' ),
					],
