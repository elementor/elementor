export default class BaseNestedTabs extends elementorModules.frontend.handlers.Base {
	getDefaultSettings() {
		return {
			selectors: {
	...
	changeActiveTab( tabIndex, fromBindings = false ) { // eslint-disable-line no-unused-vars
