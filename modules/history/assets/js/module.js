...
export default class Manager {
	...
	get history() {
		elementorCommon.helpers.hardDeprecated( 'elementor.history.history', '2.9.0', 'elementor.documents.getCurrent().history' );
		return elementor.documents.getCurrent().history;
	}

	get revisions() {
		elementorCommon.helpers.hardDeprecated( 'elementor.history.revisions', '2.9.0', 'elementor.documents.getCurrent().revisions' );
