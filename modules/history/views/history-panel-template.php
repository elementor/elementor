<script type="text/template" id="tmpl-elementor-panel-history-page">
	<div id="elementor-panel-elements-navigation" class="elementor-panel-navigation">
		<div id="elementor-panel-elements-navigation-history" class="elementor-panel-navigation-tab active" data-view="history"><?php _e( 'Actions', 'elementor' ); ?></div>
		<div id="elementor-panel-elements-navigation-revisions" class="elementor-panel-navigation-tab" data-view="revisions"><?php _e( 'Revisions', 'elementor' ); ?></div>
	</div>
...
<script type="text/template" id="tmpl-elementor-panel-history-tab">
	<div class="elementor-panel-box">
		<div class="elementor-panel-box-content">
			...
			<div class="elementor-history-revisions-message"><?php _e( 'Switch to Revisions tab for older versions', 'elementor' ) ?></div>
		</div>
	</div>
</script>
...
<script type="text/template" id="tmpl-elementor-panel-history-no-items">
	...
	<div class="elementor-panel-nerd-box-message"><?php _e( 'Once you start working, you\'ll be able to redo / undo any action you make in the editor.', 'elementor' ) ?></div>
	<div class="elementor-panel-nerd-box-message"><?php _e( 'Switch to Revisions tab for older versions', 'elementor' ) ?></div>
</script>
