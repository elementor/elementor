...
Every response includes `media_library_upload_url` — a direct link to the WordPress Media Library upload screen. Share it as a markdown link whenever you ask the user to upload missing assets.
