...
Discovers v4 atomic widgets. `summary: true` → lightweight list; default → full schemas. Permission: `edit_posts`.

## Public API

| Symbol | Signature | Purpose |
|--------|-----------|---------|
| `List_Widget_Schemas_Ability` | `execute( array $input ): array` | List v4 widgets with optional `summary` flag |
| Ability ID | `elementor/list-widget-schemas` | Stable MCP host identifier |

Verified: `list-widget-schemas-ability.php`.
