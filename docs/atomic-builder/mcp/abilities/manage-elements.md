...
Surgical edits on existing v4 elements by element ID: update settings/style/classes, delete, move, duplicate. Permission: `edit_posts`.

## Public API

| Symbol | Signature | Purpose |
|--------|-----------|---------|
| `Manage_Elements_Ability` | `execute( array $input ): array` | `action`: `update` \| `delete` \| `move` \| `duplicate` |
| Ability ID | `elementor/manage-elements` | Stable MCP host identifier |

Verified: `manage-elements-ability.php`.
