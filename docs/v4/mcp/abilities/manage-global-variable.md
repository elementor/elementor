...
Bulk create, update, or delete v4 global design tokens (colors, fonts, sizes) on the active kit. Distinct from legacy v3 globals — maps 1:1 to CSS custom properties `--label: value`.
