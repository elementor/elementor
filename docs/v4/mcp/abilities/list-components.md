...
Discovers user-defined reusable components on the site and returns overridable prop schemas for components you intend to place. Registered only when the Components experiment is active.
